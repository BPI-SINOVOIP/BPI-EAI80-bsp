...
enum opt_code
{
  ...
  OPT_minline_thumb1_jumptable = 1298,       /* -minline-thumb1-jumptable */
  OPT_mlittle_endian = 1299,                 /* -mlittle-endian */
  OPT_mlong_calls = 1300,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1301,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1302,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1303,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1304,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1305,               /* -mprint-tune-info */
  OPT_mpure_code = 1306,                     /* -mpure-code */
  OPT_mrestrict_it = 1307,                   /* -mrestrict-it */
  OPT_msched_prolog = 1308,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1309,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1310,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1311, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1312,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1313,                         /* -mthumb */
  OPT_mthumb_interwork = 1314,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1315,                  /* -mtls-dialect= */
  OPT_mtp_ = 1316,                           /* -mtp= */
  OPT_mtpcs_frame = 1317,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1318,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1319,                         /* -mtune= */
  OPT_munaligned_access = 1320,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1321,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1322,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1323,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1324,              /* -mword-relocations */
  OPT_n = 1325,                              /* -n */
  OPT_no_canonical_prefixes = 1326,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1327,              /* -no-integrated-cpp */
  OPT_no_pie = 1328,                         /* -no-pie */
  OPT_nocpp = 1329,                          /* -nocpp */
  OPT_nodefaultlibs = 1330,                  /* -nodefaultlibs */
  OPT_nolibc = 1331,                         /* -nolibc */
  OPT_nophoboslib = 1332,                    /* -nophoboslib */
  OPT_nostartfiles = 1333,                   /* -nostartfiles */
  OPT_nostdinc = 1334,                       /* -nostdinc */
  OPT_nostdinc__ = 1335,                     /* -nostdinc++ */
  OPT_nostdlib = 1336,                       /* -nostdlib */
  OPT_o = 1337,                              /* -o */
  OPT_p = 1338,                              /* -p */
  OPT_pass_exit_codes = 1339,                /* -pass-exit-codes */
  /* OPT_pedantic = 1340, */                 /* -pedantic */
  OPT_pedantic_errors = 1341,                /* -pedantic-errors */
  OPT_pg = 1342,                             /* -pg */
  OPT_pie = 1343,                            /* -pie */
  OPT_pipe = 1344,                           /* -pipe */
  OPT_print_file_name_ = 1345,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1346,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1347,          /* -print-multi-directory */
  OPT_print_multi_lib = 1348,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1349,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1350,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1351,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1352,               /* -print-prog-name= */
  OPT_print_search_dirs = 1353,              /* -print-search-dirs */
  OPT_print_sysroot = 1354,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1355,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1356,                          /* -quiet */
  OPT_r = 1357,                              /* -r */
  OPT_remap = 1358,                          /* -remap */
  OPT_s = 1359,                              /* -s */
  OPT_save_temps = 1360,                     /* -save-temps */
  OPT_save_temps_ = 1361,                    /* -save-temps= */
  OPT_shared = 1362,                         /* -shared */
  OPT_shared_libgcc = 1363,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1364,               /* -shared-libphobos */
  /* OPT_specs = 1365, */                    /* -specs */
  OPT_specs_ = 1366,                         /* -specs= */
  OPT_static = 1367,                         /* -static */
  OPT_static_libasan = 1368,                 /* -static-libasan */
  OPT_static_libgcc = 1369,                  /* -static-libgcc */
  OPT_static_libgfortran = 1370,             /* -static-libgfortran */
  OPT_static_libgo = 1371,                   /* -static-libgo */
  OPT_static_liblsan = 1372,                 /* -static-liblsan */
  OPT_static_libmpx = 1373,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1374,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1375,               /* -static-libphobos */
  OPT_static_libstdc__ = 1376,               /* -static-libstdc++ */
  OPT_static_libtsan = 1377,                 /* -static-libtsan */
  OPT_static_libubsan = 1378,                /* -static-libubsan */
  OPT_static_pie = 1379,                     /* -static-pie */
  /* OPT_std_c__03 = 1380, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1381, */                /* -std=c++0x */
  OPT_std_c__11 = 1382,                      /* -std=c++11 */
  OPT_std_c__14 = 1383,                      /* -std=c++14 */
  OPT_std_c__17 = 1384,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1385, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1386, */                /* -std=c++1z */
  OPT_std_c__2a = 1387,                      /* -std=c++2a */
  OPT_std_c__98 = 1388,                      /* -std=c++98 */
  OPT_std_c11 = 1389,                        /* -std=c11 */
  OPT_std_c17 = 1390,                        /* -std=c17 */
  /* OPT_std_c18 = 1391, */                  /* -std=c18 */
  /* OPT_std_c1x = 1392, */                  /* -std=c1x */
  OPT_std_c2x = 1393,                        /* -std=c2x */
  /* OPT_std_c89 = 1394, */                  /* -std=c89 */
  OPT_std_c90 = 1395,                        /* -std=c90 */
  OPT_std_c99 = 1396,                        /* -std=c99 */
  /* OPT_std_c9x = 1397, */                  /* -std=c9x */
  OPT_std_f2003 = 1398,                      /* -std=f2003 */
  OPT_std_f2008 = 1399,                      /* -std=f2008 */
  OPT_std_f2008ts = 1400,                    /* -std=f2008ts */
  OPT_std_f2018 = 1401,                      /* -std=f2018 */
  OPT_std_f95 = 1402,                        /* -std=f95 */
  OPT_std_gnu = 1403,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1404, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1405, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1406,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1407,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1408,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1409, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1410, */              /* -std=gnu++1z */
  OPT_std_gnu__2a = 1411,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1412,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1413,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1414,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1415, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1416, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1417,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1418, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1419,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1420,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1421, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1422, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1423,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1424, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1425, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1426, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1427, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1428, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1429,                     /* -std=legacy */
  OPT_symbolic = 1430,                       /* -symbolic */
  OPT_t = 1431,                              /* -t */
  OPT_time = 1432,                           /* -time */
  OPT_time_ = 1433,                          /* -time= */
  OPT_traditional = 1434,                    /* -traditional */
  OPT_traditional_cpp = 1435,                /* -traditional-cpp */
