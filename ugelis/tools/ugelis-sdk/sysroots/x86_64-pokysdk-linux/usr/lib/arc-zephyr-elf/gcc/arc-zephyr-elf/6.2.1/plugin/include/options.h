...
#endif
#ifdef GENERATOR_FILE
extern unsigned int arc_seen_options;
#else
  unsigned int x_arc_seen_options;
#define arc_seen_options global_options.x_arc_seen_options
#endif
#ifdef GENERATOR_FILE
...
#define MASK_ARGONAUT_SET (1 << 0)
#define MASK_ATOMIC (1 << 1)
...
#define MASK_EA_SET (1 << 8)
#define MASK_LL64 (1 << 9)
#define MASK_LONG_CALLS_SET (1 << 10)
#define MASK_LRA (1 << 11)
#define MASK_MIXED_CODE_SET (1 << 12)
#define MASK_MULMAC_32BY16_SET (1 << 13)
#define MASK_MUL64_SET (1 << 14)
#define MASK_NO_BRCC_SET (1 << 15)
#define MASK_NO_COND_EXEC (1 << 16)
#define MASK_DPFP_DISABLE_LRSR (1 << 17)
#define MASK_NO_MILLICODE_THUNK_SET (1 << 18)
#define MASK_NOMPY_SET (1 << 19)
#define MASK_VOLATILE_CACHE_SET (1 << 20)
#define MASK_NORM_SET (1 << 21)
#define MASK_NO_SDATA_SET (1 << 22)
#define MASK_SIMD_SET (1 << 23)
#define MASK_0 (1 << 24)
#define MASK_SPFP_COMPACT_SET (1 << 25)
#define MASK_SPFP_FAST_SET (1 << 26)
#define MASK_SWAP_SET (1 << 27)
...
#define TARGET_MIXED_CODE_SET_P(target_flags) ((target_flags & MASK_MIXED_CODE_SET) != 0)
...
#define TARGET_NO_MILLICODE_THUNK_SET_P(target_flags) ((target_flags & MASK_NO_MILLICODE_THUNK_SET) != 0)
...
enum opt_code
{
  ...
  OPT_Wnamespaces = 310,                     /* -Wnamespaces */
  OPT_Wnarrowing = 311,                      /* -Wnarrowing */
  OPT_Wnested_externs = 312,                 /* -Wnested-externs */
  OPT_Wnls = 313,                            /* -Wnls */
  OPT_Wno_effect_assign = 314,               /* -Wno-effect-assign */
  OPT_Wnoexcept = 315,                       /* -Wnoexcept */
  ...
  OPT_Wnull = 322,                           /* -Wnull */
  OPT_Wnull_dereference = 323,               /* -Wnull-dereference */
  OPT_Wodr = 324,                            /* -Wodr */
  OPT_Wold_style_cast = 325,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 326,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 327,           /* -Wold-style-definition */
  OPT_Wopenmp_simd = 328,                    /* -Wopenmp-simd */
  OPT_Wout_of_date = 329,                    /* -Wout-of-date */
  OPT_Wover_ann = 330,                       /* -Wover-ann */
  OPT_Woverflow = 331,                       /* -Woverflow */
  OPT_Woverlength_strings = 332,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 333,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 334,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 335,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 336,                             /* -Wp, */
  OPT_Wpacked = 337,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 338,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 339,                         /* -Wpadded */
  OPT_Wparam_assign = 340,                   /* -Wparam-assign */
  OPT_Wparentheses = 341,                    /* -Wparentheses */
  OPT_Wpedantic = 342,                       /* -Wpedantic */
  OPT_Wpkg_default_method = 343,             /* -Wpkg-default-method */
  /* OPT_Wplacement_new = 344, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 345,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 346,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 347,                  /* -Wpointer-arith */
  OPT_Wpointer_sign = 348,                   /* -Wpointer-sign */
  OPT_Wpointer_to_int_cast = 349,            /* -Wpointer-to-int-cast */
  ...
  OPT_ffilelist_file = 681,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 682,               /* -ffinite-math-only */
  OPT_ffixed_ = 683,                         /* -ffixed- */
  OPT_ffixed_form = 684,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 685,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 686,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 687,                    /* -ffloat-store */
  OPT_ffor_scope = 688,                      /* -ffor-scope */
  /* OPT_fforce_addr = 689, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 690,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 691,              /* -fforward-propagate */
  OPT_ffp_contract_ = 692,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 693,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 694,                      /* -ffpe-trap= */
  OPT_ffree_form = 695,                      /* -ffree-form */
  OPT_ffree_line_length_ = 696,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 697,          /* -ffree-line-length-none */
  OPT_ffreestanding = 698,                   /* -ffreestanding */
  OPT_ffriend_injection = 699,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 700,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 701,                   /* -ffunction-cse */
  OPT_ffunction_sections = 702,              /* -ffunction-sections */
  OPT_fgcse = 703,                           /* -fgcse */
  OPT_fgcse_after_reload = 704,              /* -fgcse-after-reload */
  OPT_fgcse_las = 705,                       /* -fgcse-las */
  OPT_fgcse_lm = 706,                        /* -fgcse-lm */
  OPT_fgcse_sm = 707,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 708,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 709,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 710,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 711,                         /* -fgnu-tm */
  OPT_fgnu_unique = 712,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 713,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 714,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 715,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 716,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 717,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 718,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 719,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 720,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 721,                       /* -fgraphite */
  OPT_fgraphite_identity = 722,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 723,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 724, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 725, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 726,           /* -fhash-synchronization */
  /* OPT_fhelp = 727, */                     /* -fhelp */
  /* OPT_fhelp_ = 728, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 729,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 730, */                /* -fhonor-std */
  OPT_fhosted = 731,                         /* -fhosted */
  /* OPT_fhuge_objects = 732, */             /* -fhuge-objects */
  OPT_fident = 733,                          /* -fident */
  OPT_fif_conversion = 734,                  /* -fif-conversion */
  OPT_fif_conversion2 = 735,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 736,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 737,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 738,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 739,             /* -fimplicit-templates */
  OPT_findirect_classes = 740,               /* -findirect-classes */
  OPT_findirect_dispatch = 741,              /* -findirect-dispatch */
  OPT_findirect_inlining = 742,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 743,         /* -finhibit-size-directive */
  OPT_finit_character_ = 744,                /* -finit-character= */
  OPT_finit_integer_ = 745,                  /* -finit-integer= */
  OPT_finit_local_zero = 746,                /* -finit-local-zero */
  OPT_finit_logical_ = 747,                  /* -finit-logical= */
  OPT_finit_real_ = 748,                     /* -finit-real= */
  OPT_finline = 749,                         /* -finline */
  OPT_finline_atomics = 750,                 /* -finline-atomics */
  OPT_finline_functions = 751,               /* -finline-functions */
  OPT_finline_functions_called_once = 752,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 753, */            /* -finline-limit- */
  OPT_finline_limit_ = 754,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 755,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 756,         /* -finline-small-functions */
  OPT_finput_charset_ = 757,                 /* -finput-charset= */
  OPT_finstrument_functions = 758,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 759,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 760,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 761,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 762,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 763,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 764,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 765,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 766,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 767,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 768,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 769,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 770, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 771,                    /* -fipa-profile */
  OPT_fipa_pta = 772,                        /* -fipa-pta */
  OPT_fipa_pure_const = 773,                 /* -fipa-pure-const */
  OPT_fipa_ra = 774,                         /* -fipa-ra */
  OPT_fipa_reference = 775,                  /* -fipa-reference */
  OPT_fipa_sra = 776,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 777, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 778,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 779,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 780,              /* -fira-loop-pressure */
  OPT_fira_region_ = 781,                    /* -fira-region= */
  OPT_fira_share_save_slots = 782,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 783,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 784,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 785,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 786,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 787,               /* -fivar-visibility= */
  OPT_fivopts = 788,                         /* -fivopts */
  OPT_fjni = 789,                            /* -fjni */
  OPT_fjump_tables = 790,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 791,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 792,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 793,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 794,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 795,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 796, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 797,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 798,             /* -fleading-underscore */
  OPT_flifetime_dse = 799,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 800,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 801,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 802,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 803,                    /* -flocal-ivars */
  /* OPT_floop_block = 804, */               /* -floop-block */
  /* OPT_floop_flatten = 805, */             /* -floop-flatten */
  /* OPT_floop_interchange = 806, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 807,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 808, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 809,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 810, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 811, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 812,                      /* -flra-remat */
  OPT_flto = 813,                            /* -flto */
  OPT_flto_compression_level_ = 814,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 815,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 816,                 /* -flto-partition= */
  OPT_flto_report = 817,                     /* -flto-report */
  OPT_flto_report_wpa = 818,                 /* -flto-report-wpa */
  OPT_flto_ = 819,                           /* -flto= */
  OPT_fltrans = 820,                         /* -fltrans */
  OPT_fltrans_output_list_ = 821,            /* -fltrans-output-list= */
  OPT_fmain_ = 822,                          /* -fmain= */
  OPT_fmath_errno = 823,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 824,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 825,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 826,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 827,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 828,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 829,                     /* -fmem-report */
  OPT_fmem_report_wpa = 830,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 831,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 832,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 833,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 834,                /* -fmessage-length= */
  OPT_fmodule_private = 835,                 /* -fmodule-private */
  OPT_fmodulo_sched = 836,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 837,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 838,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 839,                  /* -fms-extensions */
  /* OPT_fmudflap = 840, */                  /* -fmudflap */
  /* OPT_fmudflapir = 841, */                /* -fmudflapir */
  /* OPT_fmudflapth = 842, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 843, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 844, */                  /* -fnew-abi */
  OPT_fnext_runtime = 845,                   /* -fnext-runtime */
  OPT_fnil_receivers = 846,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 847, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 848,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 849,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 850, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 851,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 852,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 853,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 854,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 855,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 856,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 857,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 858,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 859,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 860,                   /* -foffload-abi= */
  OPT_foffload_ = 861,                       /* -foffload= */
  OPT_fomit_frame_pointer = 862,             /* -fomit-frame-pointer */
  OPT_fopenacc = 863,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 864,                   /* -fopenacc-dim= */
  OPT_fopenmp = 865,                         /* -fopenmp */
  OPT_fopenmp_simd = 866,                    /* -fopenmp-simd */
  OPT_foperator_names = 867,                 /* -foperator-names */
  OPT_fopt_info = 868,                       /* -fopt-info */
  OPT_fopt_info_ = 869,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 870, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 871,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 872,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 873,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 874, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 875,              /* -foutput-class-dir= */
  OPT_fpack_derived = 876,                   /* -fpack-derived */
  OPT_fpack_struct = 877,                    /* -fpack-struct */
  OPT_fpack_struct_ = 878,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 879,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 880,              /* -fpcc-struct-return */
  OPT_fpch_deps = 881,                       /* -fpch-deps */
  OPT_fpch_preprocess = 882,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 883,                     /* -fpeel-loops */
  OPT_fpeephole = 884,                       /* -fpeephole */
  OPT_fpeephole2 = 885,                      /* -fpeephole2 */
  OPT_fpermissive = 886,                     /* -fpermissive */
  OPT_fpic = 887,                            /* -fpic */
  OPT_fpie = 888,                            /* -fpie */
  OPT_fplan9_extensions = 889,               /* -fplan9-extensions */
  OPT_fplt = 890,                            /* -fplt */
  OPT_fplugin_arg_ = 891,                    /* -fplugin-arg- */
  OPT_fplugin_ = 892,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 893,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 894,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 895,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 896,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 897,                   /* -fpreprocessed */
  OPT_fpretty_templates = 898,               /* -fpretty-templates */
  OPT_fprofile = 899,                        /* -fprofile */
  OPT_fprofile_arcs = 900,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 901,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 902,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 903,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 904,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 905,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 906,                 /* -fprofile-report */
  OPT_fprofile_use = 907,                    /* -fprofile-use */
  OPT_fprofile_use_ = 908,                   /* -fprofile-use= */
  OPT_fprofile_values = 909,                 /* -fprofile-values */
  OPT_fprotect_parens = 910,                 /* -fprotect-parens */
  OPT_frandom_seed = 911,                    /* -frandom-seed */
  OPT_frandom_seed_ = 912,                   /* -frandom-seed= */
  OPT_frange_check = 913,                    /* -frange-check */
  OPT_freal_4_real_10 = 914,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 915,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 916,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 917,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 918,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 919,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 920,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 921,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 922,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 923,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 924,                /* -frecord-marker=8 */
  OPT_frecursive = 925,                      /* -frecursive */
  OPT_freduced_reflection = 926,             /* -freduced-reflection */
  OPT_free = 927,                            /* -free */
  OPT_freg_struct_return = 928,              /* -freg-struct-return */
  /* OPT_fregmove = 929, */                  /* -fregmove */
  OPT_frename_registers = 930,               /* -frename-registers */
  OPT_freorder_blocks = 931,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 932,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 933,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 934,              /* -freorder-functions */
  OPT_frepack_arrays = 935,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 936,           /* -freplace-objc-classes */
  OPT_frepo = 937,                           /* -frepo */
  OPT_freport_bug = 938,                     /* -freport-bug */
  OPT_frequire_return_statement = 939,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 940,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 941, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 942,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 943,                    /* -fresolution= */
  OPT_frounding_math = 944,                  /* -frounding-math */
  OPT_frtti = 945,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 946,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 947,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 948,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 949,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 950,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 951,                      /* -fsanitize= */
  OPT_fsaw_java_file = 952,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 953,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 954,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 955,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 956,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 957,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 958,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 959,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 960,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 961,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 962,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 963,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 964,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 965,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 966,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 967,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 968,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 969,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 970, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 971,                /* -fschedule-fusion */
  OPT_fschedule_insns = 972,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 973,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 974,              /* -fsecond-underscore */
  OPT_fsection_anchors = 975,                /* -fsection-anchors */
  /* OPT_fsee = 976, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 977,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 978,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 979, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 980,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 981,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 982,         /* -fsemantic-interposition */
  OPT_fshort_enums = 983,                    /* -fshort-enums */
  OPT_fshort_wchar = 984,                    /* -fshort-wchar */
  OPT_fshow_column = 985,                    /* -fshow-column */
  OPT_fshrink_wrap = 986,                    /* -fshrink-wrap */
  OPT_fsign_zero = 987,                      /* -fsign-zero */
  OPT_fsignaling_nans = 988,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 989,               /* -fsigned-bitfields */
  OPT_fsigned_char = 990,                    /* -fsigned-char */
  OPT_fsigned_zeros = 991,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 992,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 993,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 994,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 995,               /* -fsource-filename= */
  OPT_fsource_ = 996,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 997,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 998,                    /* -fsplit-paths */
  OPT_fsplit_stack = 999,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 1000,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1001, */                /* -fsquangle */
  OPT_fssa_backprop = 1002,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1003,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1004,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1005,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1006, */             /* -fstack-check */
  OPT_fstack_check_ = 1007,                  /* -fstack-check= */
  OPT_fstack_limit = 1008,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1009,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1010,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1011,               /* -fstack-protector */
  OPT_fstack_protector_all = 1012,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1013,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1014,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1015,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1016,                   /* -fstack-usage */
  OPT_fstats = 1017,                         /* -fstats */
  OPT_fstdarg_opt = 1018,                    /* -fstdarg-opt */
  OPT_fstore_check = 1019,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1020, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1021,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1022,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1023,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1024, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1025,     /* -fstrict-volatile-bitfields */
  ...
  OPT_ftarget_ = 1030,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1031,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1032, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1033,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1034,                 /* -ftest-coverage */
  ...
  OPT_ftls_model_ = 1039,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1040,              /* -ftoplevel-reorder */
  OPT_ftracer = 1041,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1042,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1043,        /* -ftrack-macro-expansion= */
  ...
  OPT_fuse_atomic_builtins = 1102,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1103,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1104,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1105,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1106,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1107,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1108,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1109,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1110,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1111,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1112,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1113,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1114,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1115, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1116,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1117,                   /* -fverbose-asm */
  /* OPT_fversion = 1118, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1119,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1120,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1121,                   /* -fvisibility= */
  OPT_fvpt = 1122,                           /* -fvpt */
  /* OPT_fvtable_gc = 1123, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1124, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1125,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1126,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1127,                     /* -fvtv-debug */
  OPT_fweak = 1128,                          /* -fweak */
  OPT_fweb = 1129,                           /* -fweb */
  /* OPT_fwhole_file = 1130, */              /* -fwhole-file */
  OPT_fwhole_program = 1131,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1132,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1133,             /* -fworking-directory */
  OPT_fwpa = 1134,                           /* -fwpa */
  OPT_fwpa_ = 1135,                          /* -fwpa= */
  OPT_fwrapv = 1136,                         /* -fwrapv */
  ...
  OPT_gdwarf = 1144,                         /* -gdwarf */
  OPT_gdwarf_ = 1145,                        /* -gdwarf- */
  OPT_gen_decls = 1146,                      /* -gen-decls */
  OPT_ggdb = 1147,                           /* -ggdb */
  OPT_ggnu_pubnames = 1148,                  /* -ggnu-pubnames */
  OPT_gnat = 1149,                           /* -gnat */
  OPT_gnatO = 1150,                          /* -gnatO */
  OPT_gno_pubnames = 1151,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1152,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1153,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1154,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1155,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1156,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1157,                   /* -gsplit-dwarf */
  OPT_gstabs = 1158,                         /* -gstabs */
  OPT_gstabs_ = 1159,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1160,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1161,                        /* -gtoggle */
  OPT_gvms = 1162,                           /* -gvms */
  OPT_gxcoff = 1163,                         /* -gxcoff */
  OPT_gxcoff_ = 1164,                        /* -gxcoff+ */
  OPT_gz = 1165,                             /* -gz */
  OPT_gz_ = 1166,                            /* -gz= */
  OPT_h = 1167,                              /* -h */
  OPT_idirafter = 1168,                      /* -idirafter */
  OPT_imacros = 1169,                        /* -imacros */
  OPT_imultiarch = 1170,                     /* -imultiarch */
  OPT_imultilib = 1171,                      /* -imultilib */
  OPT_include = 1172,                        /* -include */
  OPT_iplugindir_ = 1173,                    /* -iplugindir= */
  OPT_iprefix = 1174,                        /* -iprefix */
  OPT_iquote = 1175,                         /* -iquote */
  OPT_isysroot = 1176,                       /* -isysroot */
  OPT_isystem = 1177,                        /* -isystem */
  OPT_iwithprefix = 1178,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1179,              /* -iwithprefixbefore */
  OPT_k8 = 1180,                             /* -k8 */
  OPT_l = 1181,                              /* -l */
  OPT_lang_asm = 1182,                       /* -lang-asm */
  OPT_mA6 = 1183,                            /* -mA6 */
  OPT_mA7 = 1184,                            /* -mA7 */
  OPT_mARC600 = 1185,                        /* -mARC600 */
  OPT_mARC601 = 1186,                        /* -mARC601 */
  OPT_mARC700 = 1187,                        /* -mARC700 */
  OPT_mEA = 1188,                            /* -mEA */
  OPT_mRcq = 1189,                           /* -mRcq */
  OPT_mRcw = 1190,                           /* -mRcw */
  OPT_malign_call = 1191,                    /* -malign-call */
  OPT_mannotate_align = 1192,                /* -mannotate-align */
  OPT_marclinux = 1193,                      /* -marclinux */
  OPT_marclinux_prof = 1194,                 /* -marclinux_prof */
  OPT_margonaut = 1195,                      /* -margonaut */
  OPT_matomic = 1196,                        /* -matomic */
  OPT_mauto_modify_reg = 1197,               /* -mauto-modify-reg */
  OPT_mbarrel_shifter = 1198,                /* -mbarrel-shifter */
  OPT_mbbit_peephole = 1199,                 /* -mbbit-peephole */
  OPT_mbig_endian = 1200,                    /* -mbig-endian */
  OPT_mbitops = 1201,                        /* -mbitops */
  OPT_mcase_vector_pcrel = 1202,             /* -mcase-vector-pcrel */
  OPT_mcmem = 1203,                          /* -mcmem */
  OPT_mcode_density = 1204,                  /* -mcode-density */
  OPT_mcompact_casesi = 1205,                /* -mcompact-casesi */
  OPT_mcpu_ = 1206,                          /* -mcpu= */
  OPT_mcrc = 1207,                           /* -mcrc */
  OPT_mdiv_rem = 1208,                       /* -mdiv-rem */
  OPT_mdpfp = 1209,                          /* -mdpfp */
  OPT_mdpfp_compact = 1210,                  /* -mdpfp-compact */
  OPT_mdpfp_fast = 1211,                     /* -mdpfp-fast */
  OPT_mdsp_packa = 1212,                     /* -mdsp-packa */
  OPT_mdvbf = 1213,                          /* -mdvbf */
  OPT_mea = 1214,                            /* -mea */
  OPT_mearly_cbranchsi = 1215,               /* -mearly-cbranchsi */
  OPT_mexpand_adddi = 1216,                  /* -mexpand-adddi */
  OPT_mfpu_ = 1217,                          /* -mfpu= */
  OPT_mindexed_loads = 1218,                 /* -mindexed-loads */
  OPT_mirq_ctrl_saved_ = 1219,               /* -mirq-ctrl-saved= */
  OPT_misize = 1220,                         /* -misize */
  OPT_mlittle_endian = 1221,                 /* -mlittle-endian */
  OPT_mll64 = 1222,                          /* -mll64 */
  OPT_mlock = 1223,                          /* -mlock */
  OPT_mlong_calls = 1224,                    /* -mlong-calls */
  OPT_mlra = 1225,                           /* -mlra */
  OPT_mlra_priority_compact = 1226,          /* -mlra-priority-compact */
  OPT_mlra_priority_noncompact = 1227,       /* -mlra-priority-noncompact */
  OPT_mlra_priority_none = 1228,             /* -mlra-priority-none */
  OPT_mmac_24 = 1229,                        /* -mmac-24 */
  OPT_mmac_d16 = 1230,                       /* -mmac-d16 */
  OPT_mmedium_calls = 1231,                  /* -mmedium-calls */
  OPT_mmixed_code = 1232,                    /* -mmixed-code */
  OPT_mmpy_option_ = 1233,                   /* -mmpy-option= */
  OPT_mmul32x16 = 1234,                      /* -mmul32x16 */
  OPT_mmul64 = 1235,                         /* -mmul64 */
  OPT_mmultcost_ = 1236,                     /* -mmultcost= */
  OPT_mno_brcc = 1237,                       /* -mno-brcc */
  OPT_mno_cond_exec = 1238,                  /* -mno-cond-exec */
  OPT_mno_dpfp_lrsr = 1239,                  /* -mno-dpfp-lrsr */
  OPT_mno_millicode = 1240,                  /* -mno-millicode */
  OPT_mno_mpy = 1241,                        /* -mno-mpy */
  OPT_mno_volatile_cache = 1242,             /* -mno-volatile-cache */
  OPT_mnorm = 1243,                          /* -mnorm */
  OPT_mq_class = 1244,                       /* -mq-class */
  OPT_mrgf_banked_regs_ = 1245,              /* -mrgf-banked-regs= */
  OPT_mrtsc = 1246,                          /* -mrtsc */
  OPT_msdata = 1247,                         /* -msdata */
  OPT_msimd = 1248,                          /* -msimd */
  OPT_msize_level_ = 1249,                   /* -msize-level= */
  OPT_msoft_float = 1250,                    /* -msoft-float */
  OPT_mspfp = 1251,                          /* -mspfp */
  OPT_mspfp_compact = 1252,                  /* -mspfp-compact */
  OPT_mspfp_fast = 1253,                     /* -mspfp-fast */
  OPT_mswap = 1254,                          /* -mswap */
  OPT_mswape = 1255,                         /* -mswape */
  OPT_mtelephony = 1256,                     /* -mtelephony */
  OPT_mtp_regno_ = 1257,                     /* -mtp-regno= */
  OPT_mtp_regno_none = 1258,                 /* -mtp-regno=none */
  OPT_mtune_ARC600 = 1259,                   /* -mtune=ARC600 */
  OPT_mtune_ARC601 = 1260,                   /* -mtune=ARC601 */
  OPT_mtune_ARC700 = 1261,                   /* -mtune=ARC700 */
  OPT_mtune_ARC700_xmac = 1262,              /* -mtune=ARC700-xmac */
  OPT_mtune_ARC725D = 1263,                  /* -mtune=ARC725D */
  OPT_mtune_ARC750D = 1264,                  /* -mtune=ARC750D */
  OPT_multcost_ = 1265,                      /* -multcost= */
  OPT_munalign_prob_threshold_ = 1266,       /* -munalign-prob-threshold= */
  OPT_munaligned_access = 1267,              /* -munaligned-access */
  OPT_mvolatile_cache = 1268,                /* -mvolatile-cache */
  OPT_mxy = 1269,                            /* -mxy */
  OPT_n = 1270,                              /* -n */
  OPT_no_canonical_prefixes = 1271,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1272,              /* -no-integrated-cpp */
  OPT_no_pie = 1273,                         /* -no-pie */
  OPT_nocpp = 1274,                          /* -nocpp */
  OPT_nodefaultlibs = 1275,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1276,                   /* -nostartfiles */
  OPT_nostdinc = 1277,                       /* -nostdinc */
  OPT_nostdinc__ = 1278,                     /* -nostdinc++ */
  OPT_nostdlib = 1279,                       /* -nostdlib */
  OPT_o = 1280,                              /* -o */
  OPT_p = 1281,                              /* -p */
  OPT_pass_exit_codes = 1282,                /* -pass-exit-codes */
  /* OPT_pedantic = 1283, */                 /* -pedantic */
  OPT_pedantic_errors = 1284,                /* -pedantic-errors */
  OPT_pg = 1285,                             /* -pg */
  OPT_pie = 1286,                            /* -pie */
  OPT_pipe = 1287,                           /* -pipe */
  OPT_print_file_name_ = 1288,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1289,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1290,          /* -print-multi-directory */
  OPT_print_multi_lib = 1291,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1292,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1293,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1294,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1295,               /* -print-prog-name= */
  OPT_print_search_dirs = 1296,              /* -print-search-dirs */
  OPT_print_sysroot = 1297,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1298,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1299,                          /* -quiet */
  OPT_r = 1300,                              /* -r */
  OPT_remap = 1301,                          /* -remap */
  OPT_s = 1302,                              /* -s */
  OPT_s_bc_abi = 1303,                       /* -s-bc-abi */
  OPT_save_temps = 1304,                     /* -save-temps */
  OPT_save_temps_ = 1305,                    /* -save-temps= */
  OPT_shared = 1306,                         /* -shared */
  OPT_shared_libgcc = 1307,                  /* -shared-libgcc */
  /* OPT_specs = 1308, */                    /* -specs */
  OPT_specs_ = 1309,                         /* -specs= */
  OPT_static = 1310,                         /* -static */
  OPT_static_libasan = 1311,                 /* -static-libasan */
  OPT_static_libgcc = 1312,                  /* -static-libgcc */
  OPT_static_libgcj = 1313,                  /* -static-libgcj */
  OPT_static_libgfortran = 1314,             /* -static-libgfortran */
  OPT_static_libgo = 1315,                   /* -static-libgo */
  OPT_static_liblsan = 1316,                 /* -static-liblsan */
  OPT_static_libmpx = 1317,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1318,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1319,               /* -static-libstdc++ */
  OPT_static_libtsan = 1320,                 /* -static-libtsan */
  OPT_static_libubsan = 1321,                /* -static-libubsan */
  /* OPT_std_c__03 = 1322, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1323, */                /* -std=c++0x */
  OPT_std_c__11 = 1324,                      /* -std=c++11 */
  OPT_std_c__14 = 1325,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1326, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1327, */                /* -std=c++1y */
  OPT_std_c__1z = 1328,                      /* -std=c++1z */
  OPT_std_c__98 = 1329,                      /* -std=c++98 */
  OPT_std_c11 = 1330,                        /* -std=c11 */
  /* OPT_std_c1x = 1331, */                  /* -std=c1x */
  /* OPT_std_c89 = 1332, */                  /* -std=c89 */
  OPT_std_c90 = 1333,                        /* -std=c90 */
  OPT_std_c99 = 1334,                        /* -std=c99 */
  /* OPT_std_c9x = 1335, */                  /* -std=c9x */
  OPT_std_f2003 = 1336,                      /* -std=f2003 */
  OPT_std_f2008 = 1337,                      /* -std=f2008 */
  OPT_std_f2008ts = 1338,                    /* -std=f2008ts */
  OPT_std_f95 = 1339,                        /* -std=f95 */
  OPT_std_gnu = 1340,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1341, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1342, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1343,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1344,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1345, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1346, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1347,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1348,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1349,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1350, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1351, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1352,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1353,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1354, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1355, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1356,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1357, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1358, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1359, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1360,                     /* -std=legacy */
  OPT_symbolic = 1361,                       /* -symbolic */
  OPT_t = 1362,                              /* -t */
  OPT_time = 1363,                           /* -time */
  OPT_time_ = 1364,                          /* -time= */
  OPT_traditional = 1365,                    /* -traditional */
  OPT_traditional_cpp = 1366,                /* -traditional-cpp */
  OPT_trigraphs = 1367,                      /* -trigraphs */
  OPT_u = 1368,                              /* -u */
  OPT_undef = 1369,                          /* -undef */
  OPT_v = 1370,                              /* -v */
  OPT_version = 1371,                        /* -version */
  OPT_w = 1372,                              /* -w */
  OPT_wrapper = 1373,                        /* -wrapper */
  OPT_x = 1374,                              /* -x */
  OPT_z = 1375,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
