...
#define MASK_AUTO_LITPOOLS (1 << 0)
#define MASK_CONST16 (1 << 1)
...
enum opt_code
{
  ...
  OPT_mauto_litpools = 1183,                 /* -mauto-litpools */
  OPT_mconst16 = 1184,                       /* -mconst16 */
  OPT_mforce_no_pic = 1185,                  /* -mforce-no-pic */
  /* OPT_mfused_madd = 1186, */              /* -mfused-madd */
  OPT_mlongcalls = 1187,                     /* -mlongcalls */
  OPT_mserialize_volatile = 1188,            /* -mserialize-volatile */
  OPT_mtarget_align = 1189,                  /* -mtarget-align */
  OPT_mtext_section_literals = 1190,         /* -mtext-section-literals */
  OPT_n = 1191,                              /* -n */
  ...
  OPT_nostdlib__ = 1201,                     /* -nostdlib++ */
  OPT_o = 1202,                              /* -o */
  OPT_p = 1203,                              /* -p */
  OPT_pass_exit_codes = 1204,                /* -pass-exit-codes */
  /* OPT_pedantic = 1205, */                 /* -pedantic */
  OPT_pedantic_errors = 1206,                /* -pedantic-errors */
  OPT_pg = 1207,                             /* -pg */
  OPT_pie = 1208,                            /* -pie */
  OPT_pipe = 1209,                           /* -pipe */
  OPT_print_file_name_ = 1210,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1211,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1212,          /* -print-multi-directory */
  OPT_print_multi_lib = 1213,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1214,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1215,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1216,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1217,               /* -print-prog-name= */
  OPT_print_search_dirs = 1218,              /* -print-search-dirs */
  OPT_print_sysroot = 1219,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1220,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1221,                          /* -quiet */
  OPT_r = 1222,                              /* -r */
  OPT_rdynamic = 1223,                       /* -rdynamic */
  OPT_remap = 1224,                          /* -remap */
  OPT_s = 1225,                              /* -s */
  OPT_s_bc_abi = 1226,                       /* -s-bc-abi */
  OPT_save_temps = 1227,                     /* -save-temps */
  OPT_save_temps_ = 1228,                    /* -save-temps= */
  OPT_shared = 1229,                         /* -shared */
  OPT_shared_libgcc = 1230,                  /* -shared-libgcc */
  /* OPT_specs = 1231, */                    /* -specs */
  OPT_specs_ = 1232,                         /* -specs= */
  OPT_static = 1233,                         /* -static */
  OPT_static_libasan = 1234,                 /* -static-libasan */
  OPT_static_libgcc = 1235,                  /* -static-libgcc */
  OPT_static_libgcj = 1236,                  /* -static-libgcj */
  OPT_static_libgfortran = 1237,             /* -static-libgfortran */
  OPT_static_libgo = 1238,                   /* -static-libgo */
  OPT_static_liblsan = 1239,                 /* -static-liblsan */
  OPT_static_libmpx = 1240,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1241,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1242,               /* -static-libstdc++ */
  OPT_static_libtsan = 1243,                 /* -static-libtsan */
  OPT_static_libubsan = 1244,                /* -static-libubsan */
  /* OPT_std_c__03 = 1245, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1246, */                /* -std=c++0x */
  OPT_std_c__11 = 1247,                      /* -std=c++11 */
  OPT_std_c__14 = 1248,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1249, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1250, */                /* -std=c++1y */
  OPT_std_c__1z = 1251,                      /* -std=c++1z */
  ...
  /* OPT_std_gnu__17 = 1268, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1269, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1270,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1271,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1272,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1273, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1274, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1275,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1276,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1277, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1278, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1279,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1280, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1281, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1282, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1283,                     /* -std=legacy */
  OPT_symbolic = 1284,                       /* -symbolic */
  OPT_t = 1285,                              /* -t */
  OPT_time = 1286,                           /* -time */
  OPT_time_ = 1287,                          /* -time= */
