...
#define TARGET_HAVE_MEMORY_BARRIER hook_bool_void_true
...
static rtx_insn *
target_gen_nonlocal_goto (rtx x0, rtx x1, rtx x2, rtx x3)
{
  return insnify (gen_nonlocal_goto (x0, x1, x2, x3));
}

#undef TARGET_HAVE_NONLOCAL_GOTO
#define TARGET_HAVE_NONLOCAL_GOTO hook_bool_void_true
#undef TARGET_GEN_NONLOCAL_GOTO
#define TARGET_GEN_NONLOCAL_GOTO target_gen_nonlocal_goto
#undef TARGET_CODE_FOR_NONLOCAL_GOTO
#define TARGET_CODE_FOR_NONLOCAL_GOTO CODE_FOR_nonlocal_goto
...
{
  return 
#line 1666 "../../../../../../../work-shared/gcc-6.2.0-r0/gcc-6.2.0/gcc/config/xtensa/xtensa.md"
...
#define TARGET_HAVE_SIBCALL hook_bool_void_false
#undef TARGET_GEN_SIBCALL
#define TARGET_GEN_SIBCALL invalid_rtx_rtx_rtx_rtx
#undef TARGET_CODE_FOR_SIBCALL
#define TARGET_CODE_FOR_SIBCALL CODE_FOR_nothing

#undef TARGET_HAVE_SIBCALL_EPILOGUE
#define TARGET_HAVE_SIBCALL_EPILOGUE hook_bool_void_false
#undef TARGET_GEN_SIBCALL_EPILOGUE
#define TARGET_GEN_SIBCALL_EPILOGUE invalid_void
...
#define TARGET_HAVE_SIBCALL_VALUE hook_bool_void_false
#undef TARGET_GEN_SIBCALL_VALUE
#define TARGET_GEN_SIBCALL_VALUE invalid_rtx_rtx_rtx_rtx_rtx
