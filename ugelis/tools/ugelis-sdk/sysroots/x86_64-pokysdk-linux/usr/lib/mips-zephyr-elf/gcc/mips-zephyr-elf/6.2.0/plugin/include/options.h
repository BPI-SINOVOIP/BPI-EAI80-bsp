...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 351,      /* -Wpoison-system-directories */
  ...
  OPT_c = 479,                               /* -c */
  /* OPT_classpath = 480, */                 /* -classpath */
  OPT_coverage = 481,                        /* -coverage */
  OPT_cpp = 482,                             /* -cpp */
  OPT_cpp_ = 483,                            /* -cpp= */
  OPT_d = 484,                               /* -d */
  OPT_dumpbase = 485,                        /* -dumpbase */
  OPT_dumpdir = 486,                         /* -dumpdir */
  OPT_dumpmachine = 487,                     /* -dumpmachine */
  OPT_dumpspecs = 488,                       /* -dumpspecs */
  OPT_dumpversion = 489,                     /* -dumpversion */
  OPT_e = 490,                               /* -e */
  /* OPT_encoding = 491, */                  /* -encoding */
  OPT_export_dynamic = 492,                  /* -export-dynamic */
  OPT_extdirs = 493,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 494, */               /* -fCLASSPATH= */
  OPT_fPIC = 495,                            /* -fPIC */
  OPT_fPIE = 496,                            /* -fPIE */
  OPT_fRTS_ = 497,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 498,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 499,                   /* -fabi-version= */
  OPT_faccess_control = 500,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 501,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 502,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 503,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 504,                  /* -falign-commons */
  OPT_falign_functions = 505,                /* -falign-functions */
  OPT_falign_functions_ = 506,               /* -falign-functions= */
  OPT_falign_jumps = 507,                    /* -falign-jumps */
  OPT_falign_jumps_ = 508,                   /* -falign-jumps= */
  OPT_falign_labels = 509,                   /* -falign-labels */
  OPT_falign_labels_ = 510,                  /* -falign-labels= */
  OPT_falign_loops = 511,                    /* -falign-loops */
  OPT_falign_loops_ = 512,                   /* -falign-loops= */
  OPT_fall_intrinsics = 513,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 514, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 515,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 516,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 517, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 518, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 519, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 520, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 521, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 522,            /* -fasan-shadow-offset= */
  OPT_fasm = 523,                            /* -fasm */
  OPT_fassert = 524,                         /* -fassert */
  OPT_fassociative_math = 525,               /* -fassociative-math */
  OPT_fassume_compiled = 526,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 527,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 528,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 529,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 530,                   /* -fauto-profile */
  OPT_fauto_profile_ = 531,                  /* -fauto-profile= */
  OPT_fautomatic = 532,                      /* -fautomatic */
  OPT_faux_classpath = 533,                  /* -faux-classpath */
  OPT_fbackslash = 534,                      /* -fbackslash */
  OPT_fbacktrace = 535,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 536,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 537,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 538,              /* -fbootstrap-classes */
  OPT_fbounds_check = 539,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 540,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 541,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 542,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 543,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 544,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 545,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 546,                        /* -fbuiltin */
  OPT_fbuiltin_ = 547,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 548,                 /* -fbuiltin-printf */
  OPT_fcall_saved_ = 549,                    /* -fcall-saved- */
  OPT_fcall_used_ = 550,                     /* -fcall-used- */
  OPT_fcaller_saves = 551,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 552,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 553,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 554,                /* -fcheck-data-deps */
  OPT_fcheck_new = 555,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 556,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 557,               /* -fcheck-references */
  OPT_fcheck_ = 558,                         /* -fcheck= */
  OPT_fchecking = 559,                       /* -fchecking */
  OPT_fchkp_check_incomplete_type = 560,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 561,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 562,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 563,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 564,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 565,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 566,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 567, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 568,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 569,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 570,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 571, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 572,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 573,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 574,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 575,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 576,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 577,                       /* -fcilkplus */
  OPT_fclasspath_ = 578,                     /* -fclasspath= */
  OPT_fcoarray_ = 579,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 580,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 581,                         /* -fcommon */
  OPT_fcompare_debug = 582,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 583,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 584,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 585,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 586,              /* -fcompile-resource= */
  OPT_fconcepts = 587,                       /* -fconcepts */
  OPT_fcond_mismatch = 588,                  /* -fcond-mismatch */
  OPT_fconserve_space = 589,                 /* -fconserve-space */
  OPT_fconserve_stack = 590,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 591,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 592,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 593,                       /* -fconvert= */
  OPT_fcprop_registers = 594,                /* -fcprop-registers */
  OPT_fcray_pointer = 595,                   /* -fcray-pointer */
  OPT_fcrossjumping = 596,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 597,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 598, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 599,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 600,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 601,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 602,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 603,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 604,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 605,                       /* -fdbg-cnt= */
  OPT_fdce = 606,                            /* -fdce */
  OPT_fdebug_cpp = 607,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 608,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 609,            /* -fdebug-types-section */
  OPT_fdec = 610,                            /* -fdec */
  OPT_fdec_structure = 611,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 612,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 613,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 614,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 615, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 616,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 617,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 618,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 619,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 620,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 621,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 622,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 623,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 624,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 625, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 626,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 627,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 628,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 629,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 630,                /* -fdirectives-only */
  OPT_fdisable_ = 631,                       /* -fdisable- */
  OPT_fdisable_assertions = 632,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 633,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 634,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 635,         /* -fdollars-in-identifiers */
  OPT_fdse = 636,                            /* -fdse */
  OPT_fdump_ = 637,                          /* -fdump- */
  OPT_fdump_ada_spec = 638,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 639,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 640, */                /* -fdump-core */
  OPT_fdump_final_insns = 641,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 642,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 643,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 644,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 645,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 646,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 647,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 648, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 649,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 650,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 651,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 652,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 653,                 /* -fearly-inlining */
  OPT_felide_constructors = 654,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 655,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 656, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 657,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 658,        /* -femit-class-debug-always */
  OPT_femit_class_file = 659,                /* -femit-class-file */
  OPT_femit_class_files = 660,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 661,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 662,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 663,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 664,                        /* -fenable- */
  OPT_fenable_assertions = 665,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 666,             /* -fenable-assertions= */
  OPT_fencoding_ = 667,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 668,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 669, */           /* -fenum-int-equiv */
  OPT_fexceptions = 670,                     /* -fexceptions */
  OPT_fexcess_precision_ = 671,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 672,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 673,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 674,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 675,                       /* -fextdirs= */
  OPT_fextended_identifiers = 676,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 677,                /* -fextern-tls-init */
  OPT_fexternal_blas = 678,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 679, */       /* -fexternal-templates */
  OPT_ff2c = 680,                            /* -ff2c */
  OPT_ffast_math = 681,                      /* -ffast-math */
  OPT_ffat_lto_objects = 682,                /* -ffat-lto-objects */
  OPT_ffile_prefix_map_ = 683,               /* -ffile-prefix-map= */
  OPT_ffilelist_file = 684,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 685,               /* -ffinite-math-only */
  OPT_ffixed_ = 686,                         /* -ffixed- */
  OPT_ffixed_form = 687,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 688,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 689,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 690,                    /* -ffloat-store */
  OPT_ffor_scope = 691,                      /* -ffor-scope */
  /* OPT_fforce_addr = 692, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 693,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 694,              /* -fforward-propagate */
  OPT_ffp_contract_ = 695,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 696,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 697,                      /* -ffpe-trap= */
  OPT_ffree_form = 698,                      /* -ffree-form */
  OPT_ffree_line_length_ = 699,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 700,          /* -ffree-line-length-none */
  OPT_ffreestanding = 701,                   /* -ffreestanding */
  OPT_ffriend_injection = 702,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 703,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 704,                   /* -ffunction-cse */
  OPT_ffunction_sections = 705,              /* -ffunction-sections */
  OPT_fgcse = 706,                           /* -fgcse */
  OPT_fgcse_after_reload = 707,              /* -fgcse-after-reload */
  OPT_fgcse_las = 708,                       /* -fgcse-las */
  OPT_fgcse_lm = 709,                        /* -fgcse-lm */
  OPT_fgcse_sm = 710,                        /* -fgcse-sm */
  OPT_fgnat_encodings_ = 711,                /* -fgnat-encodings= */
  OPT_fgnu_keywords = 712,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 713,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 714,                         /* -fgnu-tm */
  OPT_fgnu_unique = 715,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 716,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 717,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 718,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 719,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 720,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 721,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 722,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 723,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 724,                       /* -fgraphite */
  OPT_fgraphite_identity = 725,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 726,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 727, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 728, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 729,           /* -fhash-synchronization */
  /* OPT_fhelp = 730, */                     /* -fhelp */
  /* OPT_fhelp_ = 731, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 732,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 733, */                /* -fhonor-std */
  OPT_fhosted = 734,                         /* -fhosted */
  /* OPT_fhuge_objects = 735, */             /* -fhuge-objects */
  OPT_fident = 736,                          /* -fident */
  OPT_fif_conversion = 737,                  /* -fif-conversion */
  OPT_fif_conversion2 = 738,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 739,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 740,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 741,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 742,             /* -fimplicit-templates */
  OPT_findirect_classes = 743,               /* -findirect-classes */
  OPT_findirect_dispatch = 744,              /* -findirect-dispatch */
  OPT_findirect_inlining = 745,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 746,         /* -finhibit-size-directive */
  OPT_finit_character_ = 747,                /* -finit-character= */
  OPT_finit_integer_ = 748,                  /* -finit-integer= */
  OPT_finit_local_zero = 749,                /* -finit-local-zero */
  OPT_finit_logical_ = 750,                  /* -finit-logical= */
  OPT_finit_real_ = 751,                     /* -finit-real= */
  OPT_finline = 752,                         /* -finline */
  OPT_finline_atomics = 753,                 /* -finline-atomics */
  OPT_finline_functions = 754,               /* -finline-functions */
  OPT_finline_functions_called_once = 755,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 756, */            /* -finline-limit- */
  OPT_finline_limit_ = 757,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 758,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 759,         /* -finline-small-functions */
  OPT_finput_charset_ = 760,                 /* -finput-charset= */
  OPT_finstrument_functions = 761,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 762,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 763,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 764,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 765,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 766,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 767,                         /* -fipa-cp */
  OPT_fipa_cp_alignment = 768,               /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 769,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 770,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 771,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 772,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 773, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 774,                    /* -fipa-profile */
  OPT_fipa_pta = 775,                        /* -fipa-pta */
  OPT_fipa_pure_const = 776,                 /* -fipa-pure-const */
  OPT_fipa_ra = 777,                         /* -fipa-ra */
  OPT_fipa_reference = 778,                  /* -fipa-reference */
  OPT_fipa_sra = 779,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 780, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 781,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 782,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 783,              /* -fira-loop-pressure */
  OPT_fira_region_ = 784,                    /* -fira-region= */
  OPT_fira_share_save_slots = 785,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 786,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 787,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 788,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 789,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 790,               /* -fivar-visibility= */
  OPT_fivopts = 791,                         /* -fivopts */
  OPT_fjni = 792,                            /* -fjni */
  OPT_fjump_tables = 793,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 794,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 795,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 796,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 797,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 798,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 799, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 800,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 801,             /* -fleading-underscore */
  OPT_flifetime_dse = 802,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 803,                  /* -flifetime-dse= */
  OPT_flinker_output_ = 804,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 805,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 806,                    /* -flocal-ivars */
  /* OPT_floop_block = 807, */               /* -floop-block */
  /* OPT_floop_flatten = 808, */             /* -floop-flatten */
  /* OPT_floop_interchange = 809, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 810,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 811, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 812,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 813, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 814, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 815,                      /* -flra-remat */
  OPT_flto = 816,                            /* -flto */
  OPT_flto_compression_level_ = 817,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 818,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 819,                 /* -flto-partition= */
  OPT_flto_report = 820,                     /* -flto-report */
  OPT_flto_report_wpa = 821,                 /* -flto-report-wpa */
  OPT_flto_ = 822,                           /* -flto= */
  OPT_fltrans = 823,                         /* -fltrans */
  OPT_fltrans_output_list_ = 824,            /* -fltrans-output-list= */
  OPT_fmain_ = 825,                          /* -fmain= */
  OPT_fmath_errno = 826,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 827,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 828,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 829,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 830,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 831,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 832,                     /* -fmem-report */
  OPT_fmem_report_wpa = 833,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 834,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 835,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 836,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 837,                /* -fmessage-length= */
  OPT_fmodule_private = 838,                 /* -fmodule-private */
  OPT_fmodulo_sched = 839,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 840,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 841,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 842,                  /* -fms-extensions */
  /* OPT_fmudflap = 843, */                  /* -fmudflap */
  /* OPT_fmudflapir = 844, */                /* -fmudflapir */
  /* OPT_fmudflapth = 845, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 846, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 847, */                  /* -fnew-abi */
  OPT_fnext_runtime = 848,                   /* -fnext-runtime */
  OPT_fnil_receivers = 849,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 850, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 851,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 852,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 853, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 854,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 855,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 856,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 857,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 858,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 859,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 860,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 861,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 862,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 863,                   /* -foffload-abi= */
  OPT_foffload_ = 864,                       /* -foffload= */
  OPT_fomit_frame_pointer = 865,             /* -fomit-frame-pointer */
  OPT_fopenacc = 866,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 867,                   /* -fopenacc-dim= */
  OPT_fopenmp = 868,                         /* -fopenmp */
  OPT_fopenmp_simd = 869,                    /* -fopenmp-simd */
  OPT_foperator_names = 870,                 /* -foperator-names */
  OPT_fopt_info = 871,                       /* -fopt-info */
  OPT_fopt_info_ = 872,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 873, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 874,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 875,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 876,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 877, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 878,              /* -foutput-class-dir= */
  OPT_fpack_derived = 879,                   /* -fpack-derived */
  OPT_fpack_struct = 880,                    /* -fpack-struct */
  OPT_fpack_struct_ = 881,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 882,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 883,              /* -fpcc-struct-return */
  OPT_fpch_deps = 884,                       /* -fpch-deps */
  OPT_fpch_preprocess = 885,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 886,                     /* -fpeel-loops */
  OPT_fpeephole = 887,                       /* -fpeephole */
  OPT_fpeephole2 = 888,                      /* -fpeephole2 */
  OPT_fpermissive = 889,                     /* -fpermissive */
  OPT_fpic = 890,                            /* -fpic */
  OPT_fpie = 891,                            /* -fpie */
  OPT_fplan9_extensions = 892,               /* -fplan9-extensions */
  OPT_fplt = 893,                            /* -fplt */
  OPT_fplugin_arg_ = 894,                    /* -fplugin-arg- */
  OPT_fplugin_ = 895,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 896,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 897,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 898,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 899,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 900,                   /* -fpreprocessed */
  OPT_fpretty_templates = 901,               /* -fpretty-templates */
  OPT_fprofile = 902,                        /* -fprofile */
  OPT_fprofile_arcs = 903,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 904,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 905,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 906,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 907,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 908,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 909,                 /* -fprofile-report */
  OPT_fprofile_use = 910,                    /* -fprofile-use */
  OPT_fprofile_use_ = 911,                   /* -fprofile-use= */
  OPT_fprofile_values = 912,                 /* -fprofile-values */
  OPT_fprotect_parens = 913,                 /* -fprotect-parens */
  OPT_frandom_seed = 914,                    /* -frandom-seed */
  OPT_frandom_seed_ = 915,                   /* -frandom-seed= */
  OPT_frange_check = 916,                    /* -frange-check */
  OPT_freal_4_real_10 = 917,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 918,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 919,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 920,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 921,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 922,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 923,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 924,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 925,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 926,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 927,                /* -frecord-marker=8 */
  OPT_frecursive = 928,                      /* -frecursive */
  OPT_freduced_reflection = 929,             /* -freduced-reflection */
  OPT_free = 930,                            /* -free */
  OPT_freg_struct_return = 931,              /* -freg-struct-return */
  /* OPT_fregmove = 932, */                  /* -fregmove */
  OPT_frename_registers = 933,               /* -frename-registers */
  OPT_freorder_blocks = 934,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 935,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 936,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 937,              /* -freorder-functions */
  OPT_frepack_arrays = 938,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 939,           /* -freplace-objc-classes */
  OPT_frepo = 940,                           /* -frepo */
  OPT_freport_bug = 941,                     /* -freport-bug */
  OPT_frequire_return_statement = 942,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 943,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 944, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 945,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 946,                    /* -fresolution= */
  OPT_frounding_math = 947,                  /* -frounding-math */
  OPT_frtti = 948,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 949,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 950,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 951,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 952,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 953,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 954,                      /* -fsanitize= */
  OPT_fsaw_java_file = 955,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 956,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 957,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 958,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 959,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 960,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 961,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 962,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 963,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 964,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 965,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 966,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 967,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 968,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 969,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 970,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 971,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 972,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 973, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 974,                /* -fschedule-fusion */
  OPT_fschedule_insns = 975,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 976,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 977,              /* -fsecond-underscore */
  OPT_fsection_anchors = 978,                /* -fsection-anchors */
  /* OPT_fsee = 979, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 980,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 981,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 982, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 983,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 984,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 985,         /* -fsemantic-interposition */
  OPT_fshort_enums = 986,                    /* -fshort-enums */
  OPT_fshort_wchar = 987,                    /* -fshort-wchar */
  OPT_fshow_column = 988,                    /* -fshow-column */
  OPT_fshrink_wrap = 989,                    /* -fshrink-wrap */
  OPT_fsign_zero = 990,                      /* -fsign-zero */
  OPT_fsignaling_nans = 991,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 992,               /* -fsigned-bitfields */
  OPT_fsigned_char = 993,                    /* -fsigned-char */
  OPT_fsigned_zeros = 994,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 995,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 996,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 997,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 998,               /* -fsource-filename= */
  OPT_fsource_ = 999,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 1000,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_paths = 1001,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1002,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1003,              /* -fsplit-wide-types */
  /* OPT_fsquangle = 1004, */                /* -fsquangle */
  OPT_fssa_backprop = 1005,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1006,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1007,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1008,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1009, */             /* -fstack-check */
  OPT_fstack_check_ = 1010,                  /* -fstack-check= */
  OPT_fstack_limit = 1011,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1012,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1013,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1014,               /* -fstack-protector */
  OPT_fstack_protector_all = 1015,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1016,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1017,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1018,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1019,                   /* -fstack-usage */
  OPT_fstats = 1020,                         /* -fstats */
  OPT_fstdarg_opt = 1021,                    /* -fstdarg-opt */
  OPT_fstore_check = 1022,                   /* -fstore-check */
  /* OPT_fstrength_reduce = 1023, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1024,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1025,                  /* -fstrict-enums */
  OPT_fstrict_overflow = 1026,               /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 1027, */        /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1028,     /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 1029,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1030,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1031,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1032, */             /* -ftarget-help */
  OPT_ftarget_ = 1033,                       /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 1034,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1035, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1036,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1037,                 /* -ftest-coverage */
  /* OPT_fthis_is_variable = 1038, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1039,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1040,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1041,                   /* -ftime-report */
  OPT_ftls_model_ = 1042,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1043,              /* -ftoplevel-reorder */
  OPT_ftracer = 1044,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1045,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1046,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1047,                 /* -ftrapping-math */
  OPT_ftrapv = 1048,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1049,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1050,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1051,                      /* -ftree-ccp */
  OPT_ftree_ch = 1052,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1053, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1054,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1055,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1056, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1057,                   /* -ftree-cselim */
  OPT_ftree_dce = 1058,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1059,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1060,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1061,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1062,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1063, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1064,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1065,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1066,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1067,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1068,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1069, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1070,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1071,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1072,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1073,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1074,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1075,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1076,                      /* -ftree-pre */
  OPT_ftree_pta = 1077,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1078,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1079, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1080,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1081,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1082,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1083,                     /* -ftree-slsr */
  OPT_ftree_sra = 1084,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1085, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1086, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1087,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1088,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1089,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1090, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1091,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1092, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1093,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1094,         /* -funconstrained-commons */
  OPT_funderscoring = 1095,                  /* -funderscoring */
  OPT_funit_at_a_time = 1096,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1097,              /* -funroll-all-loops */
  OPT_funroll_loops = 1098,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1099,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1100,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1101,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1102,                 /* -funsigned-char */
  OPT_funswitch_loops = 1103,                /* -funswitch-loops */
  OPT_funwind_tables = 1104,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1105,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1106,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1107,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1108,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1109,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1110,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1111,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1112,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1113,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1114,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1115,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1116,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1117,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1118, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1119,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1120,                   /* -fverbose-asm */
  /* OPT_fversion = 1121, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1122,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1123,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1124,                   /* -fvisibility= */
  OPT_fvpt = 1125,                           /* -fvpt */
  /* OPT_fvtable_gc = 1126, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1127, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1128,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1129,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1130,                     /* -fvtv-debug */
  OPT_fweak = 1131,                          /* -fweak */
  OPT_fweb = 1132,                           /* -fweb */
  /* OPT_fwhole_file = 1133, */              /* -fwhole-file */
  OPT_fwhole_program = 1134,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1135,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1136,             /* -fworking-directory */
  OPT_fwpa = 1137,                           /* -fwpa */
  OPT_fwpa_ = 1138,                          /* -fwpa= */
  OPT_fwrapv = 1139,                         /* -fwrapv */
  /* OPT_fxref = 1140, */                    /* -fxref */
  /* OPT_fzee = 1141, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1142,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1143,                     /* -fzero-link */
  OPT_g = 1144,                              /* -g */
  OPT_gant = 1145,                           /* -gant */
  OPT_gcoff = 1146,                          /* -gcoff */
  OPT_gdwarf = 1147,                         /* -gdwarf */
  OPT_gdwarf_ = 1148,                        /* -gdwarf- */
  OPT_gen_decls = 1149,                      /* -gen-decls */
  OPT_ggdb = 1150,                           /* -ggdb */
  OPT_ggnu_pubnames = 1151,                  /* -ggnu-pubnames */
  OPT_gnat = 1152,                           /* -gnat */
  OPT_gnatO = 1153,                          /* -gnatO */
  OPT_gno_pubnames = 1154,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1155,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1156,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1157,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1158,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1159,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1160,                   /* -gsplit-dwarf */
  OPT_gstabs = 1161,                         /* -gstabs */
  OPT_gstabs_ = 1162,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1163,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1164,                        /* -gtoggle */
  OPT_gvms = 1165,                           /* -gvms */
  OPT_gxcoff = 1166,                         /* -gxcoff */
  OPT_gxcoff_ = 1167,                        /* -gxcoff+ */
  OPT_gz = 1168,                             /* -gz */
  OPT_gz_ = 1169,                            /* -gz= */
  OPT_h = 1170,                              /* -h */
  OPT_idirafter = 1171,                      /* -idirafter */
  OPT_imacros = 1172,                        /* -imacros */
  OPT_imultiarch = 1173,                     /* -imultiarch */
  OPT_imultilib = 1174,                      /* -imultilib */
  OPT_include = 1175,                        /* -include */
  OPT_iplugindir_ = 1176,                    /* -iplugindir= */
  OPT_iprefix = 1177,                        /* -iprefix */
  OPT_iquote = 1178,                         /* -iquote */
  OPT_isysroot = 1179,                       /* -isysroot */
  OPT_isystem = 1180,                        /* -isystem */
  OPT_iwithprefix = 1181,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1182,              /* -iwithprefixbefore */
  OPT_k8 = 1183,                             /* -k8 */
  OPT_l = 1184,                              /* -l */
  OPT_lang_asm = 1185,                       /* -lang-asm */
  OPT_mabi_ = 1186,                          /* -mabi= */
  OPT_mabicalls = 1187,                      /* -mabicalls */
  OPT_mabs_ = 1188,                          /* -mabs= */
  OPT_march_ = 1189,                         /* -march= */
  OPT_mbranch_cost_ = 1190,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1191,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1192,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1193,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1194,             /* -mcompact-branches= */
  OPT_mdebug = 1195,                         /* -mdebug */
  OPT_mdebugd = 1196,                        /* -mdebugd */
  OPT_mdivide_breaks = 1197,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1198,                  /* -mdivide-traps */
  OPT_mdmx = 1199,                           /* -mdmx */
  OPT_mdouble_float = 1200,                  /* -mdouble-float */
  OPT_mdsp = 1201,                           /* -mdsp */
  OPT_mdspr2 = 1202,                         /* -mdspr2 */
  OPT_meb = 1203,                            /* -meb */
  OPT_mel = 1204,                            /* -mel */
  OPT_membedded_data = 1205,                 /* -membedded-data */
  OPT_meva = 1206,                           /* -meva */
  OPT_mexplicit_relocs = 1207,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1208,                  /* -mextern-sdata */
  OPT_mfix_24k = 1209,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1210,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1211,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1212,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1213,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1214,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1215,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1216,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1217,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1218,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1219,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1220,                 /* -mfp-exceptions */
  OPT_mfp32 = 1221,                          /* -mfp32 */
  OPT_mfp64 = 1222,                          /* -mfp64 */
  OPT_mfpxx = 1223,                          /* -mfpxx */
  OPT_mframe_header_opt = 1224,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1225, */              /* -mfused-madd */
  OPT_mgp32 = 1226,                          /* -mgp32 */
  OPT_mgp64 = 1227,                          /* -mgp64 */
  OPT_mgpopt = 1228,                         /* -mgpopt */
  OPT_mhard_float = 1229,                    /* -mhard-float */
  OPT_mimadd = 1230,                         /* -mimadd */
  OPT_minterlink_compressed = 1231,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1232,              /* -minterlink-mips16 */
  OPT_mips = 1233,                           /* -mips */
  OPT_mips16 = 1234,                         /* -mips16 */
  OPT_mips3d = 1235,                         /* -mips3d */
  OPT_mllsc = 1236,                          /* -mllsc */
  OPT_mload_store_pairs = 1237,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1238,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1239,                    /* -mlong-calls */
  OPT_mlong32 = 1240,                        /* -mlong32 */
  OPT_mlong64 = 1241,                        /* -mlong64 */
  OPT_mlra = 1242,                           /* -mlra */
  OPT_mmad = 1243,                           /* -mmad */
  OPT_mmcount_ra_address = 1244,             /* -mmcount-ra-address */
  OPT_mmcu = 1245,                           /* -mmcu */
  OPT_mmemcpy = 1246,                        /* -mmemcpy */
  OPT_mmicromips = 1247,                     /* -mmicromips */
  OPT_mmt = 1248,                            /* -mmt */
  OPT_mnan_ = 1249,                          /* -mnan= */
  OPT_mno_float = 1250,                      /* -mno-float */
  OPT_mno_flush_func = 1251,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1252,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1253,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1254,                     /* -mno-mips3d */
  OPT_modd_spreg = 1255,                     /* -modd-spreg */
  OPT_mpaired_single = 1256,                 /* -mpaired-single */
  OPT_mplt = 1257,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1258,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1259,               /* -mrelax-pic-calls */
  OPT_mshared = 1260,                        /* -mshared */
  OPT_msingle_float = 1261,                  /* -msingle-float */
  OPT_msmartmips = 1262,                     /* -msmartmips */
  OPT_msoft_float = 1263,                    /* -msoft-float */
  OPT_msplit_addresses = 1264,               /* -msplit-addresses */
  OPT_msym32 = 1265,                         /* -msym32 */
  OPT_msynci = 1266,                         /* -msynci */
  OPT_mtune_ = 1267,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1268,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1269,                          /* -mvirt */
  OPT_mvr4130_align = 1270,                  /* -mvr4130-align */
  OPT_mxgot = 1271,                          /* -mxgot */
  OPT_mxpa = 1272,                           /* -mxpa */
  OPT_n = 1273,                              /* -n */
  OPT_no_canonical_prefixes = 1274,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1275,              /* -no-integrated-cpp */
  OPT_no_pie = 1276,                         /* -no-pie */
  OPT_noasmopt = 1277,                       /* -noasmopt */
  OPT_nocpp = 1278,                          /* -nocpp */
  OPT_nodefaultlibs = 1279,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1280,                   /* -nostartfiles */
  OPT_nostdinc = 1281,                       /* -nostdinc */
  OPT_nostdinc__ = 1282,                     /* -nostdinc++ */
  OPT_nostdlib = 1283,                       /* -nostdlib */
  OPT_nostdlib__ = 1284,                     /* -nostdlib++ */
  OPT_o = 1285,                              /* -o */
  OPT_p = 1286,                              /* -p */
  OPT_pass_exit_codes = 1287,                /* -pass-exit-codes */
  /* OPT_pedantic = 1288, */                 /* -pedantic */
  OPT_pedantic_errors = 1289,                /* -pedantic-errors */
  OPT_pg = 1290,                             /* -pg */
  OPT_pie = 1291,                            /* -pie */
  OPT_pipe = 1292,                           /* -pipe */
  OPT_print_file_name_ = 1293,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1294,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1295,          /* -print-multi-directory */
  OPT_print_multi_lib = 1296,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1297,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1298,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1299,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1300,               /* -print-prog-name= */
  OPT_print_search_dirs = 1301,              /* -print-search-dirs */
  OPT_print_sysroot = 1302,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1303,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1304,                          /* -quiet */
  OPT_r = 1305,                              /* -r */
  OPT_remap = 1306,                          /* -remap */
  OPT_s = 1307,                              /* -s */
  OPT_s_bc_abi = 1308,                       /* -s-bc-abi */
  OPT_save_temps = 1309,                     /* -save-temps */
  OPT_save_temps_ = 1310,                    /* -save-temps= */
  OPT_shared = 1311,                         /* -shared */
  OPT_shared_libgcc = 1312,                  /* -shared-libgcc */
  /* OPT_specs = 1313, */                    /* -specs */
  OPT_specs_ = 1314,                         /* -specs= */
  OPT_static = 1315,                         /* -static */
  OPT_static_libasan = 1316,                 /* -static-libasan */
  OPT_static_libgcc = 1317,                  /* -static-libgcc */
  OPT_static_libgcj = 1318,                  /* -static-libgcj */
  OPT_static_libgfortran = 1319,             /* -static-libgfortran */
  OPT_static_libgo = 1320,                   /* -static-libgo */
  OPT_static_liblsan = 1321,                 /* -static-liblsan */
  OPT_static_libmpx = 1322,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1323,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1324,               /* -static-libstdc++ */
  OPT_static_libtsan = 1325,                 /* -static-libtsan */
  OPT_static_libubsan = 1326,                /* -static-libubsan */
  /* OPT_std_c__03 = 1327, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1328, */                /* -std=c++0x */
  OPT_std_c__11 = 1329,                      /* -std=c++11 */
  OPT_std_c__14 = 1330,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1331, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1332, */                /* -std=c++1y */
  OPT_std_c__1z = 1333,                      /* -std=c++1z */
  OPT_std_c__98 = 1334,                      /* -std=c++98 */
  OPT_std_c11 = 1335,                        /* -std=c11 */
  /* OPT_std_c1x = 1336, */                  /* -std=c1x */
  /* OPT_std_c89 = 1337, */                  /* -std=c89 */
  OPT_std_c90 = 1338,                        /* -std=c90 */
  OPT_std_c99 = 1339,                        /* -std=c99 */
  /* OPT_std_c9x = 1340, */                  /* -std=c9x */
  OPT_std_f2003 = 1341,                      /* -std=f2003 */
  OPT_std_f2008 = 1342,                      /* -std=f2008 */
  OPT_std_f2008ts = 1343,                    /* -std=f2008ts */
  OPT_std_f95 = 1344,                        /* -std=f95 */
  OPT_std_gnu = 1345,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1346, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1347, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1348,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1349,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1350, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1351, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1352,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1353,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1354,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1355, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1356, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1357,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1358,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1359, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1360, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1361,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1362, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1363, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1364, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1365,                     /* -std=legacy */
  OPT_symbolic = 1366,                       /* -symbolic */
  OPT_t = 1367,                              /* -t */
  OPT_time = 1368,                           /* -time */
  OPT_time_ = 1369,                          /* -time= */
  OPT_traditional = 1370,                    /* -traditional */
  OPT_traditional_cpp = 1371,                /* -traditional-cpp */
  OPT_trigraphs = 1372,                      /* -trigraphs */
  OPT_u = 1373,                              /* -u */
  OPT_undef = 1374,                          /* -undef */
  OPT_v = 1375,                              /* -v */
  OPT_version = 1376,                        /* -version */
  OPT_w = 1377,                              /* -w */
  OPT_wrapper = 1378,                        /* -wrapper */
  OPT_x = 1379,                              /* -x */
  OPT_z = 1380,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
