...
extern enum attr_jal get_attr_jal (rtx_insn *);

#define HAVE_ATTR_jal_macro 1
extern enum attr_jal_macro get_attr_jal_macro (rtx_insn *);

#define HAVE_ATTR_move_type 1
extern enum attr_move_type get_attr_move_type (rtx_insn *);

#define HAVE_ATTR_alu_type 1
extern enum attr_alu_type get_attr_alu_type (rtx_insn *);
...
extern enum attr_sync_mem get_attr_sync_mem (rtx_insn *);

#define HAVE_ATTR_sync_oldval 1
extern enum attr_sync_oldval get_attr_sync_oldval (rtx_insn *);

#define HAVE_ATTR_sync_cmp 1
extern enum attr_sync_cmp get_attr_sync_cmp (rtx_insn *);

#define HAVE_ATTR_sync_newval 1
extern enum attr_sync_newval get_attr_sync_newval (rtx_insn *);

#define HAVE_ATTR_sync_inclusive_mask 1
extern enum attr_sync_inclusive_mask get_attr_sync_inclusive_mask (rtx_insn *);

#define HAVE_ATTR_sync_exclusive_mask 1
extern enum attr_sync_exclusive_mask get_attr_sync_exclusive_mask (rtx_insn *);

#define HAVE_ATTR_sync_required_oldval 1
extern enum attr_sync_required_oldval get_attr_sync_required_oldval (rtx_insn *);

#define HAVE_ATTR_sync_insn1_op2 1
extern enum attr_sync_insn1_op2 get_attr_sync_insn1_op2 (rtx_insn *);

#define HAVE_ATTR_sync_insn1 1
extern enum attr_sync_insn1 get_attr_sync_insn1 (rtx_insn *);

#define HAVE_ATTR_sync_insn2 1
extern enum attr_sync_insn2 get_attr_sync_insn2 (rtx_insn *);

#define HAVE_ATTR_sync_memmodel 1
extern int get_attr_sync_memmodel (rtx_insn *);
#define HAVE_ATTR_accum_in 1
extern enum attr_accum_in get_attr_accum_in (rtx_insn *);

#define HAVE_ATTR_type 1
extern enum attr_type get_attr_type (rtx_insn *);

#define HAVE_ATTR_compact_form 1
extern enum attr_compact_form get_attr_compact_form (rtx_insn *);

#define HAVE_ATTR_cnv_mode 1
extern enum attr_cnv_mode get_attr_cnv_mode (rtx_insn *);

#define HAVE_ATTR_extended_mips16 1
extern enum attr_extended_mips16 get_attr_extended_mips16 (rtx_insn *);

#define HAVE_ATTR_compression 1
extern enum attr_compression get_attr_compression (rtx_insn *);

#define HAVE_ATTR_enabled 1
extern enum attr_enabled get_attr_enabled (rtx_insn *);

#define HAVE_ATTR_insn_count 1
extern int get_attr_insn_count (rtx_insn *);
...
extern enum attr_hazard get_attr_hazard (rtx_insn *);

#define HAVE_ATTR_can_delay 1
extern enum attr_can_delay get_attr_can_delay (rtx_insn *);

#define HAVE_ATTR_branch_likely 1
extern enum attr_branch_likely get_attr_branch_likely (rtx_insn *);

#define HAVE_ATTR_may_clobber_hilo 1
extern enum attr_may_clobber_hilo get_attr_may_clobber_hilo (rtx_insn *);

#define HAVE_ATTR_vr4130_class 1
extern enum attr_vr4130_class get_attr_vr4130_class (rtx_insn *);

#define HAVE_ATTR_ls2_turn_type 1
extern enum attr_ls2_turn_type get_attr_ls2_turn_type (rtx_insn *);

#define HAVE_ATTR_sb1_fp_pipes 1
extern enum attr_sb1_fp_pipes get_attr_sb1_fp_pipes (rtx_insn *);
