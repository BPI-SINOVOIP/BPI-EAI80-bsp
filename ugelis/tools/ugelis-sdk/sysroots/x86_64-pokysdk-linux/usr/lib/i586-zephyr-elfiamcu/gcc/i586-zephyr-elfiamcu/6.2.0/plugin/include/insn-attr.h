...
#define HAVE_ATTR_ssememalign 1
extern int get_attr_ssememalign (rtx_insn *);
...
#define HAVE_ATTR_maybe_prefix_bnd 1
extern int get_attr_maybe_prefix_bnd (rtx_insn *);
...
#define HAVE_ATTR_modrm_class 1
extern enum attr_modrm_class get_attr_modrm_class (rtx_insn *);
