...
#define HAVE_nfmadf4 ((TARGET_HARD_FLOAT) && (TARGET_DOUBLE_FLOAT))
#define HAVE_nfmssf4 (TARGET_HARD_FLOAT)
#define HAVE_nfmsdf4 ((TARGET_HARD_FLOAT) && (TARGET_DOUBLE_FLOAT))
...
#define HAVE_floatdidf2 (TARGET_64BIT && TARGET_DOUBLE_FLOAT)
#define HAVE_floatsisf2 (TARGET_HARD_FLOAT)
#define HAVE_floatdisf2 (TARGET_HARD_FLOAT && TARGET_64BIT)
#define HAVE_floatunssidf2 (TARGET_DOUBLE_FLOAT)
#define HAVE_floatunsdidf2 (TARGET_64BIT && TARGET_DOUBLE_FLOAT)
...
#define HAVE_fixuns_truncdfdi2 (TARGET_64BIT && TARGET_DOUBLE_FLOAT)
...
#define HAVE_fge_guardedsf4 (TARGET_HARD_FLOAT)
#define HAVE_fgt_guardedsf4 (TARGET_HARD_FLOAT)
#define HAVE_fle_guardedsf4 (TARGET_HARD_FLOAT)
#define HAVE_flt_guardedsf4 (TARGET_HARD_FLOAT)
#define HAVE_fge_guardeddf4 ((TARGET_HARD_FLOAT) && (TARGET_DOUBLE_FLOAT))
#define HAVE_fgt_guardeddf4 ((TARGET_HARD_FLOAT) && (TARGET_DOUBLE_FLOAT))
#define HAVE_fle_guardeddf4 ((TARGET_HARD_FLOAT) && (TARGET_DOUBLE_FLOAT))
#define HAVE_flt_guardeddf4 ((TARGET_HARD_FLOAT) && (TARGET_DOUBLE_FLOAT))
#define HAVE_jump 1
...
extern rtx        gen_fge_guardedsf4                  (rtx, rtx, rtx);
extern rtx        gen_fgt_guardedsf4                  (rtx, rtx, rtx);
extern rtx        gen_fle_guardedsf4                  (rtx, rtx, rtx);
extern rtx        gen_flt_guardedsf4                  (rtx, rtx, rtx);
extern rtx        gen_fge_guardeddf4                  (rtx, rtx, rtx);
extern rtx        gen_fgt_guardeddf4                  (rtx, rtx, rtx);
extern rtx        gen_fle_guardeddf4                  (rtx, rtx, rtx);
extern rtx        gen_flt_guardeddf4                  (rtx, rtx, rtx);
