...
enum opt_code
{
  ...
  OPT_mabi_ = 1183,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1184,             /* -mabort-on-noreturn */
  ...
  OPT_mcallee_super_interworking = 1194,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1195,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1196,                          /* -mcpu= */
  ...
  OPT_mfpu_ = 1201,                          /* -mfpu= */
  /* OPT_mhard_float = 1202, */              /* -mhard-float */
  OPT_mlittle_endian = 1203,                 /* -mlittle-endian */
  OPT_mlong_calls = 1204,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1205,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1206,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1207,                 /* -mold-rtx-costs */
  ...
  OPT_mrestrict_it = 1212,                   /* -mrestrict-it */
  OPT_msched_prolog = 1213,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1214,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1215,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1216, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1217,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1218,                         /* -mthumb */
  OPT_mthumb_interwork = 1219,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1220,                  /* -mtls-dialect= */
  OPT_mtp_ = 1221,                           /* -mtp= */
  OPT_mtpcs_frame = 1222,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1223,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1224,                         /* -mtune= */
  OPT_munaligned_access = 1225,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1226,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1227,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1228,              /* -mword-relocations */
  OPT_n = 1229,                              /* -n */
  OPT_no_canonical_prefixes = 1230,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1231,              /* -no-integrated-cpp */
  OPT_no_pie = 1232,                         /* -no-pie */
  OPT_nocpp = 1233,                          /* -nocpp */
  OPT_nodefaultlibs = 1234,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1235,                   /* -nostartfiles */
  OPT_nostdinc = 1236,                       /* -nostdinc */
  OPT_nostdinc__ = 1237,                     /* -nostdinc++ */
  OPT_nostdlib = 1238,                       /* -nostdlib */
  OPT_nostdlib__ = 1239,                     /* -nostdlib++ */
  OPT_o = 1240,                              /* -o */
  OPT_p = 1241,                              /* -p */
  ...
  OPT_pie = 1246,                            /* -pie */
  OPT_pipe = 1247,                           /* -pipe */
  OPT_print_file_name_ = 1248,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1249,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1250,          /* -print-multi-directory */
  OPT_print_multi_lib = 1251,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1252,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1253,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1254,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1255,               /* -print-prog-name= */
  OPT_print_search_dirs = 1256,              /* -print-search-dirs */
  OPT_print_sysroot = 1257,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1258,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1259,                          /* -quiet */
  OPT_r = 1260,                              /* -r */
  OPT_remap = 1261,                          /* -remap */
  OPT_s = 1262,                              /* -s */
  OPT_s_bc_abi = 1263,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1273,                  /* -static-libgcj */
  OPT_static_libgfortran = 1274,             /* -static-libgfortran */
  OPT_static_libgo = 1275,                   /* -static-libgo */
  OPT_static_liblsan = 1276,                 /* -static-liblsan */
  OPT_static_libmpx = 1277,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1278,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1279,               /* -static-libstdc++ */
  OPT_static_libtsan = 1280,                 /* -static-libtsan */
  OPT_static_libubsan = 1281,                /* -static-libubsan */
  ...
  OPT_std_c__98 = 1289,                      /* -std=c++98 */
  OPT_std_c11 = 1290,                        /* -std=c11 */
  /* OPT_std_c1x = 1291, */                  /* -std=c1x */
  /* OPT_std_c89 = 1292, */                  /* -std=c89 */
  OPT_std_c90 = 1293,                        /* -std=c90 */
  OPT_std_c99 = 1294,                        /* -std=c99 */
  /* OPT_std_c9x = 1295, */                  /* -std=c9x */
  OPT_std_f2003 = 1296,                      /* -std=f2003 */
  OPT_std_f2008 = 1297,                      /* -std=f2008 */
  OPT_std_f2008ts = 1298,                    /* -std=f2008ts */
  OPT_std_f95 = 1299,                        /* -std=f95 */
  OPT_std_gnu = 1300,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1301, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1302, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1303,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1304,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1305, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1306, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1307,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1308,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1309,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1310, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1311, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1312,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1313,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1314, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1315, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1316,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1317, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1318, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1319, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1320,                     /* -std=legacy */
  OPT_symbolic = 1321,                       /* -symbolic */
  OPT_t = 1322,                              /* -t */
  OPT_time = 1323,                           /* -time */
  OPT_time_ = 1324,                          /* -time= */
  OPT_traditional = 1325,                    /* -traditional */
  OPT_traditional_cpp = 1326,                /* -traditional-cpp */
  OPT_trigraphs = 1327,                      /* -trigraphs */
  OPT_u = 1328,                              /* -u */
  OPT_undef = 1329,                          /* -undef */
  OPT_v = 1330,                              /* -v */
  OPT_version = 1331,                        /* -version */
  OPT_w = 1332,                              /* -w */
  OPT_wrapper = 1333,                        /* -wrapper */
  OPT_x = 1334,                              /* -x */
  OPT_z = 1335,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
