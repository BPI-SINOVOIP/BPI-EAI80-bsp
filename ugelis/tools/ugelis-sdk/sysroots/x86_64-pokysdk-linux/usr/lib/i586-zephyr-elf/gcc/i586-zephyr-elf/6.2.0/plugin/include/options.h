...
enum opt_code
{
  ...
  OPT_Wpoison_system_directories = 348,      /* -Wpoison-system-directories */
  ...
  OPT_ffile_prefix_map_ = 680,               /* -ffile-prefix-map= */
  ...
  OPT_m128bit_long_double = 1183,            /* -m128bit-long-double */
  OPT_m16 = 1184,                            /* -m16 */
  OPT_m32 = 1185,                            /* -m32 */
  OPT_m3dnow = 1186,                         /* -m3dnow */
  OPT_m3dnowa = 1187,                        /* -m3dnowa */
  OPT_m64 = 1188,                            /* -m64 */
  OPT_m80387 = 1189,                         /* -m80387 */
  OPT_m8bit_idiv = 1190,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1191,             /* -m96bit-long-double */
  OPT_mabi_ = 1192,                          /* -mabi= */
  OPT_mabm = 1193,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1194,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1195,                 /* -maddress-mode= */
  OPT_madx = 1196,                           /* -madx */
  OPT_maes = 1197,                           /* -maes */
  OPT_malign_data_ = 1198,                   /* -malign-data= */
  OPT_malign_double = 1199,                  /* -malign-double */
  OPT_malign_functions_ = 1200,              /* -malign-functions= */
  OPT_malign_jumps_ = 1201,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1202,                  /* -malign-loops= */
  OPT_malign_stringops = 1203,               /* -malign-stringops */
  ...
  OPT_mhard_float = 1243,                    /* -mhard-float */
  OPT_mhle = 1244,                           /* -mhle */
  OPT_miamcu = 1245,                         /* -miamcu */
  OPT_mieee_fp = 1246,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1247,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1248,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1249,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1250, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1251,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1252,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1253,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1254,                /* -mlong-double-80 */
  OPT_mlwp = 1255,                           /* -mlwp */
  OPT_mlzcnt = 1256,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1257,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1258,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1259,                  /* -mmitigate-rop */
  OPT_mmmx = 1260,                           /* -mmmx */
  OPT_mmovbe = 1261,                         /* -mmovbe */
  OPT_mmpx = 1262,                           /* -mmpx */
  OPT_mms_bitfields = 1263,                  /* -mms-bitfields */
  OPT_mmwaitx = 1264,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1265,            /* -mno-align-stringops */
  OPT_mno_default = 1266,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1267,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1268,                  /* -mno-push-args */
  OPT_mno_red_zone = 1269,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1270,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1271,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1272,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1273,                          /* -mpc32 */
  OPT_mpc64 = 1274,                          /* -mpc64 */
  OPT_mpc80 = 1275,                          /* -mpc80 */
  OPT_mpclmul = 1276,                        /* -mpclmul */
  OPT_mpcommit = 1277,                       /* -mpcommit */
  OPT_mpku = 1278,                           /* -mpku */
  OPT_mpopcnt = 1279,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1280,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1281,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1282,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1283,                        /* -mprfchw */
  OPT_mpush_args = 1284,                     /* -mpush-args */
  OPT_mrdrnd = 1285,                         /* -mrdrnd */
  OPT_mrdseed = 1286,                        /* -mrdseed */
  OPT_mrecip = 1287,                         /* -mrecip */
  OPT_mrecip_ = 1288,                        /* -mrecip= */
  OPT_mrecord_mcount = 1289,                 /* -mrecord-mcount */
  OPT_mred_zone = 1290,                      /* -mred-zone */
  OPT_mregparm_ = 1291,                      /* -mregparm= */
  OPT_mrtd = 1292,                           /* -mrtd */
  OPT_mrtm = 1293,                           /* -mrtm */
  OPT_msahf = 1294,                          /* -msahf */
  OPT_msha = 1295,                           /* -msha */
  OPT_mskip_rax_setup = 1296,                /* -mskip-rax-setup */
  OPT_msoft_float = 1297,                    /* -msoft-float */
  OPT_msse = 1298,                           /* -msse */
  OPT_msse2 = 1299,                          /* -msse2 */
  OPT_msse2avx = 1300,                       /* -msse2avx */
  OPT_msse3 = 1301,                          /* -msse3 */
  OPT_msse4 = 1302,                          /* -msse4 */
  OPT_msse4_1 = 1303,                        /* -msse4.1 */
  OPT_msse4_2 = 1304,                        /* -msse4.2 */
  OPT_msse4a = 1305,                         /* -msse4a */
  /* OPT_msse5 = 1306, */                    /* -msse5 */
  OPT_msseregparm = 1307,                    /* -msseregparm */
  OPT_mssse3 = 1308,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1309,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1310,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1311,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1312,            /* -mstringop-strategy= */
  OPT_mstv = 1313,                           /* -mstv */
  OPT_mtbm = 1314,                           /* -mtbm */
  OPT_mtls_dialect_ = 1315,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1316,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1317,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1318,                         /* -mtune= */
  OPT_mveclibabi_ = 1319,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1320,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1321,                    /* -mvzeroupper */
  OPT_mx32 = 1322,                           /* -mx32 */
  OPT_mxop = 1323,                           /* -mxop */
  OPT_mxsave = 1324,                         /* -mxsave */
  OPT_mxsavec = 1325,                        /* -mxsavec */
  OPT_mxsaveopt = 1326,                      /* -mxsaveopt */
  OPT_mxsaves = 1327,                        /* -mxsaves */
  OPT_n = 1328,                              /* -n */
  OPT_no_canonical_prefixes = 1329,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1330,              /* -no-integrated-cpp */
  OPT_no_pie = 1331,                         /* -no-pie */
  OPT_nocpp = 1332,                          /* -nocpp */
  OPT_nodefaultlibs = 1333,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1334,                   /* -nostartfiles */
  OPT_nostdinc = 1335,                       /* -nostdinc */
  OPT_nostdinc__ = 1336,                     /* -nostdinc++ */
  OPT_nostdlib = 1337,                       /* -nostdlib */
  OPT_nostdlib__ = 1338,                     /* -nostdlib++ */
  OPT_o = 1339,                              /* -o */
  OPT_p = 1340,                              /* -p */
  OPT_pass_exit_codes = 1341,                /* -pass-exit-codes */
  /* OPT_pedantic = 1342, */                 /* -pedantic */
  OPT_pedantic_errors = 1343,                /* -pedantic-errors */
  OPT_pg = 1344,                             /* -pg */
  OPT_pie = 1345,                            /* -pie */
  OPT_pipe = 1346,                           /* -pipe */
  OPT_print_file_name_ = 1347,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1348,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1349,          /* -print-multi-directory */
  OPT_print_multi_lib = 1350,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1351,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1352,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1353,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1354,               /* -print-prog-name= */
  OPT_print_search_dirs = 1355,              /* -print-search-dirs */
  OPT_print_sysroot = 1356,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1357,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1358,                          /* -quiet */
  OPT_r = 1359,                              /* -r */
  OPT_remap = 1360,                          /* -remap */
  OPT_s = 1361,                              /* -s */
  OPT_s_bc_abi = 1362,                       /* -s-bc-abi */
  OPT_save_temps = 1363,                     /* -save-temps */
  OPT_save_temps_ = 1364,                    /* -save-temps= */
  OPT_shared = 1365,                         /* -shared */
  OPT_shared_libgcc = 1366,                  /* -shared-libgcc */
  /* OPT_specs = 1367, */                    /* -specs */
  OPT_specs_ = 1368,                         /* -specs= */
  OPT_static = 1369,                         /* -static */
  OPT_static_libasan = 1370,                 /* -static-libasan */
  OPT_static_libgcc = 1371,                  /* -static-libgcc */
  OPT_static_libgcj = 1372,                  /* -static-libgcj */
  OPT_static_libgfortran = 1373,             /* -static-libgfortran */
  OPT_static_libgo = 1374,                   /* -static-libgo */
  OPT_static_liblsan = 1375,                 /* -static-liblsan */
  OPT_static_libmpx = 1376,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1377,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1378,               /* -static-libstdc++ */
  OPT_static_libtsan = 1379,                 /* -static-libtsan */
  OPT_static_libubsan = 1380,                /* -static-libubsan */
  /* OPT_std_c__03 = 1381, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1382, */                /* -std=c++0x */
  OPT_std_c__11 = 1383,                      /* -std=c++11 */
  OPT_std_c__14 = 1384,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1385, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1386, */                /* -std=c++1y */
  OPT_std_c__1z = 1387,                      /* -std=c++1z */
  OPT_std_c__98 = 1388,                      /* -std=c++98 */
  OPT_std_c11 = 1389,                        /* -std=c11 */
  ...
  OPT_std_f95 = 1398,                        /* -std=f95 */
  OPT_std_gnu = 1399,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1400, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1401, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1402,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1403,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1404, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1405, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1406,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1407,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1408,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1409, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1410, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1411,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1412,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1413, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1414, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1415,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1416, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1417, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1418, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1419,                     /* -std=legacy */
  OPT_symbolic = 1420,                       /* -symbolic */
  OPT_t = 1421,                              /* -t */
  OPT_time = 1422,                           /* -time */
  OPT_time_ = 1423,                          /* -time= */
  OPT_traditional = 1424,                    /* -traditional */
  OPT_traditional_cpp = 1425,                /* -traditional-cpp */
  OPT_trigraphs = 1426,                      /* -trigraphs */
  OPT_u = 1427,                              /* -u */
  OPT_undef = 1428,                          /* -undef */
  OPT_v = 1429,                              /* -v */
  OPT_version = 1430,                        /* -version */
  OPT_w = 1431,                              /* -w */
  OPT_wrapper = 1432,                        /* -wrapper */
  OPT_x = 1433,                              /* -x */
  OPT_z = 1434,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
