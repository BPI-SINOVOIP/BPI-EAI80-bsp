...
static int uart0_pinmux_config(void)
{
    ...
    {
        {PINMUX_GPIO_PIN_2, GPIOI, GPIOI2_AF4_UART0_TX},
        {PINMUX_GPIO_PIN_3, GPIOI, GPIOI3_AF4_UART0_RX},
    };
...
static int uart2_pinmux_config(void)
{
    ...
    Device_Pinmux_T s_uartPinMux[2] =
    {
        {PINMUX_GPIO_PIN_5, GPIOF, GPIOF5_AF3_UART2_TX},
        {PINMUX_GPIO_PIN_6, GPIOF, GPIOF6_AF3_UART2_RX},
    };
...
static int uart7_pinmux_config(void)
{
    int ret = 0;
    struct device *porte = device_get_binding(CONFIG_PINMUX_GM_PORTC_NAME);
    if (porte == NULL)
...
static int dcmi0_pinmux_config()
{
    ...
    {
        {PINMUX_GPIO_PIN_7, GPIOH, GPIOH7_AF2_VIN_D2},
        {PINMUX_GPIO_PIN_8, GPIOH, GPIOH8_AF2_VIN_D1},
        {PINMUX_GPIO_PIN_9, GPIOH, GPIOH9_AF2_VIN_D3},
        {PINMUX_GPIO_PIN_10, GPIOH, GPIOH10_AF2_VIN_D0},
    ...
    ret = pinmux_pin_set(porth, s_VINPinMux[0].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porth, s_VINPinMux[1].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porth, s_VINPinMux[2].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porth, s_VINPinMux[3].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
...
static int dcmi1_pinmux_config()
{
    ...
    Device_Pinmux_T s_VINPinMux[11] =
    {
        {PINMUX_GPIO_PIN_10, GPIOC, GPIOC10_AF8_VIN2_D2},
        {PINMUX_GPIO_PIN_11, GPIOC, GPIOC11_AF8_VIN2_D1},
        {PINMUX_GPIO_PIN_12, GPIOC, GPIOC12_AF8_VIN2_D3},
        {PINMUX_GPIO_PIN_13, GPIOC, GPIOC13_AF8_VIN2_D0},
        {PINMUX_GPIO_PIN_14, GPIOC, GPIOC14_AF8_VIN2_D4},
        {PINMUX_GPIO_PIN_15, GPIOC, GPIOC15_AF8_VIN2_PIXCLK},
        {PINMUX_GPIO_PIN_0, GPIOD, GPIOD0_AF8_VIN2_D5},
        {PINMUX_GPIO_PIN_1, GPIOD, GPIOD1_AF8_VIN2_D6},
        {PINMUX_GPIO_PIN_2, GPIOD, GPIOD2_AF8_VIN2_D7},
        {PINMUX_GPIO_PIN_3, GPIOD, GPIOD3_AF8_VIN2_HSYNC},
        {PINMUX_GPIO_PIN_4, GPIOD, GPIOD4_AF8_VIN2_VSYHC},
    };
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[0].alternate;
    ret = pinmux_pin_set(portc, s_VINPinMux[0].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[1].alternate;
    ret = pinmux_pin_set(portc, s_VINPinMux[1].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[2].alternate;
    ret = pinmux_pin_set(portc, s_VINPinMux[2].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[3].alternate;
    ret = pinmux_pin_set(portc, s_VINPinMux[3].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[4].alternate;
    ret = pinmux_pin_set(portc, s_VINPinMux[4].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[5].alternate;
    ret = pinmux_pin_set(portc, s_VINPinMux[5].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[6].alternate;
    ret = pinmux_pin_set(portd, s_VINPinMux[6].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[7].alternate;
    ret = pinmux_pin_set(portd, s_VINPinMux[7].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[8].alternate;
    ret = pinmux_pin_set(portd, s_VINPinMux[8].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[9].alternate;
    ret = pinmux_pin_set(portd, s_VINPinMux[9].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    pin_cfg.pull = GPIO_NOPULL;
    pin_cfg.alternate = s_VINPinMux[10].alternate;
    ret = pinmux_pin_set(portd, s_VINPinMux[10].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
...
static int lcd_pinmux_config()
{
    ...
    {
        {PINMUX_GPIO_PIN_13, GPIOD, GPIOD13_AF2_VOUT_B2},
        {PINMUX_GPIO_PIN_14, GPIOD, GPIOD14_AF2_VOUT_B1},
        {PINMUX_GPIO_PIN_15, GPIOD, GPIOD15_AF2_VOUT_B0},
        {PINMUX_GPIO_PIN_0, GPIOE, GPIOE0_AF2_VOUT_G1},
        {PINMUX_GPIO_PIN_1, GPIOE, GPIOE1_AF2_VOUT_DE},
        {PINMUX_GPIO_PIN_2, GPIOE, GPIOE2_AF2_VOUT_VSYNC},
        {PINMUX_GPIO_PIN_3, GPIOE, GPIOE3_AF2_VOUT_HSYNC},
        {PINMUX_GPIO_PIN_4, GPIOE, GPIOE4_AF2_VOUT_OUT_CLK},
        {PINMUX_GPIO_PIN_5, GPIOE, GPIOE5_AF2_VOUT_B7},
        {PINMUX_GPIO_PIN_6, GPIOE, GPIOE6_AF2_VOUT_B6},
        {PINMUX_GPIO_PIN_7, GPIOE, GPIOE7_AF2_VOUT_B5},
        {PINMUX_GPIO_PIN_8, GPIOE, GPIOE8_AF2_VOUT_B4},
        {PINMUX_GPIO_PIN_9, GPIOE, GPIOE9_AF2_VOUT_B3},
        {PINMUX_GPIO_PIN_10, GPIOE, GPIOE10_AF2_VOUT_G7},
        {PINMUX_GPIO_PIN_11, GPIOE, GPIOE11_AF2_VOUT_G6},
        {PINMUX_GPIO_PIN_12, GPIOE, GPIOE12_AF2_VOUT_G5},
        {PINMUX_GPIO_PIN_13, GPIOE, GPIOE13_AF2_VOUT_G4},
        {PINMUX_GPIO_PIN_14, GPIOE, GPIOE14_AF2_VOUT_G3},
        {PINMUX_GPIO_PIN_15, GPIOE, GPIOE15_AF2_VOUT_G2},
        {PINMUX_GPIO_PIN_0, GPIOF, GPIOF0_AF2_VOUT_R7},
        {PINMUX_GPIO_PIN_1, GPIOF, GPIOF1_AF2_VOUT_R6},
        {PINMUX_GPIO_PIN_2, GPIOF, GPIOF2_AF2_VOUT_R5},
        {PINMUX_GPIO_PIN_3, GPIOF, GPIOF3_AF2_VOUT_R4},
        {PINMUX_GPIO_PIN_4, GPIOF, GPIOF4_AF2_VOUT_R3},
        {PINMUX_GPIO_PIN_5, GPIOF, GPIOF5_AF2_VOUT_R2},
        {PINMUX_GPIO_PIN_6, GPIOF, GPIOF6_AF2_VOUT_R1},
        {PINMUX_GPIO_PIN_7, GPIOF, GPIOF7_AF2_VOUT_R0},
        {PINMUX_GPIO_PIN_8, GPIOF, GPIOF8_AF2_VOUT_G0},
    };
    ...
    ret = pinmux_pin_set(portd, s_VOUTPinMux[0].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portd, s_VOUTPinMux[1].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portd, s_VOUTPinMux[2].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[3].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[4].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[5].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[6].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[7].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[8].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[9].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[11].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[12].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[13].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[14].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[15].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[16].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[17].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[18].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[19].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[20].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[21].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[22].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[23].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[24].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[25].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[26].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[27].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
...
static int adc_pinmux_config(void)
{
    ...
    static Device_Pinmux_T s_pinmux[] =
    {
        ...
        {PINMUX_GPIO_PIN_4,  GPIOC, 0}, /* ADC_CHANNEL_0 pinmux config paramter */
        {PINMUX_GPIO_PIN_5,  GPIOC, 0}, /* ADC_CHANNEL_1 pinmux config paramter */
#endif
    };
    ...
    static Device_Pinmux_T s_pinmux[16] =
    {
        ...
        {PINMUX_GPIO_PIN_4,  GPIOC, 0}, /* ADC_CHANNEL_0 pinmux config paramter */
        {PINMUX_GPIO_PIN_5,  GPIOC, 0}, /* ADC_CHANNEL_1 pinmux config paramter */
        {PINMUX_GPIO_PIN_8,  GPIOC, 0}, /* ADC_CHANNEL_2 pinmux config paramter */
        {PINMUX_GPIO_PIN_9,  GPIOC, 0}, /* ADC_CHANNEL_3 pinmux config paramter */
        {PINMUX_GPIO_PIN_10,  GPIOC, 0}, /* ADC_CHANNEL_4 pinmux config paramter */
        {PINMUX_GPIO_PIN_11,  GPIOC, 0}, /* ADC_CHANNEL_5 pinmux config paramter */
        {PINMUX_GPIO_PIN_12,  GPIOC, 0}, /* ADC_CHANNEL_6 pinmux config paramter */
        {PINMUX_GPIO_PIN_13,  GPIOC, 0}, /* ADC_CHANNEL_7 pinmux config paramter */ //
        {PINMUX_GPIO_PIN_14,  GPIOC, 0}, /* ADC_CHANNEL_8 pinmux config paramter */ //
        {PINMUX_GPIO_PIN_15,  GPIOC, 0}, /* ADC_CHANNEL_9 pinmux config paramter */

        {PINMUX_GPIO_PIN_0, GPIOD, 0}, /* ADC_CHANNEL_10 pinmux config paramter */
        {PINMUX_GPIO_PIN_1, GPIOD, 0}, /* ADC_CHANNEL_11 pinmux config paramter */
        {PINMUX_GPIO_PIN_2, GPIOD, 0}, /* ADC_CHANNEL_12 pinmux config paramter */
        {PINMUX_GPIO_PIN_3, GPIOD, 0}, /* ADC_CHANNEL_13 pinmux config paramter */

        {PINMUX_GPIO_PIN_4, GPIOD, 0}, /* ADC_CHANNEL_14 pinmux config paramter */
        {PINMUX_GPIO_PIN_5, GPIOD, 0}, /* ADC_CHANNEL_15 pinmux config paramter */
#endif
    };
#endif
...
static int acmp_pinmux_config(void)
{
    ...
    Device_Pinmux_T pinmux[4] =
    {
        {PINMUX_GPIO_PIN_8,  GPIOC, 0},
        {PINMUX_GPIO_PIN_9,  GPIOC, 0},
        {PINMUX_GPIO_PIN_10,  GPIOC, 0},
        {PINMUX_GPIO_PIN_12,  GPIOC, 0},
    };
...
#ifdef CHIP_F6721B
#ifdef CONFIG_TOUCHSCREEN
        {PINMUX_GPIO_PIN_7, GPIOD, GPIOD7_AF2_I2C1_SDA},
        {PINMUX_GPIO_PIN_6, GPIOD, GPIOD6_AF2_I2C1_SCL},
#else
...
#ifdef CHIP_F6721B
#ifdef CONFIG_TOUCHSCREEN
    ret = pinmux_pin_set(portd, s_i2cPinMux[0].pin, (unsigned int)&pin_cfg);
#else
...
#ifdef CHIP_F6721B
#ifdef CONFIG_TOUCHSCREEN
    ret = pinmux_pin_set(portd, s_i2cPinMux[1].pin, (unsigned int)&pin_cfg);
#else
...
#ifdef CONFIG_DEVICE_POWER_MANAGEMENT
DEVICE_DEFINE(gm_pinmux, "pinmux_evb_176pin", pinmux_gm_initialize, gm_pinmux_pm_control, \
              NULL, NULL, PRE_KERNEL_1, DEVICE_PRIORITY_BOARD_PINMUX,  NULL) ;
#else

DEVICE_DEFINE(gm_pinmux, "pinmux_evb_176pin", pinmux_gm_initialize, NULL, \
              NULL, NULL, PRE_KERNEL_1, DEVICE_PRIORITY_BOARD_PINMUX,  NULL) ;
