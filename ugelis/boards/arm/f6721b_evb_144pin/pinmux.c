...
{
    int ret = 0;
    struct device *portc = NULL;
    struct device *portd = NULL;
    struct device *porti = NULL;
    GPIO_PinConfig_T pin_cfg;
    Device_Pinmux_T s_VINPinMux[11] =
    {
        {PINMUX_GPIO_PIN_8, GPIOC, GPIOC8_AF13_VIN_D0},
        {PINMUX_GPIO_PIN_10, GPIOC, GPIOC10_AF13_VIN_D1},
        {PINMUX_GPIO_PIN_12, GPIOC, GPIOC12_AF13_VIN_D2},
        {PINMUX_GPIO_PIN_14, GPIOC, GPIOC14_AF13_VIN_D3},
        {PINMUX_GPIO_PIN_0, GPIOD, GPIOD0_AF13_VIN_D4},
        {PINMUX_GPIO_PIN_6, GPIOI, GPIOI6_AF13_VIN_D5},
        {PINMUX_GPIO_PIN_8, GPIOI, GPIOI8_AF13_VIN_D6},
        {PINMUX_GPIO_PIN_10, GPIOI, GPIOI10_AF13_VIN_D7},
        {PINMUX_GPIO_PIN_2, GPIOI, GPIOI2_AF13_VIN_HSYNC},
        {PINMUX_GPIO_PIN_3, GPIOI, GPIOI3_AF13_VIN_PIXCLK},
        {PINMUX_GPIO_PIN_4, GPIOI, GPIOI4_AF13_VIN_VSYNC},
    };

    portc = device_get_binding(CONFIG_PINMUX_GM_PORTC_NAME);
    if (portc == NULL)
    {
        return -1;
    }
    ...
    portd = device_get_binding(CONFIG_PINMUX_GM_PORTD_NAME);
    if (portd == NULL)
    {
        return -1;
    }
    ...
    ret = pinmux_pin_set(portd, s_VINPinMux[4].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porti, s_VINPinMux[5].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porti, s_VINPinMux[6].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porti, s_VINPinMux[7].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porti, s_VINPinMux[8].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
...
#ifdef CONFIG_DEVICE_POWER_MANAGEMENT
DEVICE_DEFINE(gm_pinmux, "pinmux_evb_144pin", pinmux_gm_initialize, gm_pinmux_pm_control, \
              NULL, NULL, PRE_KERNEL_1, DEVICE_PRIORITY_BOARD_PINMUX,  NULL) ;
#else

DEVICE_DEFINE(gm_pinmux, "pinmux_evb_144pin", pinmux_gm_initialize, NULL, \
              NULL, NULL, PRE_KERNEL_1, DEVICE_PRIORITY_BOARD_PINMUX,  NULL) ;
