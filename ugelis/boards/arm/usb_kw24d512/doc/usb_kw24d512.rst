...
device and host functions. Only USB device function is supported in uGelis
...
:ref:`nxp_opensda_jlink` tools. This builds the uGelis application,
...
.. code-block:: console
     ...
     ***** BOOTING UGELIS OS v1.8.99 - BUILD: Jul 26 2017 15:39:04 *****
     Hello World! arm
