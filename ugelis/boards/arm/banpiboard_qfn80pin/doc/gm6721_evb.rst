...
The uGelis stm32f469i_disco board configuration supports the following hardware features:
...
Other hardware features are not yet supported on uGelis porting.
...
Default uGelis Peripheral Mapping:
----------------------------------
- UART_3_TX : PB10
- UART_3_RX : PB11
- UART_6_TX : PG14
...
The STM32F469 Discovery kit has up to 8 UARTs. The uGelis console output is assigned to UART3.
...
This interface is supported by the openocd version included in uGelis SDK.
