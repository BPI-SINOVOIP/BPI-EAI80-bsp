...
- uGelis board with SPI master driver. SPI communications must use 5V
...
#. Ensure your uGelis board, the 5V power supply, and the LED strip
...
.. ugelis-app-commands::
   :ugelis-app: samples/drivers/led_lpd8806
   :board: <board>
   :goals: flash
   :compact:
