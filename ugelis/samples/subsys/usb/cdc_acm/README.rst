...
Abstract Control Model (ACM) driver provided by the uGelis project.
...
.. ugelis-app-commands::
   :ugelis-app: samples/subsys/usb/cdc_acm
   :board: arduino_101
   :goals: flash
   :compact:
...
And on ttyACM device, provided by ugelis USB device stack:
