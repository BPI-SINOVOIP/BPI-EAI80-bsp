...
static void ugelis_timer_wrapper(struct k_timer *timer);
...
static void ugelis_timer_wrapper(struct k_timer *ztimer)
{
...
int timer_create(clockid_t clockid, struct sigevent *evp, timer_t *timerid)
{
	...
	if (evp->sigev_notify == SIGEV_NONE) {
		...
		k_timer_init(&timer->ztimer, ugelis_timer_wrapper, NULL);
	}
