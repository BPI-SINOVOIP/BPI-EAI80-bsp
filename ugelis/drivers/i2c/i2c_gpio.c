...
static void i2c_gpio_set_scl(void *io_context, int state)
{
    ...
    gpio_pin_configure(context->gpio, context->scl_pin, GPIO_DIR_OUT | GPIO_PUD_PULL_UP);
...
static void i2c_gpio_set_sda(void *io_context, int state)
{
    ...
    gpio_pin_configure(context->gpio, context->sda_pin, GPIO_DIR_OUT | GPIO_PUD_PULL_UP);
...
static int i2c_gpio_get_sda(void *io_context)
{
    ...
    gpio_pin_configure(context->gpio, context->sda_pin, GPIO_DIR_IN | GPIO_PUD_PULL_UP);
