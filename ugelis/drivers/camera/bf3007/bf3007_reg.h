 ...
 * register offset
 */
#define PAGE        0xfe/*page select*/
#define PID         0xFC /* Product ID Number MSB */
#define VER         0xFD /* Product ID Number LSB */

//page 1 register
#define GAIN        0x6A /* AGC - Gain control gain setting */
#define BLUE        0xB0 /* AWB - Blue channel gain setting */
#define RED         0xB1 /* AWB - Red   channel gain setting */
#define GREEN       0xB3 /* AWB - Green channel gain setting */
...
#define BF3007_MAX_WIDTH    VGA_WIDTH
#define BF3007_MAX_HEIGHT   VGA_HEIGHT

/*
 * ID
 */
#define BF3007  0x300A
#define BF3005  0x3003
