 ...
 * STM32Cube HAL layer.
 *
 * There is a bit of an impedance mismatch between the uGelis
 ...
 *
 * WARNING: Don't mix USB defined in STM32Cube HAL and CONFIG_USB from uGelis
 * Kconfig system.
 */
#ifdef USB
...
/* uGelis USB device controller API implementation */
