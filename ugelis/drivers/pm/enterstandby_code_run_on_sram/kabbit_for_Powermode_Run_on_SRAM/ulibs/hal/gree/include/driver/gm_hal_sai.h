...
//typedef void (*HAL_DMA_Callback_T)(struct DMA_HandleTypeDef *hdma, uint8_t event, unsigned long param);
...
HAL_StatusTypeDef HAL_SAI_InitProtocol(SAI_Block_TypeDef *pSAI, SAI_HandleTypeDef *hsai);
...
//HAL_StatusTypeDef HAL_SAI_InitProtocol(SAI_Block_TypeDef*pSAI,SAI_HandleTypeDef *hsai);
HAL_StatusTypeDef HAL_SAI_Init(SAI_Block_TypeDef *pSAI, SAI_HandleTypeDef *hsai);
...
HAL_StatusTypeDef HAL_SAI_Transmit(SAI_HandleTypeDef *hsai, uint32_t *pData, uint16_t Size, uint32_t Timeout);
HAL_StatusTypeDef HAL_SAI_Receive(SAI_HandleTypeDef *hsai, uint32_t *pData, uint16_t Size, uint32_t Timeout);

/* Non-Blocking mode: Interrupt */
HAL_StatusTypeDef HAL_SAI_Transmit_IT(SAI_HandleTypeDef *hsai, uint32_t *pData, uint16_t Size);
HAL_StatusTypeDef HAL_SAI_Receive_IT(SAI_HandleTypeDef *hsai, uint32_t *pData, uint16_t Size);

/* Non-Blocking mode: DMA */
HAL_StatusTypeDef HAL_SAI_Transmit_DMA(SAI_HandleTypeDef *hsai, SAI_WorkMode_T mode, uint32_t *pData, uint16_t Size);
HAL_StatusTypeDef HAL_SAI_Receive_DMA(SAI_HandleTypeDef *hsai, SAI_WorkMode_T mode, uint32_t *pData, uint16_t Size);
