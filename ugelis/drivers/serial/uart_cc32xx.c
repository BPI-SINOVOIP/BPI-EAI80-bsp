 ...
 *  However, the uGelis console driver, and the uGelis uart sample test, assume
...
static int uart_cc32xx_err_check(struct device *dev)
{
	...
	/* Map cc32xx SDK uart.h defines to ugelis uart.h defines */
...
static void uart_cc32xx_isr(void *arg)
{
	...
	/*
	 * Clear interrupts only after cb called, as uGelis UART clients expect
