...
#ifdef __USE_KEIL_
extern unsigned char Image$$KMUTEX_REGION$$Base;
extern unsigned char Image$$KMUTEX_REGION$$Length;
...
#ifdef __USE_KEIL_
	_k_mutex_list_start = (struct k_msgq*)&Image$$KMUTEX_REGION$$Base;
	_k_mutex_list_end = (struct k_msgq*)((uint32_t)&Image$$KMUTEX_REGION$$Base + (uint32_t)&Image$$KMUTEX_REGION$$Length);
#endif	
