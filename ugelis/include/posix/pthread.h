 ...
 * POSIX API, it's provided to better conform with uGelis's allocation
 ...
 * See IEEE 1003.1.
 *
 * Note that pthread attribute structs are currently noops in uGelis.
 */
 ...
 * provided to better conform with uGelis's allocation strategies for
 * kernel objects.
 *
...
/* FIXME: these are going to be tricky to implement.  uGelis has (for
 ...
 * work similarly but conform to uGelis's paradigms.
 */
 ...
 * can only be true given the way uGelis implements these
