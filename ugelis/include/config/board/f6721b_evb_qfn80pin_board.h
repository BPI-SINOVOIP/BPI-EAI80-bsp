/**************************************************
 * Generated include file for gree,f6721b-evb-qfn80pin
 *               DO NOT MODIFY
 */

#ifndef _F6721B_EVB_QFN80PIN_BOARD_H
#define _F6721B_EVB_QFN80PIN_BOARD_H
...
/* dcmi0 interface setting, include powerdown, reset, scl and sda*/
    ...
    #define GREE_CAMERA_0_GPIO_PWDN_PORT "GPIOJ"
    #define GREE_CAMERA_0_GPIO_PWDN_PIN  3
    #define GREE_CAMERA_0_GPIO_RST_PORT  "GPIOJ"
    #define GREE_CAMERA_0_GPIO_RST_PIN   2
#else
    #define GREE_CAMERA_0_GPIO_PWDN_PORT "GPIOJ"
    #define GREE_CAMERA_0_GPIO_PWDN_PIN  2
    #define GREE_CAMERA_0_GPIO_RST_PORT  "GPIOJ"
    #define GREE_CAMERA_0_GPIO_RST_PIN   1
#endif
...
#define GREE_CAMERA_1_GPIO_PWDN_PORT "GPIOE"
#define GREE_CAMERA_1_GPIO_PWDN_PIN  8
#define GREE_CAMERA_1_GPIO_RST_PORT  "GPIOE"
#define GREE_CAMERA_1_GPIO_RST_PIN   7
#define GREE_CAMERA_1_GPIO_SCL_PORT  "GPIOE"
#define GREE_CAMERA_1_GPIO_SCL_PIN   6
#define GREE_CAMERA_1_GPIO_SDA_PORT  "GPIOE"
#define GREE_CAMERA_1_GPIO_SDA_PIN   5
...
/*lcd and touch screen config pins*/
    ...
    /*QFN80 sorting board*/
    #if defined (QFN80_SORTING_BOARD)
        #define GREE_LCD_BACKGROUND_LIGHT_PORT      "GPIOC"
        #define GREE_LCD_BACKGROUND_LIGHT_PIN       5
    #elif defined(QFN80_DEMO_BOARD_V3)
        /*QFN80 demo board 3.0*/
        #define GREE_LCD_BACKGROUND_LIGHT_PORT      "GPIOC"
        #define GREE_LCD_BACKGROUND_LIGHT_PIN       2
    #else
        /*QFN80 demo board*/
        #define GREE_LCD_BACKGROUND_LIGHT_PORT      "GPIOC"
        #define GREE_LCD_BACKGROUND_LIGHT_PIN       3
    #endif
#else
    /*GM6721*/
    #define GREE_LCD_BACKGROUND_LIGHT_PORT      "GPIOB"
    #define GREE_LCD_BACKGROUND_LIGHT_PIN       13
#endif
/*QFN80 demo board*/
#if defined(QFN80_DEMO_BOARD_V3)
    #define GREE_LCD_TOUCHSCREEN_RST_PORT       "GPIOC"
    #define GREE_LCD_TOUCHSCREEN_RST_PIN        9
    #define GREE_LCD_TOUCHSCREEN_INT_PORT       "GPIOC"
    #define GREE_LCD_TOUCHSCREEN_INT_PIN        8
#else
    #define GREE_LCD_TOUCHSCREEN_RST_PORT       "GPIOC"
    #define GREE_LCD_TOUCHSCREEN_RST_PIN        8
    #define GREE_LCD_TOUCHSCREEN_INT_PORT       "GPIOC"
    #define GREE_LCD_TOUCHSCREEN_INT_PIN        5
#endif
