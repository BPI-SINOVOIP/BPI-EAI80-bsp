...
/********************  Bit definition for IMP_IFCR register  ****************/
#define IMP_IFCR_CTEIF_Pos       (0U)                                        
#define IMP_IFCR_CTEIF_Msk       (0x1U << IMP_IFCR_CTEIF_Pos)              /**< 0x00000001 */
#define IMP_IFCR_CTEIF           IMP_IFCR_CTEIF_Msk                        /**< Clears Transfer Error Interrupt Flag         */
#define IMP_IFCR_CTCIF_Pos       (1U)                                        
#define IMP_IFCR_CTCIF_Msk       (0x1U << IMP_IFCR_CTCIF_Pos)              /**< 0x00000002 */
#define IMP_IFCR_CTCIF           IMP_IFCR_CTCIF_Msk                        /**< Clears Transfer Complete Interrupt Flag      */
#define IMP_IFCR_CTWIF_Pos       (2U)                                        
#define IMP_IFCR_CTWIF_Msk       (0x1U << IMP_IFCR_CTWIF_Pos)              /**< 0x00000004 */
#define IMP_IFCR_CTWIF           IMP_IFCR_CTWIF_Msk                        /**< Clears Transfer Watermark Interrupt Flag     */
#define IMP_IFCR_CAECIF_Pos      (3U)                                        
#define IMP_IFCR_CAECIF_Msk      (0x1U << IMP_IFCR_CAECIF_Pos)             /**< 0x00000008 */
#define IMP_IFCR_CAECIF          IMP_IFCR_CAECIF_Msk                       /**< Clears CLUT Access Error Interrupt Flag      */
#define IMP_IFCR_CCTCIF_Pos      (4U)                                        
#define IMP_IFCR_CCTCIF_Msk      (0x1U << IMP_IFCR_CCTCIF_Pos)             /**< 0x00000010 */
#define IMP_IFCR_CCTCIF          IMP_IFCR_CCTCIF_Msk                       /**< Clears CLUT Transfer Complete Interrupt Flag */
#define IMP_IFCR_CCEIF_Pos       (5U)                                        
#define IMP_IFCR_CCEIF_Msk       (0x1U << IMP_IFCR_CCEIF_Pos)              /**< 0x00000020 */
#define IMP_IFCR_CCEIF           IMP_IFCR_CCEIF_Msk                        /**< Clears Configuration Error Interrupt Flag    */
...
#define IMP_FGPFCCR_START_Pos    (5U)                                        
#define IMP_FGPFCCR_START_Msk    (0x1U << IMP_FGPFCCR_START_Pos)           /**< 0x00000020 */
#define IMP_FGPFCCR_START        IMP_FGPFCCR_START_Msk                     /**< Start */
#define IMP_FGPFCCR_CS_Pos       (8U)                                        
#define IMP_FGPFCCR_CS_Msk       (0xFFU << IMP_FGPFCCR_CS_Pos)             /**< 0x0000FF00 */
#define IMP_FGPFCCR_CS           IMP_FGPFCCR_CS_Msk                        /**< CLUT size */
...
#define IMP_BGPFCCR_START_Pos    (5U)                                        
#define IMP_BGPFCCR_START_Msk    (0x1U << IMP_BGPFCCR_START_Pos)           /**< 0x00000020 */
#define IMP_BGPFCCR_START        IMP_BGPFCCR_START_Msk                     /**< Start */
#define IMP_BGPFCCR_CS_Pos       (8U)                                        
#define IMP_BGPFCCR_CS_Msk       (0xFFU << IMP_BGPFCCR_CS_Pos)             /**< 0x0000FF00 */
#define IMP_BGPFCCR_CS           IMP_BGPFCCR_CS_Msk                        /**< CLUT size */
...
/********************  Bit definition for IMP_AMTCR register  ***************/
#define IMP_AMTCR_EN_Pos         (0U)                                        
#define IMP_AMTCR_EN_Msk         (0x1U << IMP_AMTCR_EN_Pos)                /**< 0x00000001 */
#define IMP_AMTCR_EN             IMP_AMTCR_EN_Msk                          /**< Enable */
#define IMP_AMTCR_DT_Pos         (8U)                                        
#define IMP_AMTCR_DT_Msk         (0xFFU << IMP_AMTCR_DT_Pos)               /**< 0x0000FF00 */
#define IMP_AMTCR_DT             IMP_AMTCR_DT_Msk                          /**< Dead Time */
