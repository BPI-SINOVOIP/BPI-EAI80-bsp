...
elseif(QEMU_NET_STACK)
  ...
  if(PCAP)
    ...
    set_ifndef(NET_TOOLS ${UGELIS_BASE}/../net-tools) # Default if not set
...
if(CONFIG_X86_IAMCU)
  list(APPEND PRE_QEMU_COMMANDS
    COMMAND
    ${PYTHON_EXECUTABLE}
    ${UGELIS_BASE}/scripts/qemu-machine-hack.py
    $<TARGET_FILE:${logical_target_for_ugelis_elf}>
    )
endif()
...
set_ifndef(QEMU_KERNEL_OPTION
  "-kernel;$<TARGET_FILE:${logical_target_for_ugelis_elf}>"
  )
