include(${UGELIS_BASE}/cmake/hex.cmake)
file(READ ${UGELIS_BASE}/VERSION ver)
...
message("uGelis version: ${PROJECT_VERSION_MAJOR}.${PROJECT_VERSION_MINOR}.${PROJECT_VERSION_PATCH}")
...
math(EXPR UGELIS_VERSION_CODE                      "(${MAJOR} << 16) + (${MINOR} << 8) + (${PATCH})")
