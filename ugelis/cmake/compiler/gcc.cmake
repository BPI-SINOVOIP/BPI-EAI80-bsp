...
if(CMAKE_C_COMPILER STREQUAL CMAKE_C_COMPILER-NOTFOUND)
  message(FATAL_ERROR "uGelis was unable to find the toolchain. Is the environment misconfigured?
User-configuration:
UGELIS_TOOLCHAIN_VARIANT: ${UGELIS_TOOLCHAIN_VARIANT}
Internal variables:
...
foreach(file_name include include-fixed)
  ...
  if(MSYS)
    ...
    # https://github.com/ugelisproject-rtos/ugelis/issues/4687 is
    # resolved
    execute_process(
...
if("${UGELIS_TOOLCHAIN_VARIANT}" STREQUAL "xcc")

  LIST(APPEND TOOLCHAIN_LIBS gcc)
  LIST(APPEND TOOLCHAIN_LIBS hal)

else()
  include(${UGELIS_BASE}/cmake/gcc-m-cpu.cmake)
  ...
  if("${ARCH}" STREQUAL "arm")
    ...
    include(${UGELIS_BASE}/cmake/fpu-for-gcc-m-cpu.cmake)
