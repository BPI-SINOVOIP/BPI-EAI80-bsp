...
#
# It is a legacy mechanism that will in uGelis translate to
# specififying UGELIS_TOOLCHAIN_VARIANT to 'cross-compile' with the location
# 'CROSS_COMPILE'.
#
# New users should set the env var 'UGELIS_TOOLCHAIN_VARIANT' to
# 'cross-compile' and the 'CROSS_COMPILE' env var to the toolchain
# prefix. This interface is consisent with the other non-"uGelis SDK"
# toolchains.
#
