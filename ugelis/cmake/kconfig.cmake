...
set_ifndef(KCONFIG_ROOT ${UGELIS_BASE}/Kconfig)
...
add_custom_target(
  ...
  ${PYTHON_EXECUTABLE} ${UGELIS_BASE}/scripts/kconfig/menuconfig.py ${KCONFIG_ROOT}
...
execute_process(
  COMMAND
  ${PYTHON_EXECUTABLE}
  ${UGELIS_BASE}/scripts/kconfig/kconfig.py
  ${KCONFIG_ROOT}
