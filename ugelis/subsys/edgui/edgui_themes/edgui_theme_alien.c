...
static void basic_init(void)
{
    ...
    bg.body.main_color   = edgui_color_hex3(0x333);
    bg.body.grad_color   = edgui_color_hex3(0x333);
    ...
    panel.body.main_color   = edgui_color_hex3(0x666);
    panel.body.grad_color   = edgui_color_hex3(0x666);
    ...
    panel.image.color       = edgui_color_hsv_to_rgb(_hue, 8, 96);
...
static void btn_init(void)
{
    ...
    btn_rel.image.color         = edgui_color_hsv_to_rgb(_hue, 8, 96);
    ...
    btn_pr.image.color     = edgui_color_hsv_to_rgb(_hue, 10, 100);
    ...
    btn_trel.image.color       = edgui_color_hsv_to_rgb(_hue, 0, 100);
    ...
    btn_tpr.image.color       = edgui_color_hsv_to_rgb(_hue, 10, 90);
...
static void label_init(void)
{
    ...
    label_prim.text.color = edgui_color_hsv_to_rgb(_hue, 80, 96);
...
static void slider_init(void)
{
    ...
    slider_knob.body.main_color   = EDGUI_COLOR_WHITE;
    slider_knob.body.grad_color   = EDGUI_COLOR_SILVER;
    slider_knob.body.border.width = 1;
    slider_knob.body.border.color = EDGUI_COLOR_GRAY;
...
static void lmeter_init(void)
{
    ...
    lmeter_bg.body.padding.right = EDGUI_DPI / 8; /*Scale line length*/
    lmeter_bg.line.color         = edgui_color_hex3(0x222);
...
static void gauge_init(void)
{
    ...
    gauge_bg.body.padding.top    = EDGUI_DPI / 10; /*Needle center size*/
    gauge_bg.body.padding.bottom = EDGUI_DPI / 10; /*Needle center size*/
    gauge_bg.body.padding.inner  = EDGUI_DPI / 12; /*Label - scale distance*/
    gauge_bg.body.border.color   = edgui_color_hex3(0x777);
...
static void arc_init(void)
{
    ...
    arc.body.border.color   = edgui_color_hex3(0x555);
...
static void calendar_init(void)
{
    ...
    static edgui_style_t color_text;
    static edgui_style_t gray_text;
    static edgui_style_t today_box;

    edgui_style_copy(&header, &def);
    header.body.radius         = 0;
    header.body.padding.left   = EDGUI_DPI / 12;
    header.body.padding.right  = EDGUI_DPI / 12;
    header.body.padding.top    = EDGUI_DPI / 14;
    header.body.padding.bottom = EDGUI_DPI / 14;
    header.body.main_color     = edgui_color_hsv_to_rgb(_hue, 30, 60);
    ...
    header.body.border.color   = edgui_color_hsv_to_rgb(_hue, 20, 80);
    header.text.color          = edgui_color_hsv_to_rgb(_hue, 5, 100);

    edgui_style_copy(&today_box, &header);
    today_box.body.main_color = edgui_color_hsv_to_rgb(_hue, 40, 70);
    today_box.body.grad_color = today_box.body.main_color;
    today_box.body.opa        = EDGUI_OPA_TRANSP;

    edgui_style_copy(&color_text, &def);
    color_text.text.color = edgui_color_hsv_to_rgb(_hue, 30, 80);

    edgui_style_copy(&gray_text, &def);
    gray_text.text.color = edgui_color_hsv_to_rgb(_hue, 10, 65);
...
static void cb_init(void)
{
    ...
    cb_rel.body.border.color = EDGUI_COLOR_GRAY;
    cb_rel.body.main_color   = EDGUI_COLOR_WHITE;
    ...
    cb_ina.body.main_color   = EDGUI_COLOR_SILVER;
...
static void list_init(void)
{
    ...
    list_rel.image.color       = edgui_color_hsv_to_rgb(_hue, 10, 94);
    ...
    list_pr.image.color     = edgui_color_hsv_to_rgb(_hue, 7, 96);
...
static void roller_init(void)
{
    ...
    roller_bg.body.main_color   = edgui_color_hex3(0x222);
    roller_bg.body.grad_color   = edgui_color_hex3(0x666);
...
static void tabview_init(void)
{
    ...
    tab_rel.body.main_color     = edgui_color_hex3(0x666);
    tab_rel.body.grad_color     = edgui_color_hex3(0x666);
    ...
    tab_pr.body.main_color = edgui_color_hex3(0x444);
    tab_pr.body.grad_color = edgui_color_hex3(0x444);
...
static void win_init(void)
{
    ...
    header.body.padding.left   = EDGUI_DPI / 12;
    header.body.padding.right  = EDGUI_DPI / 12;
    header.body.padding.top    = EDGUI_DPI / 20;
    header.body.padding.bottom = EDGUI_DPI / 20;
    header.body.main_color     = edgui_color_hsv_to_rgb(_hue, 30, 60);
    header.body.grad_color     = header.body.main_color;
    header.body.border.opa     = panel.body.border.opa;
    header.body.border.width   = panel.body.border.width;
    ...
    header.text.color          = edgui_color_hsv_to_rgb(_hue, 5, 100);
    header.image.color         = edgui_color_hsv_to_rgb(_hue, 5, 100);
...
static void style_mod(edgui_group_t * group, edgui_style_t * style)
{
    ...
    style->body.border.color = edgui_color_hsv_to_rgb(_hue, 70, 90);
#else
    style->body.border.opa   = EDGUI_OPA_COVER;
