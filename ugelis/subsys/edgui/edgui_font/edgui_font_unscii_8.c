...
static EDGUI_ATTRIBUTE_LARGE_CONST const uint8_t gylph_bitmap[] = {
    /* U+20 " " */
...
static const edgui_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
...
static const edgui_font_fmt_txt_cmap_t cmaps[] =
{
    {
        .range_start = 32, .range_length = 96, .type = EDGUI_FONT_FMT_TXT_CMAP_FORMAT0_TINY,
...
static edgui_font_fmt_txt_dsc_t font_dsc = {
...
edgui_font_t edgui_font_unscii_8 = {
    .dsc = &font_dsc,          /*The custom font data. Will be accessed by `get_glyph_bitmap/dsc` */
    .get_glyph_bitmap = edgui_font_get_bitmap_fmt_txt,    /*Function pointer to get glyph's bitmap*/
    .get_glyph_dsc = edgui_font_get_glyph_dsc_fmt_txt,    /*Function pointer to get glyph's data*/
    .line_height = 8,          /*The maximum line height required by the font*/
    .base_line = 2,             /*Baseline measured from the bottom of the line*/
};

#endif /*#if EDGUI_FONT_UNSCII_8*/
