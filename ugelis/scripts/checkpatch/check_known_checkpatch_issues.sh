...
do_checkpatch_bin=${UGELIS_BASE}/scripts/checkpatch/do_checkpatch.sh
timestamp_bin=${UGELIS_BASE}/scripts/checkpatch/timestamp
...
known_checkpatch_issues=${UGELIS_BASE}/scripts/known_checkpatch_issues
