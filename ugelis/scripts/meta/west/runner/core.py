...
"""uGelis binary runner core interfaces

This provides the core uGelisBinaryRunner class meant for public use,
...
class BuildConfiguration:
    ...
    def _init(self):
        build_z = os.path.join(self.build_dir, 'ugelis')
...
class uGelisBinaryRunner(abc.ABC):
    '''Abstract superclass for binary runners (flashers, debuggers).

    **Note**: these APIs are still evolving, and will change!

    With some exceptions, boards supported by uGelis must provide
    generic means to be flashed (have a uGelis firmware binary
    ...
    'flash'). uGelis boards (like 'nrf52_pca10040') declare compatible
    ...
    1. Define a uGelisBinaryRunner subclass, and implement its
    ...
    3. Give your runner's name to the uGelis build system in your
       board's build files.

    For command-line invocation from the uGelis build system, runners
    ...
    def get_runners():
        ...
        return uGelisBinaryRunner.__subclasses__()
