...
regs_config = {
    'ugelis,flash' : 'CONFIG_FLASH' ,
    'ugelis,sram'  : 'CONFIG_SRAM'  ,
    'ugelis,ccm'   : 'CONFIG_CCM'   ,
    'ugelis,sdram' : 'CONFIG_SDRAM' ,
}

name_config = {
    'ugelis,console'     : 'CONFIG_UART_CONSOLE_ON_DEV_NAME',
    'ugelis,bt-uart'     : 'CONFIG_BT_UART_ON_DEV_NAME',
    'ugelis,uart-pipe'   : 'CONFIG_UART_PIPE_ON_DEV_NAME',
    'ugelis,bt-mon-uart' : 'CONFIG_BT_MONITOR_ON_DEV_NAME',
    'ugelis,uart-mcumgr' : 'CONFIG_UART_MCUMGR_ON_DEV_NAME'
}
