...
#cov-configure --comptype gcc --compiler i586-ugelis-elfiamcu-gcc --template
#cov-build --dir /tmp/cov-build/cov-int sanitycheck -a x86 --all -b

#cov-configure --comptype gcc --compiler arm-ugelis-eabi-gcc --template
#cov-build --dir /tmp/cov-build/cov-int sanitycheck -a arm --all -b

cov-configure --comptype gcc --compiler arc-ugelis-elf-gcc --template
