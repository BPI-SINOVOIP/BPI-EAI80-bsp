...
#define RX_I2C_NAME "I2C_0"
#define TX_I2C_NAME "I2C_2"
...
static int test_i2c_irq_and_poll(void)
{
    ...
    struct device *i2c_dev = device_get_binding(RX_I2C_NAME);
    if (i2c_dev == NULL)
    {
        return RET_ERROR;
    }
    ...
    struct device *i2c_dev2 = device_get_binding(TX_I2C_NAME);
    if (i2c_dev2 == NULL)
    {
        return RET_ERROR;
    }
