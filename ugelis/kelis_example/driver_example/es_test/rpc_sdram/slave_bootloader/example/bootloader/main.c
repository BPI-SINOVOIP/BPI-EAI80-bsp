...
#else
    info.system_load_addr = 0xC0800000;    //slave CPU ugelis.bin download address
    info.system_addr = 0x10030000;          //ugelis2.bin address in NOR FLASH
    info.system_size = (128 * 1024);
#endif
