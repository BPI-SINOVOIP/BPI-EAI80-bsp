...
typedef struct
{
    ...
    __IO uint32_t ES_RISR;         /**< DES/AES raw interrupt status register, offset:0x2C */
    __IO uint32_t ES_MISR;         /**< DES/AES masked interrupt status register, offset:0x30 */
    ...
    __IO uint32_t ES_KB1_1LR;      /**< DES/AES key buffer 0 left register 1, offset:0xB8 */
    __IO uint32_t ES_KB1_1RR;      /**< DES/AES key buffer 0 right register 1, offset:0xBC */
    ...
    __IO uint32_t ES_KB3_0LR;      /**< DES/AES key buffer 2 left register 0, offset:0xD0 */
    __IO uint32_t ES_KB3_0RR;      /**< DES/AES key buffer 2 right register 0, offset:0xD4 */
    __IO uint32_t ES_KB3_1LR;      /**< DES/AES key buffer 2 left register 1, offset:0xD8 */
    __IO uint32_t ES_KB3_1RR;      /**< DES/AES key buffer 2 right register 1, offset:0xDC */
} CRYPTO_Device_T;

/** Base address of crypto engine */
#define CRYPTO_BASE        (0x50041000)
...
#define CRYP_CR_ALGOMODE_CTR             (0x6U << CRYP_CR_ALGOMODE_Pos)
...
#define CRYP_CR_DATATYPE_16BIT           (0x1 << CRYP_CR_DATATYPE_Pos)
#define CRYP_CR_DATATYPE_8BIT            (0x2 << CRYP_CR_DATATYPE_Pos)
#define CRYP_CR_DATATYPE_1BIT            (0x3 << CRYP_CR_DATATYPE_Pos)
...
#define CRYP_CR_GCM_CCMPH_0              CRYP_CR_GCM_CCMPH_Msk
...
#define CRYP_DMACR_DMATCLVL_Msk          (0xf << CRYP_DMACR_DMATXLVL_Pos)
...
/****************** Bits definition for ES_RISR register  *******************/
...
/****************** Bits definition for ES_MISR register  *******************/
...
#define CRYP_SKCFG_KEYBUF_KEY3SEL_Msk    (0x1 << CRYP_SKCFG_KEYBUF_KEY3SEL_Pos)
#define CRYP_SKCFG_KEYBUF_KEY3SEL_LOW    (0x00000000)
#define CRYP_SKCFG_KEYBUF_KEY3SEL_HIGH   (0x1 << CRYP_SKCFG_KEYBUF_KEY3SEL_Pos)

#define CRYP_SKCFG_KEYBUF_WR_SEL_Pos     (16U)
#define CRYP_SKCFG_KEYBUF_WR_SEL_Msk     (0xf << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K0          (0x00000000)
#define CRYP_SKCFG_KEYBUF_TO_K1          (0x1U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K2          (0x2U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K3          (0x3U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K4          (0x4U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K5          (0x5U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K6          (0x6U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
#define CRYP_SKCFG_KEYBUF_TO_K7          (0x7U << CRYP_SKCFG_KEYBUF_WR_SEL_Pos)
...
#define CRYP_SKCFG_OTP_K1                (0x1 << CRYP_SKCFG_OTP_SEL_Pos)
#define CRYP_SKCFG_OTP_K2                (0x2 << CRYP_SKCFG_OTP_SEL_Pos)
#define CRYP_SKCFG_OTP_K3                (0x3 << CRYP_SKCFG_OTP_SEL_Pos)
#define CRYP_SKCFG_OTP_K4                (0x4 << CRYP_SKCFG_OTP_SEL_Pos)
#define CRYP_SKCFG_OTP_K5                (0x5 << CRYP_SKCFG_OTP_SEL_Pos)
#define CRYP_SKCFG_OTP_K6                (0x6 << CRYP_SKCFG_OTP_SEL_Pos)
#define CRYP_SKCFG_OTP_K7                (0x7 << CRYP_SKCFG_OTP_SEL_Pos)

#define CRYP_SKCFG_HMACKEY_SEL_Pos       (28U)
#define CRYP_SKCFG_HMACKEY_SEL_Msk       (0x3 << CRYP_SKCFG_HMACKEY_SEL_Pos)
#define CRYP_SKCFG_HMACKEY_OTP_KEY6      (0x00000000)
#define CRYP_SKCFG_HMACKEY_OTP_KEY7      (0x1 << CRYP_SKCFG_HMACKEY_SEL_Pos)
#define CRYP_SKCFG_HMACKEY_OTP_KEY6_7    (0x2 << CRYP_SKCFG_HMACKEY_SEL_Pos)

#define CRYP_SKCFG_OTP_64_SEL_Pos        (31U)
#define CRYP_SKCFG_OTP_64_SEL_Msk        (0x1 << CRYP_SKCFG_OTP_64_SEL_Pos)
#define CRYP_SKCFG_OTP_LOW64             (0x00000000)
#define CRYP_SKCFG_OTP_HIGH64            (0x1 << CRYP_SKCFG_OTP_64_SEL_Pos)

/****************** Bits definition for CRYP_SK_CS register  *********************/
#define CRYP_SKCS_AES_GETKEY_Pos         (1U)
#define CRYP_SKCS_AES_GETKEY_Msk         (0x1 << CRYP_SKCS_AES_GETKEY_Pos)

#define CRYP_SKCS_DES_GETKEY_Pos         (8U)
#define CRYP_SKCS_DES_GETKEY_Msk         (0x1 << CRYP_SKCS_DES_GETKEY_Pos)

#define CRYP_SKCS_HMAC_GETKEY_Pos        (16U)
#define CRYP_SKCS_HMAC_GETKEY_Msk        (0x1 << CRYP_SKCS_HMAC_GETKEY_Pos)

#define CRYP_SKCS_DBGKEYSEL_Pos          (24U)
#define CRYP_SKCS_DBGKEYSEL_Msk          (0x3 << CRYP_SKCS_DBGKEYSEL_Pos)
#define CRYP_SKCS_DBGKEYSEL_DES          (0x00000000)
#define CRYP_SKCS_DBGKEYSEL_AES          (0x1 << CRYP_SKCS_DBGKEYSEL_Pos)
#define CRYP_SKCS_DBGKEYSEL_HMAC         (0x2 << CRYP_SKCS_DBGKEYSEL_Pos)
 ...
 * @{
 */
#define CRYP_ITSTATUS_INFIFO         ((uint32_t)CRYP_MISR_INMIS)     /**< Input FIFO interrupt is pending */
#define CRYP_ITSTATUS_OUTFIFO        ((uint32_t)CRYP_MISR_OUTMIS)    /**< Ouput FIFO interrupt is pending */
/**
 * @}
 */
...
/** @brief  Check whether the specified CRYP interrupt is set or not.
  ...
  */
#define HAL_CRYP_GET_ITSTATUS(__HANDLE__, irq) ((IO_BIT_GET((__HANDLE__)->Instance->ES_MISR, irq)) == irq)
