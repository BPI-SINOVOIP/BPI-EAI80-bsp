...
/**************************** UART RESET and CLOCK BASE *********************************/
#define UART_RESET_BASE                      (*(volatile uint32_t *)0x40000078)
#define UART_CLOCK_BASE                      (*(volatile uint32_t *)0x40000088)


/**************************** UART RX/TX register bitfiled *********************************/
...
/**************************** UART TX Baud Rate register bitfiled *********************************/
...
/**************************** UART contral1 register bitfiled *********************************/
...
/**************************** UART contral2 register bitfiled *********************************/
...
/**************************** UART contral3 register bitfiled *********************************/
...
#define UART_LS_TES                          ((uint32_t) ((uint32_t)0x1 << UART_LS_TES_POS))   /* UART transmitter empty status filed */
#define UART_LS_THES_POS                     ((uint32_t) 6)                                    /* UART transmitter holding register empty status pos */
#define UART_LS_THES                         ((uint32_t) ((uint32_t)0x1 << UART_LS_THES_POS))  /* UART transmitter holding register empty status filed */
#define UART_LS_DRS_POS                      ((uint32_t) 5)                                    /* UART data ready status pos */
#define UART_LS_DRS                          ((uint32_t) ((uint32_t)0x1 << UART_LS_DRS_POS))   /* UART data ready status filed */
...
/**************************** UART line status register bitfiled *********************************/
#define UART_TH_RFC_POS                       ((uint32_t) 24)                                     /* UART rx fifo data number is read out while reading operation occurs pos */
#define UART_TH_RFC                           ((uint32_t) ((uint32_t)0x1F << UART_TH_RFC_POS))    /* UART rx fifo data number is read out while reading operation occurs filed */
#define UART_TH_RTL_POS                       ((uint32_t) 16)                                     /* UART rx fifo data number is read out while reading operation occurs pos */
#define UART_TH_RTL                           ((uint32_t) ((uint32_t)0x1F << UART_TH_RTL_POS))    /* UART rx fifo data number is read out while reading operation occurs filed */
#define UART_TH_TFC_POS                       ((uint32_t) 8)                                      /* UART tx fifo data number is read out while reading operation occurs pos */
#define UART_TH_TFC                           ((uint32_t) ((uint32_t)0x1F << UART_TH_TFC_POS))    /* UART tx fifo data number is read out while reading operation occurs filed */
...
#define UART_IE_RFTRIE                         ((uint32_t) ((uint32_t)0x1 << UART_IE_RFTRIE_POS)) /* UART rx fifo trigger interrupt enable filed */
#define UART_IE_TFTIE_POS                     ((uint32_t) 16)                                     /* UART tx fifo trigger interrupt enable pos */
#define UART_IE_TFTIE                         ((uint32_t) ((uint32_t)0x1 << UART_IE_TFTIE_POS))   /* UART rx fifo trigger interrupt enable filed */
...
#define UART_IE_THEIE                         ((uint32_t) ((uint32_t)0x1 << UART_IE_THEIE_POS))   /* UART transmitter holding register empty interrupt enable filed */
#define UART_IE_RDAIE_POS                     ((uint32_t) 5)                                      /* UART receive data available interrupt enable pos */
#define UART_IE_RDAIE                         ((uint32_t) ((uint32_t)0x1 << UART_IE_RDAIE_POS))   /* UART receive data available interrupt enable filed */
...
#define UART_IS_RFTI                         ((uint32_t) ((uint32_t)0x1 << UART_IS_RFTI_POS))      /* UART rx fifo trigger interrupt status filed */
#define UART_IS_TFTI_POS                     ((uint32_t) 16)                                       /* UART tx fifo trigger interrupt status pos */
#define UART_IS_TFTI                         ((uint32_t) ((uint32_t)0x1 << UART_IS_TFTI_POS))      /* UART tx fifo trigger interrupt status filed */
...
#define UART_IS_TEI                          ((uint32_t) ((uint32_t)0x1 << UART_IS_TEI_POS))       /* UART transmitter empty interrupt filed */
#define UART_IS_THEI_POS                     ((uint32_t) 6)                                        /* UART transmitter holding register empty interrupt pos */
#define UART_IS_THEI                         ((uint32_t) ((uint32_t)0x1 << UART_IS_TEI_POS))       /* UART transmitter holding register empty interrupt filed */
#define UART_IS_RDAI_POS                     ((uint32_t) 5)                                        /* UART receive data available interrupt pos */
#define UART_IS_RDAI                         ((uint32_t) ((uint32_t)0x1 << UART_IS_RDAI_POS))      /* UART receive data available interrupt filed */
#define UART_IS_RFTOI_POS                    ((uint32_t) 4)                                        /* UART rx fifo timeout interrupt pos */
#define UART_IS_RFTOI                        ((uint32_t) ((uint32_t)0x1 << UART_IS_RFTOI_POS))     /* UART rx fifo timeout interrupt filed */
...
/**
 * @brief  Disable reset rx fifo
 *
 * @param  pUART           pUART devive Point
 *
 * @retval void
 */
#define LL_UART_TX_FIFO_RESET_DISABEL(pUART)        IO_BIT_CLEAR(pUART->C2, UART_C2_TFR)

/**
 * @brief  Enable reset rx fifo
 *
 * @param  pUART           pUART devive Point
 *
 * @retval void
 ...
 * @retval void
 */
#define LL_UART_RX_FIFO_RESET_DISABEL(pUART)        IO_BIT_CLEAR(pUART->C2, UART_C2_RFR)

/**
 * @brief  Disable all fifo
 *
 * @param  pUART           pUART devive Point
 *
 * @retval void
...
/**
 * @brief  Set baudrate div
 *
 * @param  pUART           pUART devive Point
 * @param  val             Baudrate div value
 *
 * @retval void
 */
...
/**
 * @brief  Enable uart interrupt mask
 *
 * @param  pUART           pUART devive Point
 ...
 * @retval void
 */
#define LL_UART_INTERRUPTES_ENABLE(pUART, mask)     IO_BIT_SET(pUART->IE, mask)

/**
 * @brief  Disable uart interrupt mask
 *
 * @param  pUART           pUART devive Point
 * @param  mask            Interrupt mask
 *
