...
int main(void)
{
    ...
    /*  for(i=0; i<8 ;i++)
        {
            g_UsbDeviceHidGeneric.buffer[0][i]=i;
            g_UsbDeviceHidGeneric.buffer[1][i]=i+8;
        }
    */
    ...
    while (1)
    {
        //        if(g_UsbDeviceHidGeneric.buffer[g_UsbDeviceHidGeneric.bufferIndex][0] == 0x11)
        //        {
        //            printf("hid send \n");
        //          USB_DeviceHidSend(g_UsbDeviceHidGeneric.hidHandle, USB_HID_GENERIC_ENDPOINT_IN,
        //                        (uint8_t *)&g_UsbDeviceHidGeneric.buffer[g_UsbDeviceHidGeneric.bufferIndex][0],
        //                        USB_HID_GENERIC_OUT_BUFFER_LENGTH);
        //          g_UsbDeviceHidGeneric.buffer[g_UsbDeviceHidGeneric.bufferIndex][0] = 0x0;
        //      }
