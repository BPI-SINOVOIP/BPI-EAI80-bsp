...
extern uint32_t _tick_get_32();
unsigned long  start_time()
{
    return (unsigned long)(_tick_get_32());
}
...
/* Main and Proc_0 in the Ada version             */
{
    ...
    else
    {
        ...
        // the unit of return value of time() is "micro second"
        Microseconds = (float) User_Time / (float) Number_Of_Runs;
        Dhrystones_Per_Second = (float) Number_Of_Runs * Mic_secs_Per_Second / (float) User_Time;
#endif
