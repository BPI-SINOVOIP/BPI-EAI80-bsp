...
#define SAI1_BASE                           (APB2_PERIPHERAL_BASE + 0x00002000U)// todo
#define SAI1_Block_A_BASE     (SAI1_BASE + 0x000U)// todo
#define SAI1_Block_B_BASE     (SAI1_BASE + 0x400U)// todo
...
#define SAI_xCR1_DS_               (0x1U << SAI_xCR1_DS_Pos)                   /*!< 0x00000010 */
#define SAI_xCR1_DS_0              (0x2U << SAI_xCR1_DS_Pos)                   /*!< 0x00000020 */
#define SAI_xCR1_DS_1              (0x3U << SAI_xCR1_DS_Pos)                   /*!< 0x00000040 */
#define SAI_xCR1_DS_2              (0x4U << SAI_xCR1_DS_Pos)                   /*!< 0x00000080 */
#define SAI_xCR1_DS_3              (0x5U << SAI_xCR1_DS_Pos)                   /*!< 0x000000A0 *///20BIT
#define SAI_xCR1_DS_4              (0x6U << SAI_xCR1_DS_Pos)                   /*!< 0x000000C0 *///24BIT
...
#define __HAL_SAI_LOCK(__HANDLE__)                                           \
    do{                                        \
        if((__HANDLE__)->Lock == HAL_SAI_LOCKED)   \
        {                                      \
            return HAL_SAI_BUSY;                    \
        }                                      \
        else                                   \
        {                                      \
            (__HANDLE__)->Lock = HAL_SAI_LOCKED;    \
        }                                      \
    }while (0U)

#define __HAL_SAI_UNLOCK(__HANDLE__)                                          \
    do{                                       \
        (__HANDLE__)->Lock = HAL_SAI_UNLOCKED;    \
    }while (0U)
/**
 * @brief Set rts
 *
