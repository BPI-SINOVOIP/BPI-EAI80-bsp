...
#define SLAVE_IMAGE_ADDR       (0x20000000)       /* TODO GET IT LINKSRCIRPT*/
#define VETTOR_SIZE            (90*2)


RPC_Handle_T *ghRPCTable[] = {0};

static RPC_CPUId_T HAL_RPC_GetCPUID(void);
static void HAL_RPC_IrqConfig(RPC_CPUId_T id);
static void LL_RPC_MasterCopySlaveVectorTable(void);
...
void HAL_RPC_IRQHandler(void *param)
{
    uint32_t pack = NULL;
...
void  HAL_RPC_MasterBootSlave(void)
{
