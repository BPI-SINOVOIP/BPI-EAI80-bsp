...
{
#ifdef FACEAI
    cmd_register("fe", faceai_cmd_exit, 0);
    cmd_register("fs", faceai_cmd_start, 0);
    cmd_register("fr", faceai_record, 0);
    cmd_register("fc", faceai_clear, 0);
#endif
