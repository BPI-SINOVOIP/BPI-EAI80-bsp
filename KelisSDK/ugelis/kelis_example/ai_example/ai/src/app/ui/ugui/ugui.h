...
/* -------------------------------------------------------------------------------- */
/* Classic functions */
typedef void (*UG_Point_Func)(UG_S16, UG_S16, UG_COLOR);

UG_S16 UG_Init(UG_GUI *g, UG_Point_Func p, UG_S16 x, UG_S16 y);
...
void UG_Update(void);
void UG_DrawBMP(UG_S16 xp, UG_S16 yp, UG_BMP *bmp, UG_U8 alpha);
