...
#define  DEBUG_PRINT
#define  FACE_FRAME         0x00
#define  OBJECT_FRAME       0x01
#define  GESTURE_FRAME      0x02

//#define  FRAME_PROCESS      FACE_FRAME
#define  FRAME_PROCESS      OBJECT_FRAME
...
typedef enum
{
    ...
    FRAME_GESTURE_INFO_CMD          = 0x1E,  /**< The Commander Means The Frame Type Is Gesture Info Frame */
    FRAME_FACE_INFO_CMD             = 0x2A,  /**< The Commander Means The Frame Type Is Face Info Frame */
    FRAME_FACE_START_CAP_CMD        = 0x2B,  /**< The Commander Means The Frame Type Is Face Capture Start Frame */
    FRAME_FACE_STOP_CAP_CMD         = 0x2C,  /**< The Commander Means The Frame Type Is Face Capture Stop Frame */
    FRAME_FACE_DELBASE_CMD          = 0x2D,  /**< The Commander Means The Frame Type Is Face Delete Base Frame */
    ...
    FRAME_SHELL_DEBUG_START         = 0x9A,   /**< The Commander Means The Frame Type Is Device Info Answer Frame */
    FRAME_SHELL_DEBUG_STOP          = 0x9B   /**< The Commander Means The Frame Type Is Device Info Answer Frame */
} Frame_Type_Cmd_T;
