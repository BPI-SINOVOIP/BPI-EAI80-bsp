...
#define BUFFERSIZE    0x62000 //   (0x62000*2)   //           /*INPUT_WIDTH * INPUT_HEIGHT * 4*/    112*112*32 
...
__aligned(32) unsigned char data_debug[21 * 1024] _GENERIC_SECTION_ZI(mem_ai_data);
