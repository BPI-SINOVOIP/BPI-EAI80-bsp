...
int device_init(void)
{
    ...
    *(volatile uint32_t *)(0x4003928C) &= ~0xF0;
    ...
    memset(inputImage, 0x00, BUFFERSIZE * sizeof(unsigned short));
    memset(OutputImage, 0x00, BUFFERSIZE * sizeof(unsigned short));
...
void gesture_detect(void)
{
    ...
    float biases_anchors7x7[10] = {0.9917, 1.5492, 1.4302, 2.3448, 1.8711, 3.0492, 2.3776, 4.0403, 3.7323, 5.2108};
    int nboxes;
    float thresh = 0.3;
