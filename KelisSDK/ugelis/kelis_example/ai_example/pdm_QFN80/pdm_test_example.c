...
extern void arm_correlate_f32_dsp(
...
static volatile uint32_t a_mstReceCmplt = 0;
static volatile uint32_t b_mstReceCmplt = 0;
...
//    printf("a_mstReceCmplt = %d\n", a_mstReceCmplt);
//    printf("b_mstReceCmplt = %d\n", b_mstReceCmplt);
//    printf("pingpong_offset_a = %d\n", pingpong_offset_a);
//    printf("pingpong_offset_b = %d\n", pingpong_offset_b);
    a_mstReceCmplt = 0;
    b_mstReceCmplt = 0;
	pingpong_offset_a = 0;
