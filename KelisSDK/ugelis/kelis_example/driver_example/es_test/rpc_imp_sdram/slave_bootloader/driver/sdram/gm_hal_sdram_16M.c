...
{
    *(unsigned int *)(0x1ffff0a8) |= 0xfffffba3;
    *(unsigned int *)(0x1ffff0ac) |= 0xff31ffff;
...
#else
    HW32_REG(0x400002DC) |= 1 << 24;
    HW32_REG(0x40000324) |= 0xf << 16; //SDRAM_SDCLK         XPG12
    HW32_REG(0x400002E8) |= 1 << 10;
    HW32_REG(0x40000338) |= 0xf << 20; //SDRAM_D[0]          XPJ5
    HW32_REG(0x400002E8) |= 1 << 14;
    HW32_REG(0x40000338) |= 0xf << 28; //SDRAM_D[1]          XPJ7
    HW32_REG(0x400002E8) |= 1 << 18;
    HW32_REG(0x4000033C) |= 0xf << 4 ; //SDRAM_D[2]          XPJ9
    HW32_REG(0x400002E8) |= 1 << 26;
    HW32_REG(0x4000033C) |= 0xf << 20; //SDRAM_D[3]          XPJ13
    HW32_REG(0x400002E8) |= 1 << 30;
    HW32_REG(0x4000033C) |= 0xf << 28; //SDRAM_D[4]          XPJ15
    HW32_REG(0x400002EC) |= 1 << 2 ;
    HW32_REG(0x40000340) |= 0xf << 4 ; //SDRAM_D[5]          XPK1
    HW32_REG(0x400002EC) |= 1 << 6 ;
    HW32_REG(0x40000340) |= 0xf << 12; //SDRAM_D[6]          XPK3
    HW32_REG(0x400002EC) |= 1 << 10;
    HW32_REG(0x40000340) |= 0xf << 20; //SDRAM_D[7]          XPK5
    HW32_REG(0x400002E4) |= 1 << 10;
    HW32_REG(0x40000330) |= 0xf << 20; //SDRAM_D[8]          XPI5
    HW32_REG(0x400002E4) |= 1 << 14;
    HW32_REG(0x40000330) |= 0xf << 28; //SDRAM_D[9]          XPI7
    HW32_REG(0x400002E4) |= 1 << 18;
    HW32_REG(0x40000334) |= 0xf << 4 ; //SDRAM_D[10]         XPI9
    HW32_REG(0x400002E4) |= 1 << 22;
    HW32_REG(0x40000334) |= 0xf << 12; //SDRAM_D[11]         XPI11
    HW32_REG(0x400002E4) |= 1 << 26;
    HW32_REG(0x40000334) |= 0xf << 20; //SDRAM_D[12]         XPI13
    HW32_REG(0x400002E4) |= 1 << 30;
    HW32_REG(0x40000334) |= 0xf << 28; //SDRAM_D[13]         XPI15
    HW32_REG(0x400002E8) |= 1 << 2 ;
    HW32_REG(0x40000338) |= 0xf << 4 ; //SDRAM_D[14]         XPJ1
    HW32_REG(0x400002E8) |= 1 << 6 ;
    HW32_REG(0x40000338) |= 0xf << 12; //SDRAM_D[15]         XPJ3
    HW32_REG(0x400002E4) |= 1 << 28;
    HW32_REG(0x40000334) |= 0xf << 24; //SDRAM_D[16]         XPI14
    HW32_REG(0x400002E8) |= 1 << 0 ;
    HW32_REG(0x40000338) |= 0xf << 0 ; //SDRAM_D[17]         XPJ0
    HW32_REG(0x400002E8) |= 1 << 4 ;
    HW32_REG(0x40000338) |= 0xf << 8 ; //SDRAM_D[18]         XPJ2
    HW32_REG(0x400002E8) |= 1 << 8 ;
    HW32_REG(0x40000338) |= 0xf << 16; //SDRAM_D[19]         XPJ4
    HW32_REG(0x400002EC) |= 1 << 8 ;
    HW32_REG(0x40000340) |= 0xf << 16; //SDRAM_D[20]         XPK4
    HW32_REG(0x400002EC) |= 1 << 12;
    HW32_REG(0x40000340) |= 0xf << 24; //SDRAM_D[21]         XPK6
    HW32_REG(0x400002EC) |= 1 << 14;
    HW32_REG(0x40000340) |= 0xf << 28; //SDRAM_D[22]         XPK7
    HW32_REG(0x400002EC) |= 1 << 16;
    HW32_REG(0x40000344) |= 0xf << 0 ; //SDRAM_D[23]         XPK8
    HW32_REG(0x400002C4) |= 1 << 18;
    HW32_REG(0x400002F4) |= 0xf << 4 ; //SDRAM_D[24]         XPA9
    HW32_REG(0x400002C4) |= 1 << 20;
    HW32_REG(0x400002F4) |= 0xf << 8 ; //SDRAM_D[25]         XPA10
    HW32_REG(0x400002D0) |= 1 << 4 ;
    HW32_REG(0x40000308) |= 0xf << 8 ; //SDRAM_D[26]         XPD2
    HW32_REG(0x400002D0) |= 1 << 8 ;
    HW32_REG(0x40000308) |= 0xf << 16; //SDRAM_D[27]         XPD4
    HW32_REG(0x400002D0) |= 1 << 12;
    HW32_REG(0x40000308) |= 0xf << 24; //SDRAM_D[28]         XPD6
    HW32_REG(0x400002D0) |= 1 << 16;
    HW32_REG(0x4000030C) |= 0xf << 0 ; //SDRAM_D[29]         XPD8
    HW32_REG(0x400002D0) |= 1 << 24;
    HW32_REG(0x4000030C) |= 0xf << 16; //SDRAM_D[30]         XPD12
    HW32_REG(0x400002D0) |= 1 << 28;
    HW32_REG(0x4000030C) |= 0xf << 24; //SDRAM_D[31]         XPD14
    HW32_REG(0x400002D0) |= 1 << 14;
    HW32_REG(0x40000308) |= 0xf << 28; //SDRAM_A[0]          XPD7
    HW32_REG(0x400002D0) |= 1 << 18;
    HW32_REG(0x4000030C) |= 0xf << 4 ; //SDRAM_A[1]          XPD9
    HW32_REG(0x400002D0) |= 1 << 22;
    HW32_REG(0x4000030C) |= 0xf << 12; //SDRAM_A[2]          XPD11
    HW32_REG(0x400002D0) |= 1 << 26;
    HW32_REG(0x4000030C) |= 0xf << 20; //SDRAM_A[3]          XPD13
    HW32_REG(0x400002D0) |= 1 << 30;
    HW32_REG(0x4000030C) |= 0xf << 28; //SDRAM_A[4]          XPD15
    HW32_REG(0x400002D4) |= 1 << 4 ;
    HW32_REG(0x40000310) |= 0xf << 8 ; //SDRAM_A[5]          XPE2
    HW32_REG(0x400002D4) |= 1 << 8 ;
    HW32_REG(0x40000310) |= 0xf << 16; //SDRAM_A[6]          XPE4
    HW32_REG(0x400002D4) |= 1 << 12;
    HW32_REG(0x40000310) |= 0xf << 24; //SDRAM_A[7]          XPE6
    HW32_REG(0x400002D4) |= 1 << 16;
    HW32_REG(0x40000314) |= 0xf << 0 ; //SDRAM_A[8]          XPE8
    HW32_REG(0x400002D4) |= 1 << 18;
    HW32_REG(0x40000314) |= 0xf << 4 ; //SDRAM_A[9]          XPE9
    HW32_REG(0x400002D0) |= 1 << 10;
    HW32_REG(0x40000308) |= 0xf << 20; //SDRAM_A[10]         XPD5
    HW32_REG(0x400002D4) |= 1 << 22;
    HW32_REG(0x40000314) |= 0xf << 12; //SDRAM_A[11]         XPE11
    HW32_REG(0x400002D4) |= 1 << 0 ;
    HW32_REG(0x40000310) |= 0xf << 0 ; //SDRAM_A[12]         XPE0
    HW32_REG(0x400002CC) |= 1 << 18;
    HW32_REG(0x40000304) |= 0xf << 4 ; //SDRAM_SDNWE         XPC9
    HW32_REG(0x400002CC) |= 1 << 30;
    HW32_REG(0x40000304) |= 0xf << 28; //SDRAM_SDNE[0]       XPC15
    HW32_REG(0x400002CC) |= 1 << 4 ;
    HW32_REG(0x40000300) |= 0xf << 8 ; //SDRAM_SDNE[1]       XPC2
    HW32_REG(0x400002D4) |= 1 << 26;
    HW32_REG(0x40000314) |= 0xf << 20; //SDRAM_SDCKE[0]      XPE13
    HW32_REG(0x400002CC) |= 1 << 6 ;
    HW32_REG(0x40000300) |= 0xf << 12; //SDRAM_SDCKE[1]      XPC3
    HW32_REG(0x400002CC) |= 1 << 26;
    HW32_REG(0x40000304) |= 0xf << 20; //SDRAM_SDNRAS        XPC13
    HW32_REG(0x400002CC) |= 1 << 14;
    HW32_REG(0x40000300) |= 0xf << 28; //SDRAM_NBL[0]        XPC7
    HW32_REG(0x400002D4) |= 1 << 30;
    HW32_REG(0x40000314) |= 0xf << 28; //SDRAM_NBL[1]        XPE15
    HW32_REG(0x400002CC) |= 1 << 10;
    HW32_REG(0x40000300) |= 0xf << 20; //SDRAM_NBL[2]        XPC5
    HW32_REG(0x400002CC) |= 1 << 12;
    HW32_REG(0x40000300) |= 0xf << 24; //SDRAM_NBL[3]        XPC6
    HW32_REG(0x400002CC) |= 1 << 22;
    HW32_REG(0x40000304) |= 0xf << 12; //SDRAM_SDNCAS        XPC11
    HW32_REG(0x400002D0) |= 1 << 2 ;
    HW32_REG(0x40000308) |= 0xf << 4 ; //SDRAM_BA[0]         XPD1
    HW32_REG(0x400002D0) |= 1 << 6 ;
    HW32_REG(0x40000308) |= 0xf << 12; //SDRAM_BA[1]         XPD3
#endif
