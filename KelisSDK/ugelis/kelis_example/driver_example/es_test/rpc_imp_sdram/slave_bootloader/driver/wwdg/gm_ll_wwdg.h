...
//#define WWDG_BASE                           (0x40008000u)                /* Base Addresses of WDOG Peripheral Control Registers */
//#define WWDG                               ((WDOG_Device_T *)WWDG_BASE) /* WDOG Device Pointer */
...
#define LL_WDOG_WAIT_WRITEDONE()               do{while((*(volatile uint32_t *)(0x4000001c)) & SYS_DGB_WDOG_WRITEDONE);}while(0u);         /* Waiting for DBG_CFG_CTRL bit16 wdog write done flag */
