...
#if IWDG_FPGA_TEST
static void iwdg_RegPrint(void)
{
    /*after iwdg reset,iwdg reg cann't reset value*/
    printk("\r KR:0x%x\n", (*(volatile uint32_t *)(0x40008000)));
    printk("\r Pres:0x%x\n", (*(volatile uint32_t *)(0x40008004)));
    printk("\r Reload:0x%x\n", (*(volatile uint32_t *)(0x40008008)));
    printk("\r status:0x%x\n", (*(volatile uint32_t *)(0x4000800c)));
    printk("\r version:0x%x\n", (*(volatile uint32_t *)(0x400080fc)));

}
#endif /*#if IWDG_FPGA_TEST*/
