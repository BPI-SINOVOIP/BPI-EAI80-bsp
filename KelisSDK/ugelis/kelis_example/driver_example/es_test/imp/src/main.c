...
//#define TEST_CASE_MODE0_ARGB4444    1
//#define TEST_CASE_MODE0_L8_ALIGN_0  1
...
//#define TEST_CASE_MODE2_AL44_ARGB8888                                    1
//#define TEST_CASE_MODE2_AL88_ARGB8888                                    1
//#define TEST_CASE_MODE2_ARGB8888_RGB565                                1
//#define TEST_CASE_MODE2_ARGB8888_L8                                1
//#define TEST_CASE_MODE2_ARGB1555_L8                            1
//#define TEST_CASE_MODE2_ARGB4444_L8                            1
                   ...
                   uint32_t input_offset, uint32_t output_offset, uint32_t pic_width, uint32_t pic_height)
{
    ...
    HAL_IMP_Start(pIMP, fg_addr, dst, &scaleCfg);
...
void main(void)
{
    ...
    while (1)
    {
        ...
        if (ret == 0)
        {
#if (defined TEST_CASE_MODE0_ARGB8888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode0((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_MODE0_RGB888)
            IMP_test_mode0(dis_buf.addr, (uint32_t)argb8888, IMP_INPUT_RGB888, FMT_RGB888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB888);
#elif (defined TEST_CASE_MODE0_RGB565)
            IMP_test_mode0(dis_buf.addr, (uint32_t)argb8888, IMP_INPUT_RGB565, FMT_RGB565, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif (defined TEST_CASE_MODE0_ARGB1555)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB1555, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode0((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB1555, FMT_ARGB1555, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB1555);
#elif (defined TEST_CASE_MODE0_ARGB4444)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB4444, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode0((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB4444, FMT_ARGB4444, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB4444);
#elif defined(TEST_CASE_MODE0_L8_ALIGN_0)
...
#elif defined(TEST_CASE_MODE0_L8_ALIGN_1) || defined(TEST_CASE_MODE0_L8_ALIGN_2) || defined(TEST_CASE_MODE0_L8_ALIGN_3)
            imlib_rgb565_to_gray(dis_buf.addr, gray_pic_0, sizeOfPixel);
            IMP_test_mode0((uint32_t)gray_pic_0, (uint32_t)gray_pic_1, IMP_INPUT_L8, FMT_L8, 0, 0, info.pic_width, info.pic_height);
            memcpy(gray_pic, gray_pic_1, sizeOfPixel);
            addr = (uint32_t)gray_pic;
            LCD_set_pixfmt(FMT_L8);
#elif (defined TEST_CASE_MODE0_AL44)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imlib_argb8888_to_al44((uint32_t)argb8888_pic_0, (uint8_t *)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode0((uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_AL44, FMT_AL44, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_AL44);
#elif (defined TEST_CASE_MODE0_AL88)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imlib_argb8888_to_al88((uint32_t)argb8888_pic_0, (uint16_t *)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode0((uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_AL88, FMT_AL88, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_AL88);
#elif (defined TEST_CASE_MODE1_ARGB8888_RGB888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode1((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_RGB888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB888);
#elif (defined TEST_CASE_MODE1_RGB888_RGB565)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888, IMP_INPUT_RGB888, FMT_RGB565, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif (defined TEST_CASE_MODE1_RGB565_L8)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888, IMP_INPUT_RGB565, FMT_L8, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_L8);
#elif (defined TEST_CASE_MODE1_RGB888_L8)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888, IMP_INPUT_RGB888, FMT_L8, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_L8);
#elif (defined TEST_CASE_MODE1_RGB565_ARGB1555)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888, IMP_INPUT_RGB565, FMT_ARGB1555, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB1555);
#elif (defined TEST_CASE_MODE1_ARGB1555_ARGB4444)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB1555, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode1((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB1555, FMT_ARGB4444, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB4444);
#elif (defined TEST_CASE_MODE1_ARGB4444_ARGB8888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB4444, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode1((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB4444, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_MODE1_L8_ARGB8888) || defined (TEST_CASE_MODE1_L8_ARGB8888_CLUT)
            imlib_rgb565_to_gray(dis_buf.addr, gray_pic_0, sizeOfPixel);
            IMP_test_mode1((uint32_t)gray_pic_0, (uint32_t)argb8888, IMP_INPUT_L8, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_MODE1_AL44_RGB565) || defined(TEST_CASE_MODE1_AL44_RGB565_CLUT)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imlib_argb8888_to_al44((uint32_t)argb8888_pic_0, (uint8_t *)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode1((uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_AL44, FMT_RGB565, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif (defined TEST_CASE_MODE1_AL88_RGB888) || defined(TEST_CASE_MODE1_AL88_RGB888_CLUT)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imlib_argb8888_to_al88((uint32_t)argb8888_pic_0, (uint16_t *)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode1((uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_AL88, FMT_RGB888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB888);
#elif (defined TEST_CASE_MODE1_ARGB8888_RGB888_SCALE_NARROW) || (defined TEST_CASE_MODE1_ARGB8888_RGB888_SCALE_MAGNIFY)
            imlib_rgb565_to_argb8888(dis_buf.addr, (uint32_t)argb8888_pic_0, 0x7f, sizeOfPixel);
            IMP_test_mode1((uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_RGB888, 40, 40, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB888);
#elif defined(TEST_CASE_MODE2_RGB888_ARGB8888)
            IMP_test_mode3(0x7f00ff00, (uint32_t)argb8888_pic_0, FMT_RGB888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2(dis_buf.addr, (uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_RGB888, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_RGB565_ARGB8888)
            IMP_test_mode3(0x7f0000ff, (uint32_t)argb8888_pic_0, FMT_RGB565, 0, info.pic_width, info.pic_height);
            IMP_test_mode2(dis_buf.addr, (uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_ARGB1555_ARGB8888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB1555, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0xffff0000, (uint32_t)argb8888_pic_1, FMT_ARGB1555, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB1555, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_ARGB4444_ARGB8888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB4444, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0x7f0000ff, (uint32_t)argb8888_pic_1, FMT_ARGB4444, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB4444, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_L8_ARGB8888)
            imlib_rgb565_to_gray(dis_buf.addr, gray_pic_0, sizeOfPixel);
            imlib_gray_to_background((uint32_t)gray_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)gray_pic_0, (uint32_t)gray_pic_1, (uint32_t)argb8888, IMP_INPUT_L8, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_AL44_ARGB8888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imlib_argb8888_to_al44((uint32_t)argb8888_pic_0, (uint8_t *)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_AL44, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_AL88_ARGB8888)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imlib_argb8888_to_al88((uint32_t)argb8888_pic_0, (uint8_t *)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_AL88, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_ARGB8888_RGB565)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0x7fff0000, (uint32_t)argb8888_pic_1, FMT_ARGB8888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_RGB565, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif defined(TEST_CASE_MODE2_ARGB8888_L8)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0x7fff0000, (uint32_t)argb8888_pic_1, FMT_ARGB8888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_L8, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_L8);
#elif defined(TEST_CASE_MODE2_ARGB4444_L8)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB4444, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0xff00ff00, (uint32_t)argb8888, FMT_ARGB1555, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB4444, FMT_L8, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_L8);
#elif defined(TEST_CASE_MODE2_ARGB1555_L8)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB1555, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0xff0000ff, (uint32_t)argb8888, FMT_ARGB1555, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB1555, FMT_L8, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_L8);
#elif defined(TEST_CASE_MODE2_ARGB8888_RGB565_ALIGN_2)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0x7fff0000, (uint32_t)argb8888_pic_1, FMT_ARGB8888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888_pic_2, IMP_INPUT_ARGB8888, FMT_RGB565, 0, 0, info.pic_width, info.pic_height);
            memcpy(argb8888, argb8888_pic_2, sizeOfPixel * 2);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif defined(TEST_CASE_MODE2_ARGB8888_ARGB8888_OFFSET_ODD)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0x7fff0000, (uint32_t)argb8888_pic_1, FMT_ARGB8888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_ARGB8888, 45, 45, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_ARGB8888_ARGB8888_OFFSET_EVEN)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            IMP_test_mode3(0x7fff0000, (uint32_t)argb8888_pic_1, FMT_ARGB8888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_ARGB8888, FMT_ARGB8888, 40, 40, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif defined(TEST_CASE_MODE2_L8_RGB565_ALIGN_OFFSET_ODD)
            imlib_rgb565_to_gray(dis_buf.addr, (char *)argb8888_pic_0, sizeOfPixel);
            imlib_gray_to_background((uint32_t)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888_pic_2, IMP_INPUT_L8, FMT_RGB565, 20, 20, info.pic_width, info.pic_height);
            memcpy(argb8888, argb8888_pic_2, sizeOfPixel * 2);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif defined(TEST_CASE_MODE2_L8_RGB565_ALIGN_OFFSET_EVEN)
            imlib_rgb565_to_gray(dis_buf.addr, (char *)argb8888_pic_0, sizeOfPixel);
            imlib_gray_to_background((uint32_t)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888_pic_2, IMP_INPUT_L8, FMT_RGB565, 35, 35, info.pic_width, info.pic_height);
            memcpy(argb8888, argb8888_pic_2, sizeOfPixel * 2);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif (defined TEST_CASE_MODE2_A4_RGB888)
            imlib_gray_to_background((uint32_t)argb8888_pic_0, sizeOfPixel);
            imlib_gray_to_background((uint32_t)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_A4, FMT_RGB888, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB888);
#elif (defined TEST_CASE_MODE2_A8_RGB565)
            imlib_gray_to_background((uint32_t)argb8888_pic_0, sizeOfPixel);
            imlib_gray_to_background((uint32_t)argb8888_pic_1, sizeOfPixel);
            IMP_test_mode2((uint32_t)argb8888_pic_0, (uint32_t)argb8888_pic_1, (uint32_t)argb8888, IMP_INPUT_A8, FMT_RGB565, 0, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif (defined TEST_CASE_MODE2_RGB565_RGB888_ARGB8888)
            IMP_test_mode3(0x7f00ff00, (uint32_t)argb8888_pic_0, FMT_RGB888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2((uint32_t)dis_buf.addr, (uint32_t)argb8888_pic_0, (uint32_t)argb8888, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_MODE2_RGB888_ARGB8888_SCALE_NARROW) || (defined TEST_CASE_MODE2_RGB888_ARGB8888_SCALE_MAGNIFY)
            IMP_test_mode3(0x7f00ff00, (uint32_t)argb8888_pic_0, FMT_RGB888, 0, info.pic_width, info.pic_height);
            IMP_test_mode2(dis_buf.addr, (uint32_t)argb8888_pic_0, (uint32_t)argb8888, IMP_INPUT_RGB888, FMT_ARGB8888, 40, 40, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_MODE3_ARGB8888)
            IMP_test_mode3(0x7fff0000, (uint32_t)argb8888, FMT_ARGB8888, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_MODE3_RGB888)
            IMP_test_mode3(0x7f00ff00, (uint32_t)argb8888, FMT_RGB888, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB888);
#elif (defined TEST_CASE_MODE3_RGB565)
            IMP_test_mode3(0x7f0000ff, (uint32_t)argb8888, FMT_RGB565, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#elif (defined TEST_CASE_MODE3_ARGB1555)
            IMP_test_mode3(0xffff0000, (uint32_t)argb8888, FMT_ARGB1555, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB1555);
#elif (defined TEST_CASE_MODE3_ARGB4444)
            IMP_test_mode3(0x7f0000ff, (uint32_t)argb8888, FMT_ARGB4444, 0, info.pic_width, info.pic_height);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB4444);
#elif (defined TEST_CASE_16RD_32WR)
            imp_trans(dis_buf.addr, 0, (uint32_t)argb8888, 0, info.pic_width, info.pic_height, 1, 0);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_ARGB8888);
#elif (defined TEST_CASE_32RD_16WR)
            IMP_test_mode1(dis_buf.addr, (uint32_t)argb8888_pic_0, IMP_INPUT_RGB565, FMT_ARGB8888, 0, 0, info.pic_width, info.pic_height);
            imp_trans(argb8888_pic_0, 0, (uint32_t)argb8888, 0, info.pic_width, info.pic_height, 0, 1);
            addr = (uint32_t)argb8888;
            LCD_set_pixfmt(FMT_RGB565);
#endif
