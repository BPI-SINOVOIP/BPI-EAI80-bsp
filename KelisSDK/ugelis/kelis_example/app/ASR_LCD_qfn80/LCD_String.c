...
int lcd_ShowAllString()
{

    /*中文*/
    lcd_draw_chstr(240, 40, 100, 16, 16, chstr_cmd[0], WORD_COLOR);
    lcd_draw_chstr(240, 80, 100, 16, 16, chstr_cmd[7], WORD_COLOR);
    lcd_draw_chstr(240, 100, 100, 16, 16, chstr_cmd[13], WORD_COLOR);
    lcd_draw_chstr(240, 120, 100, 16, 16, chstr_cmd[14], WORD_COLOR);    
    lcd_draw_chstr(240, 140, 100, 16, 16, chstr_cmd[31], WORD_COLOR);
    lcd_draw_chstr(240, 60, 100, 16, 16, chstr_cmd[32], WORD_COLOR);
    
    lcd_draw_chstr(360, 40, 100, 16, 16, chstr_cmd[17], WORD_COLOR);    
    lcd_draw_chstr(360, 60, 100, 16, 16, chstr_cmd[23], WORD_COLOR);
    lcd_draw_chstr(360, 80, 100, 16, 16, chstr_cmd[29], WORD_COLOR);
    lcd_draw_chstr(360, 100, 100, 16, 16, chstr_cmd[30], WORD_COLOR);
    lcd_draw_chstr(360, 120, 100, 16, 16, chstr_cmd[34], WORD_COLOR);
    lcd_draw_chstr(360, 140, 100, 16, 16, chstr_cmd[36], WORD_COLOR);
}
