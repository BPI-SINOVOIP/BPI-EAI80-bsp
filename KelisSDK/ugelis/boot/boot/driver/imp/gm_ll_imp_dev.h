...
typedef struct
{
  ...
  __IO uint32_t IFCR;          /**< IMP Interrupt Flag Clear Register,            Address offset: 0x08 */
  ...
  __IO uint32_t AMTCR;         /**< IMP AHB Master Timer Configuration Register,  Address offset: 0x4C */
