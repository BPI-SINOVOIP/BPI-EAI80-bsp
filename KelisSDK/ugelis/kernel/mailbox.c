...
#ifdef __USE_KEIL_
extern unsigned char Image$$KMBOX_REGION$$Base;
extern unsigned char Image$$KMBOX_REGION$$Length;

struct k_mbox* _k_mbox_list_start;
struct k_mbox* _k_mbox_list_end;
#else
...
#ifdef __USE_KEIL_
	_k_mbox_list_start = (struct k_mbox*)&Image$$KMBOX_REGION$$Base;
	_k_mbox_list_start = (struct k_mbox*)((uint32_t)&Image$$KMBOX_REGION$$Base + (uint32_t)&Image$$KMBOX_REGION$$Length);
#endif
