...
#ifdef __USE_KEIL_
extern unsigned char Image$$KMSGQ_REGION$$Base;
extern unsigned char Image$$KMSGQ_REGION$$Length;
...
#ifdef __USE_KEIL_
	_k_msgq_list_start = (struct k_msgq*)&Image$$KMSGQ_REGION$$Base;
	_k_msgq_list_end = (struct k_msgq*)((uint32_t)&Image$$KMSGQ_REGION$$Base + (uint32_t)&Image$$KMSGQ_REGION$$Length);
#endif	
