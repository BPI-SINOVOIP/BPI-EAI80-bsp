...
extern struct _kernel g_kernel;

#ifdef CONFIG_SMP
#define _current_cpu (_arch_curr_cpu())
#define _current (_arch_curr_cpu()->current)
#else
#define _current_cpu (&g_kernel.cpus[0])
#define _current g_kernel.current
#endif

#define _ready_q g_kernel.ready_q
#define _timeout_q g_kernel.timeout_q
#define _threads g_kernel.threads
