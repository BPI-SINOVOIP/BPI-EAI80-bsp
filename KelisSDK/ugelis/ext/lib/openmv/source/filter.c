...
void imlib_mean_filter(image_t *img, const int ksize, bool threshold, int offset, bool invert, image_t *mask)
{
    ...
    switch(img->bpp) {
        case IMAGE_BPP_BINARY: {
            ...
            buf.data = (uint8_t *)malloc(IMAGE_BINARY_LINE_LEN_BYTES(img) * brows);
            memset(buf.data, 0, IMAGE_BINARY_LINE_LEN_BYTES(img) * brows);
        ...
        case IMAGE_BPP_GRAYSCALE: {
            ...
            buf.data = (uint8_t *)malloc(IMAGE_GRAYSCALE_LINE_LEN_BYTES(img) * brows);
            memset(buf.data, 0, (IMAGE_GRAYSCALE_LINE_LEN_BYTES(img) * brows));
        ...
        case IMAGE_BPP_RGB565: {
            ...
            buf.data = (uint8_t *)malloc(IMAGE_RGB565_LINE_LEN_BYTES(img) * brows);
            memset(buf.data, 0, (IMAGE_RGB565_LINE_LEN_BYTES(img) * brows));
...
void imlib_median_filter(image_t *img, const int ksize, float percentile, bool threshold, int offset, bool invert, image_t *mask)
{
    ...
    //int int_percentile = fast_floorf(percentile * (n - 1));
    int int_percentile = n/2;
    ...
    switch(img->bpp) {
        ...
        case IMAGE_BPP_RGB565: {
            ...
            buf.data = (uint8_t *)malloc(IMAGE_RGB565_LINE_LEN_BYTES(img) * brows);
            memset(buf.data, 0, (IMAGE_RGB565_LINE_LEN_BYTES(img) * brows));
            int *r_data = (int *)malloc(n*sizeof(int));
            memset(r_data, 0, (n*sizeof(int)));
            int *g_data = (int *)malloc(n*sizeof(int));
            memset(g_data, 0, (n*sizeof(int)));
            int *b_data = (int *)malloc(n*sizeof(int));
            memset(b_data, 0, (n*sizeof(int)));
