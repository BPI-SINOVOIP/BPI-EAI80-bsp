...
struct ugelis_stat_mgmt_walk_arg {
...
static int
ugelis_stat_mgmt_walk_cb(struct stats_hdr *hdr, void *arg,
                         const char *name, uint16_t off)
{
    struct ugelis_stat_mgmt_walk_arg *walk_arg;
                             ...
                             void *arg)
{
    ...
    walk_arg = (struct ugelis_stat_mgmt_walk_arg) {
        .cb = cb,
        .arg = arg,
    };

    return stats_walk(hdr, ugelis_stat_mgmt_walk_cb, &walk_arg);
}
