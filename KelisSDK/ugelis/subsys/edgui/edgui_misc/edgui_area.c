...
void edgui_area_set_pos(edgui_area_t * area_p, edgui_coord_t x, edgui_coord_t y)
{
    ...
    area_p->x1   = x;
    area_p->y1   = y;
    edgui_area_set_width(area_p, w);
    edgui_area_set_height(area_p, h);
}
...
bool edgui_area_intersect(edgui_area_t * res_p, const edgui_area_t * a1_p, const edgui_area_t * a2_p)
{
    ...
    res_p->x1 = EDGUI_MATH_MAX(a1_p->x1, a2_p->x1);
    res_p->y1 = EDGUI_MATH_MAX(a1_p->y1, a2_p->y1);
    res_p->x2 = EDGUI_MATH_MIN(a1_p->x2, a2_p->x2);
    res_p->y2 = EDGUI_MATH_MIN(a1_p->y2, a2_p->y2);
...
{
    a_res_p->x1 = EDGUI_MATH_MIN(a1_p->x1, a2_p->x1);
    a_res_p->y1 = EDGUI_MATH_MIN(a1_p->y1, a2_p->y1);
    a_res_p->x2 = EDGUI_MATH_MAX(a1_p->x2, a2_p->x2);
    a_res_p->y2 = EDGUI_MATH_MAX(a1_p->y2, a2_p->y2);
}
