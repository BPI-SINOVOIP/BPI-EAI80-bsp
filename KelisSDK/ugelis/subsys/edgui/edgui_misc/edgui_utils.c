 ...
 */
char * edgui_utils_num_to_str(int32_t num, char * buf)
{
    if(num == 0) {
        buf[0] = '0';
        buf[1] = '\0';
 ...
 * @param cmp    Pointer to comparison function (see #edgui_font_codeCompare as a comparison function
 * example)
 *
 * @return a pointer to a matching item, or NULL if none exists.
 */
void * edgui_utils_bsearch(const void * key, const void * base, uint32_t n, uint32_t size,
