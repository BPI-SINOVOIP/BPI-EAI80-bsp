...
#if CONFIG_DATA_V0
#define SDRAM_BASE_ADDRESS 0x00000000 /* data section is in sdram virtual address(0x0.......) */
#else
#define SDRAM_BASE_ADDRESS CONFIG_SDRAM_BASE_ADDRESS /* data section is in sdram physis address(0xC.......) */
#endif
...
#define MEM_PM_SAVE_START               (SDRAM_BASE_ADDRESS)
#define MEM_PM_SAVE_END                 (MEM_PM_SAVE_START+MEM_PM_RESVER_SIZE)

#if(MEM_PM_SAVE_END > (SDRAM_BASE_ADDRESS + __SIZE_K(CONFIG_IMAGE_OFFSET_SIZE)))
#error "###MEM_PM_SAVE_END > (SDRAM_BASE_ADDRESS + __SIZE_K(CONFIG_IMAGE_OFFSET_SIZE))####"
#endif
...
#define  MEM_RESVER_START                  (SDRAM_BASE_ADDRESS + __SIZE_K(CONFIG_SDRAM_SIZE) - MEM_RESVER_SIZE)
...
#endif
#define  CAMERA_IMAGE_BUFFER_END           (CAMERA_IMAGE_BUFFER_START+ CONFIG_CAMERA_IMAGE_BUFFER_LENGTH)
...
#if(MEM_RESVER_END > (SDRAM_BASE_ADDRESS + __SIZE_K(CONFIG_SDRAM_SIZE)))
#error "###MEM_RESVER_END > (SDRAM_BASE_ADDRESS + CONFIG_SDRAM_SIZE)####"
#endif
