...
static int uart1_pinmux_config(void)
{
    ...
    Device_Pinmux_T s_uartPinMux[2] =
    {
        {PINMUX_GPIO_PIN_2, GPIOC, GPIOC2_AF0_UART1_TX},
        {PINMUX_GPIO_PIN_3, GPIOC, GPIOC3_AF0_UART1_RX},
    };
...
static int lcd_pinmux_config()
{
    ...
    struct device *portf = NULL;
    GPIO_PinConfig_T pin_cfg;
    Device_Pinmux_T s_VOUTPinMux[20] =
    {
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[0].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[1].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(porte, s_VOUTPinMux[2].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
    ...
    ret = pinmux_pin_set(portf, s_VOUTPinMux[18].pin, (unsigned int)&pin_cfg);
    if (ret)
    {
        return ret;
    }
...
static int adc_pinmux_config(void)
{
    ...
    static Device_Pinmux_T s_pinmux[] =
    {
        ...
        {PINMUX_GPIO_PIN_5,  GPIOC, GPIO_AF_NONE}, /* ADC_CHANNEL_1 pinmux config paramter */
...
#endif
#ifdef CHIP_F6721B
        {PINMUX_GPIO_PIN_8, GPIOC, GPIOC8_AF2_I2C2_SDA},
        {PINMUX_GPIO_PIN_9, GPIOC, GPIOC9_AF2_I2C2_SCL},
#endif
    };
...
#ifdef CONFIG_DEVICE_POWER_MANAGEMENT
DEVICE_DEFINE(gm_pinmux, "pinmux_qfn80pin", pinmux_gm_initialize, gm_pinmux_pm_control, \
              NULL, NULL, PRE_KERNEL_1, DEVICE_PRIORITY_BOARD_PINMUX,  NULL) ;
#else

DEVICE_DEFINE(gm_pinmux, "pinmux_qfn80pin", pinmux_gm_initialize, NULL, \
              NULL, NULL, PRE_KERNEL_1, DEVICE_PRIORITY_BOARD_PINMUX,  NULL) ;
