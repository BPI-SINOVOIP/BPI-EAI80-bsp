...
#define  GPIO_INT                  (1 << 28)
#ifdef CONFIG_SOC_SERIES_GM6721X
    #define PULL_UP 0
    ...
    #define  GPIO_INT_ACTIVE_LOW       GPIO_MODE_IT_LOW
    #define  GPIO_INT_ACTIVE_FALLING   GPIO_MODE_IT_FALLING
    #define  GPIO_INT_ACTIVE_HIGH      GPIO_MODE_IT_HIGH
    #define  GPIO_INT_ACTIVE_RISING    GPIO_MODE_IT_RISING

    /** Do Level trigger. */
    #define GPIO_INT_LEVEL      (0 << 7)

    /** Do Edge trigger. */
    #define GPIO_INT_EDGE       (0 << 7)
