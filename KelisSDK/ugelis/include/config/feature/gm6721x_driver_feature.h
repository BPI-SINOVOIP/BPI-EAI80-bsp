...
/*hardware IIC camera*/
#if defined(CONFIG_OV5640)||defined(CONFIG_BF3007)||defined(CONFIG_GC0308)
    ...
    //#define CONFIG_CAMERA_0_I2C_NAME CONFIG_I2C_GPIO_0_NAME
        ...
        #define CONFIG_GC0308_0     1
    #endif
    /*gpio sccb camera*/
#elif defined(CONFIG_GC2145)||defined(CONFIG_OV7725)
    #define CONFIG_SCCB_0
    #define CONFIG_CAMERA_0_SCCB_NAME   "SCCB_0"
    #if defined(CONFIG_GC2145)
        #define CONFIG_GC2145_0 1
    #elif defined(CONFIG_OV7725)
        #define CONFIG_OV7725_0     1
    #endif
#endif
/*config the second camera protocol*/
/*hardware IIC camera*/
#if defined(CONFIG_OV5640_1)||defined(CONFIG_BF3007_1)||defined(CONFIG_GC0308_1)
    #define CONFIG_I2C_2  1
    #define CONFIG_CAMERA_1_I2C_NAME CONFIG_I2C_2_NAME
    /*gpio sccb camera*/
#elif defined(CONFIG_GC2145_1)||defined(CONFIG_OV7725_1)
...
/********************************************/
    ...
    #elif defined(BANPIBOARD_QFN80PIN_HW)
        #define CONFIG_I2C_2    1
