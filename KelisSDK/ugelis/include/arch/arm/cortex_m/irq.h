...
extern void _sw_isr_table_set(s32_t irq,s32_t flags,void *func,void *param);
#endif
...
({ \
	_sw_isr_table_set(irq_p, 0, isr_p, isr_param_p); \
...
({ \
	_sw_isr_table_set(irq_p, ISR_FLAG_DIRECT, isr_p, NULL); \
	_irq_priority_set(irq_p, priority_p, flags_p); \
	irq_p; \
})
#else
