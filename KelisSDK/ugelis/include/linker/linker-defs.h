...
#else
static char *__bss_start;
static char *__bss_end;
extern unsigned char Image$$BSS_REGION$$Base;
extern unsigned char Image$$BSS_REGION$$Limit;
extern unsigned char Load$$BSS_REGION$$Length;
extern unsigned char Image$$BSS_REGION$$Length;

extern unsigned char Image$$NOINIT_REGION$$Base;
extern unsigned char Load$$NOINIT_REGION$$Length;
extern unsigned char Load$$DEVICE_PRE_KERNEL1_REGION$$Base;
extern unsigned char Image$$DEVICE_PRE_KERNEL1_REGION$$Base;

extern unsigned char Load$$DATA_START_REGION$$Base;
extern unsigned char Image$$DATA_START_REGION$$Base;
extern unsigned char Load$$DATA_START_REGION$$Length;
extern unsigned char Image$$DATA_START_REGION$$Length;
extern unsigned char Image$$DATA_END_REGION$$Base;
extern unsigned char Load$$DATA_END_REGION$$Length;

extern unsigned char Load$$VECTOR_REGION$$Base;
extern unsigned char Image$$VECTOR_REGION$$Base;
extern unsigned char Image$$VECTOR_REGION$$Length;
extern unsigned char Load$$VECTOR_REGION$$Length;
extern unsigned char Image$$VECTOR_REGION$$Limit;

extern unsigned char Load$$TEXT_REGION$$Base;
extern unsigned char Image$$TEXT_REGION$$Base;
extern unsigned char Image$$TEXT_REGION$$Length;
extern unsigned char Load$$TEXT_REGION$$Length;
extern unsigned char Load$$TEXT_REGION$$Limit;
#endif
...
#else
static char *__data_rom_start;
static char *__data_ram_start;
static char *__data_ram_end;
#endif
#ifdef CONFIG_APPLICATION_MEMORY
...
#else
static char *_vector_start = (char *)&Image$$VECTOR_REGION$$Base;
static char *_vector_end = (char *)&Image$$VECTOR_REGION$$Limit;
#endif
