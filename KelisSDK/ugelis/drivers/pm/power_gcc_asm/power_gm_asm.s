...
#include <arch/cpu.h>
_ASM_FILE_PROLOGUE
GTEXT(pm_save_current_cpu_contex_asm)
GTEXT(pm_gm_resume_cpu_contex_asm)


/**/
SECTION_FUNC(TEXT, pm_save_current_cpu_contex_asm)
push {r0}
...
SECTION_FUNC(TEXT, pm_gm_resume_cpu_contex_asm)
