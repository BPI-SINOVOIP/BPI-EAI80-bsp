...
/*i2c select*/
#if defined(F6721B_EVB_QFN80PIN)||defined(BANPIBOARD_QFN80PIN)//all demoQFN80 board only support gpio i2c
/*software gpio i2c protocol*/
#include "../i2c/i2c_gpio.c"
#include "../i2c/i2c_bitbang.c"
#elif defined(LQFP176_DEMO_BOARD)//176 demoboard and bipaiboard support hardware i2c
