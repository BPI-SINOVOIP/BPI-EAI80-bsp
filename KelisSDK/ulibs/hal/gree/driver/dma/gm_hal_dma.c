...
static DMA_Channel_Info_T s_dmaChannelInfoMap[] =
{
    ...
    {DMA_CHANNEL_0, DMA_DEV_3, DMA_REQUEST_PDM_A},
    ...
    {DMA_CHANNEL_1, DMA_DEV_1, DMA_REQUEST_PDM_B},
    ...
    {DMA_CHANNEL_2, DMA_DEV_2, DMA_REQUEST_PDM_C},
    ...
    {DMA_CHANNEL_3, DMA_DEV_3, DMA_REQUEST_PDM_D},
    ...
    {DMA_CHANNEL_4, DMA_DEV_1, DMA_REQUEST_PDM_A},
    ...
    {DMA_CHANNEL_6, DMA_DEV_0, DMA_REQUEST_PDM_B},//47
#endif
    ...
    /* channel 15 */
    {DMA_CHANNEL_15, DMA_DEV_0, DMA_REQUEST_PDM_D},
...
RET_CODE HAL_DMA_MultiBuffer_Start(DMA_Handle_T *hDMA, uint32_t srcAddress, uint32_t destAddress, uint32_t SecondMemAddress, uint32_t size)
{
    ...
    if ((SecondMemAddress & 0xF0000000) == 0)
    {
        SecondMemAddress |= 0xC0000000;
    }
