...
#define UART_IE_TXIDL_POS                     ((uint32_t) 7)                                      /* UART transmitter empty interrupt enable pos */
#define UART_IE_TXIDL                         ((uint32_t) ((uint32_t)0x1 << UART_IE_TXIDL_POS))     /* UART transmitter empty interrupt enable filed */
...
#define UART_IE_RFTO_POS                      ((uint32_t) 4)                                      /* UART receive timerout interrupt enable pos */
#define UART_IE_RFTO                          ((uint32_t) ((uint32_t)0x1 << UART_IE_RFTO_POS))   /* UART receive timerout interrupt enable filed */
...
#define UART_IS_TXIDL_POS                    ((uint32_t) 7)                                        /* UART transmitter empty interrupt pos */
#define UART_IS_TXIDL                        ((uint32_t) ((uint32_t)0x1 << UART_IS_TXIDL_POS))       /* UART transmitter empty interrupt filed */
#define UART_IS_THEI_POS                     ((uint32_t) 6)                                        /* UART transmitter holding register empty interrupt pos */
#define UART_IS_TXHE                         ((uint32_t) ((uint32_t)0x1 << UART_IS_THEI_POS))       /* UART transmitter holding register empty interrupt filed */
...
{
    IO_BIT_SET(pUART->IE, (UART_IE_TXHE | UART_IE_TXIDL));
}

__STATIC_INLINE void LL_UART_Disable_Tx_Interrupts(UART_Device_T *pUART)
{
    IO_BIT_CLEAR(pUART->IE, (UART_IE_TXHE | UART_IE_TXIDL));
}
...
__STATIC_INLINE int LL_UART_Is_IE_TXIDL(UART_Device_T *pUART)
{
    return !!(pUART->IE & UART_IE_TXIDL);
}
...
__STATIC_INLINE int LL_UART_Is_IS_TXIDL(UART_Device_T *pUART)
{
    return !!(pUART->IS & UART_IS_TXIDL);
}
...
__STATIC_INLINE void LL_UART_Clear_IS_TXIDL(UART_Device_T *pUART)
{
    IO_BIT_SET(pUART->IS, UART_IS_TXIDL);
}
...
{
    IO_BIT_SET(pUART->IE, (UART_IE_TFT | UART_IE_TXIDL));

}

__STATIC_INLINE void LL_UART_Disable_TxFifo_Interrupts(UART_Device_T *pUART)
{
    IO_BIT_CLEAR(pUART->IE, (UART_IE_TFT | UART_IE_TXIDL));
...
{
    IO_BIT_SET(pUART->IE, UART_IE_RFT | UART_IE_RFTO);
}
...
__STATIC_INLINE int LL_UART_Is_IE_RFT(UART_Device_T *pUART)
{
    return !!(pUART->IE & UART_IE_RFT);
}

__STATIC_INLINE int LL_UART_Is_IE_RFTO(UART_Device_T *pUART)
{
    return !!(pUART->IE & UART_IE_RFTO);
}
