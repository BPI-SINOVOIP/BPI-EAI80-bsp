...
static RET_CODE HAL_SQI_MX25_4LINE_Disable(SQI_Device_T *pSQIDev)
{
    ...
    HAL_SQI_Write_Enable(pSQIDev);
    HAL_SQI_Wait_Idle(pSQIDev);
    HAL_SQI_SET_CFG_REGISTER(pSQIDev, SQI_SET_CODE_HIT | SQI_SET_DATA_HIT | NOR_WRSR_CMD);
...
/*=================================IS25primary function==================================================*/

static RET_CODE HAL_SQI_IS25_4LINE_Disable(SQI_Device_T *pSQIDev)
{
    uint8_t rbuf;
    int     timeout;
...
static RET_CODE HAL_SQI_IS25_4LINE_Enable(SQI_Device_T *pSQIDev)
{
    uint8_t rbuf;
    int     timeout;
    HAL_SQI_Wait_Idle(pSQIDev);
...
RET_CODE HAL_SQI_IS25_4LineWrite_Enable(SQI_Device_T *pSQIDev, uint32_t count, uint32_t flash_size)
{
    RET_CODE ret;
    ret = HAL_SQI_MX25_4LINE_Enable(pSQIDev);
    if (ret != RET_OK)
    ...
    if (flash_size > SFLASH_16M_SIZE)
    {
        HAL_SQI_SET_CFG_REGISTER(pSQIDev, SQI_FAST_RW_CNT_EN | SQI_CONTINUE_WRITE_EN | SQI_SET_CODE_HIT | SQI_SET_ADDR_HIT  | SQI_SET_DATA_HIT | IS25R_4PP4B_CMD);
    }
    else
    {
        HAL_SQI_SET_CFG_REGISTER(pSQIDev, SQI_FAST_RW_CNT_EN | SQI_CONTINUE_WRITE_EN | SQI_SET_CODE_HIT | SQI_SET_ADDR_HIT  | SQI_SET_DATA_HIT | IS25R_4PP_CMD);
    }
    LL_SQI_FAST_RW_CNT_SET(pSQIDev, count);
    return RET_OK;
...
RET_CODE HAL_SQI_IS25_4LineRead_Enable(SQI_Device_T *pSQIDev, uint32_t count, uint32_t flash_size)
{
    RET_CODE ret;
    ret = HAL_SQI_IS25_4LINE_Enable(pSQIDev);
    if (ret != RET_OK)
    {
        return ret;
    }
    ...
    if (flash_size > SFLASH_16M_SIZE)
    {
        HAL_SQI_SET_CFG_REGISTER(pSQIDev, SQI_FAST_RW_CNT_EN | SQI_CONTINUE_READ_EN | SQI_SET_CODE_HIT | SQI_SET_ADDR_HIT | SQI_SET_DMY_HIT | SQI_SET_DATA_HIT | IS25R_QREAD4B_CMD);
    }
    else
    {
        HAL_SQI_SET_CFG_REGISTER(pSQIDev, SQI_FAST_RW_CNT_EN | SQI_CONTINUE_READ_EN | SQI_SET_CODE_HIT | SQI_SET_ADDR_HIT | SQI_SET_DMY_HIT | SQI_SET_DATA_HIT | IS25R_QREAD_CMD);
    }
...
RET_CODE HAL_SQI_IS25_Close_4Line(SQI_Device_T *pSQIDev)
{
    if (pSQIDev)
    {
        return HAL_SQI_IS25_4LINE_Disable(pSQIDev);
    }
    else
    {
        return RET_ERROR;
...
RET_CODE HAL_SQI_IS25_4Address_Enable(SQI_Device_T *pSQIDev)
{
    uint8_t rbuf;
    LL_SQI_SET_ADDR_BYTE_NUM(pSQIDev, 1);
    return RET_OK;
...
uint32_t HAL_SQI_ReadID(SQI_Device_T *pSQIDev)
{
    ...
    //      HAL_SQI_SET_CFG_REGISTER(pSQIDev,SQI_SET_CODE_HIT | SQI_SET_DATA_HIT | NOR_READ_ID_CMD);
    for (i = 0; i < 4; i++)
    {
