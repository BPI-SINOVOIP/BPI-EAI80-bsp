...
/*=================================IS define==================================================*/
#define IS25R_4PP_CMD                     0x38         //quad page program 
#define IS25R_4PP4B_CMD                   0x3E         //quad page program use 4 byte address
#define IS25R_QREAD_CMD                   0x6B         //1I / 4O read command
#define IS25R_QREAD4B_CMD                 0x6C         //1I / 4O read command use 4 byte address
