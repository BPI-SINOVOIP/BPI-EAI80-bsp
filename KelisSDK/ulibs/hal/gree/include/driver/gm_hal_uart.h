...
#define UART_INDEX3                         3
#define UART_INDEX4                         4
#define UART_INDEX5                         5
#define UART_INDEX6                         6
#define UART_INDEX7                         7
/**
 * @}
 */
...
typedef enum
{
    ...
    UART_EVENT_TX_FINISHED    = 3,   /**< is the received character. */
...
typedef struct
{
    ...
    uint32_t        clockSrc;         /**< UART clock source */
    uint8_t         reserved[2];
 ...
 *
 * This function gets one character from data register, it will not wait even though no data received.
 *
