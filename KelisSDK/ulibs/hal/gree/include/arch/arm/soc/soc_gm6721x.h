...
#define SPI4_BASE                          (APB2_PERIPHERAL_BASE + 0x00008000U)
...
#define SYS_IP_SW_RESET_BKD_POS                ((uint32_t) 31)
#define SYS_IP_SW_RESET_BKD_SET_MASK           ((uint32_t) ((uint32_t)1ul << SYS_IP_SW_RESET_BKD_POS))
#endif
